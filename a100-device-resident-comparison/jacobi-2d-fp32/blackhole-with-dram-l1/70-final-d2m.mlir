...
module {
  func.func @_Z15runJacobi2DCUDAiiPfS__driver(%arg0: memref<3200x3200xf32>) -> memref<3200x3200xf32> attributes {tt.d2m_emittable = true, tt.d2m_unhandled = 0 : i64, tt.function_type = "forward_device", tt.l1_peak = 1445888 : i64, tt.l1_persistent_base = 626688 : i64, tt.l1_pool = 626688 : i64} {
    ...
    d2m.generic {block_factors = [], grid = #ttcore.grid<10x10>, indexing_maps = [], iterator_types = [], threads = [#d2m.thread<datamovement>, #d2m.thread<datamovement>, #d2m.thread<compute>]}
        ...
        outs(%alloc, %alloc_14 : memref<10x10x10x10x!ttcore.tile<32x32, f32>, #ttcore.shard<40960x4096, 1>, #l1>, memref<10x10x10x10x!ttcore.tile<32x32, f32>, #ttcore.shard<40960x4096, 1>, #dram>)
      ...
      %4 = d2m.get_cb(4) resolution_stage =  compile : <memref<10x10x!ttcore.tile<32x32, f32>, #l1>>
      %5 = d2m.get_cb(5) resolution_stage =  compile : <memref<1x2x!ttcore.tile<32x32, f32>, #l1>>
      %6 = d2m.get_cb(6) resolution_stage =  compile : <memref<1x10x!ttcore.tile<32x32, f32>, #l1>>
      %7 = d2m.get_cb(7) resolution_stage =  compile : <memref<1x10x!ttcore.tile<32x32, f32>, #l1>>
      ...
      %core0 = d2m.core_index(0) : index
      %core1 = d2m.core_index(1) : index
      %fold_cb0 = d2m.get_cb(0) resolution_stage =  compile : <memref<10x10x!ttcore.tile<32x32, f32>, #l1>>
      d2m.remote_load %alloc_14[%core0, %core1] into %fold_cb0 : memref<10x10x10x10x!ttcore.tile<32x32, f32>, #ttcore.shard<40960x4096, 1>, #dram> into !d2m.cb<memref<10x10x!ttcore.tile<32x32, f32>, #l1>>
      ...
      scf.for %arg1 = %c0 to %c1000 step %c1 {
        ...
        %29 = d2m.get_arg(16) : !d2m.local_semaphore
        ...
        %32 = d2m.get_arg(18) : !d2m.local_semaphore
        scf.for %arg2 = %c0 to %c10 step %c1 {
          scf.for %arg3 = %c0 to %c10 step %c1 {
      ...
      d2m.remote_store %alloc_14[%core0, %core1] from %fold_cb0 : memref<10x10x10x10x!ttcore.tile<32x32, f32>, #ttcore.shard<40960x4096, 1>, #dram> from !d2m.cb<memref<10x10x!ttcore.tile<32x32, f32>, #l1>>
      d2m.atomic_barrier
    }, {
      %c1 = arith.constant 1 : index
      %c9 = arith.constant 9 : index
      ...
      scf.for %arg1 = %c0 to %c1000 step %c1 {
        ...
        %14 = d2m.get_arg(17) : !d2m.local_semaphore
        scf.for %arg2 = %c0 to %c10 step %c1 {
          scf.for %arg3 = %c0 to %c10 step %c1 {
        ...
        %17 = d2m.get_arg(19) : !d2m.local_semaphore
        scf.for %arg2 = %c0 to %c10 step %c1 {
          scf.for %arg3 = %c0 to %c10 step %c1 {
      ...
      %10 = d2m.get_cb(15) resolution_stage =  compile : <memref<1x1x!ttcore.tile<32x32, f32>, #l1>>
