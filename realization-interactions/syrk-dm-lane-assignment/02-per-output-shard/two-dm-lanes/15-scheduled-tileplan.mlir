...
#map1 = affine_map<(d0, d1, d2, d3, d4) -> (d3 + d0 * 320, d1 * 320 + d4)>
#map2 = affine_map<(d0, d1, d2, d3, d4) -> (d2 + d0 * 320, d1 * 320 + d4)>
#map3 = affine_map<(d0, d1, d2) -> (d0, d2)>
#map4 = affine_map<(d0, d1, d2) -> (d1, d2)>
#map5 = affine_map<(d0, d1, d2) -> (d0, d1)>
#map6 = affine_map<(d0, d1, d2, d3, d4, d5, d6) -> (d4 + d2 * 32 + d0 * 320, d5 + d3 * 32 + d1 * 320)>
module {
    ...
    tileplan.device_for (%arg2, %arg3) in (%c10_0, %c10) {
      ...
      ^bb0(%arg4: memref<3200x3200xbf16>, %arg5: memref<3200x3200xbf16>):
        ...
        tileplan.temporal_for (%arg6) in (0, 10, 1) {
          ...
          %3 = tileflow.read_l1_buffer %2 at(%c0, %c0) epoch(%arg6) : !tileplan.l1_buffer -> !d2mtile.tile<bf16>
          %4 = tileplan.logical_read %0 access_dims(%arg3, %arg6) element_map #map1 {frameShape = array<i64: 10, 10>} : !tileplan.shard_view -> !d2mtile.tile<bf16>
          %5 = tileplan.logical_read %0 access_dims(%arg2, %arg6) element_map #map2 {frameShape = array<i64: 10, 10>} : !tileplan.shard_view -> !d2mtile.tile<bf16>
          %6 = tileplan.compute {indexing_maps = [#map3, #map4, #map5], iterator_types = [#tileplan.iterator_type<parallel>, #tileplan.iterator_type<parallel>, #tileplan.iterator_type<reduction>]} ins(%5, %4 : !d2mtile.tile<bf16>, !d2mtile.tile<bf16>) outs(%3 : !d2mtile.tile<bf16>) {
          ^bb0(%arg7: !d2mtile.tile<bf16>, %arg8: !d2mtile.tile<bf16>, %arg9: !d2mtile.tile<bf16>):
            %7 = d2mtile.matmul_block %arg7, %arg8 acc %arg9 block [10, 10, 10] {transpose = true} : !d2mtile.tile<bf16>
            tileplan.yield %7 : !d2mtile.tile<bf16>
          } -> !d2mtile.tile<bf16>
          tileflow.write_l1_buffer %2 at(%c0, %c0) epoch(%arg6) to %6 {frameShape = array<i64: 10, 10>} : !tileplan.l1_buffer to !d2mtile.tile<bf16>
        } {epoch_id = 0 : i64, loop_name = "k"}
        %c10_1 = arith.constant 10 : index
        tileplan.shard_for (%arg6) in (%c10_1) axis <row> {
          %c10_2 = arith.constant 10 : index
          tileplan.shard_for (%arg7) in (%c10_2) axis <col> {
            %3 = tileplan.logical_read %1 access_dims(%arg2, %arg3, %arg6, %arg7) element_map #map6 : !tileplan.shard_view -> !d2mtile.tile<bf16>
            %4 = d2mtile.fill "3.000000e+00" -> "source_ssa" : !d2mtile.tile<bf16>
            %5 = d2mtile.binary tile_mul %3, %4 -> "source_ssa" : !d2mtile.tile<bf16>
            %6 = d2mtile.fill "2.000000e+00" -> "source_ssa" : !d2mtile.tile<bf16>
            %7 = tileflow.read_l1_buffer %2 at(%arg6, %arg7) : !tileplan.l1_buffer -> !d2mtile.tile<bf16>
            %8 = d2mtile.binary tile_mul %7, %6 -> "source_ssa" : !d2mtile.tile<bf16>
            %9 = d2mtile.binary tile_add %5, %8 -> "source_ssa" : !d2mtile.tile<bf16>
