  ...
  func.func @_Z11syrk_kerneliiPfS__driver(%arg0: memref<3200x3200xbf16> {tileplan.abi_index = 0 : i64, tileplan.tensor_role = #tileplan.tensor_role<input>}, %arg1: memref<3200x3200xbf16> {tileplan.abi_index = 1 : i64, tileplan.tensor_role = #tileplan.tensor_role<inout>}) attributes {tileplan.selected_compute} {
    ...
    tileplan.device_for (%arg2, %arg3) in (%c10_0, %c10) {
      ...
      ^bb0(%arg4: memref<3200x3200xbf16>, %arg5: memref<3200x3200xbf16>):
        ...
        task.group @dm1_0 engine(<dm1>) domain(<phase>) reads(%0 : !tileplan.l1_buffer [full]) writes(%3 : !tileplan.l1_buffer [full]) {
          ...
          tileplan.temporal_for (%arg6) in (0, 10, 1) {
            %8 = affine.apply #map(%arg6, %arg3)
            tileflow.bulk_transfer %0 into %3 source_core(%5, %8) source_slice(%6, %7) multicast(%c0, %arg3, %c10_1, %c1) epoch(%arg6) {task.dm_lane = #task.engine<dm1>, task.engine_label = "dm"} : !tileplan.l1_buffer into !tileplan.l1_buffer
          } {epoch_id = 0 : i64}
        }
        task.group @dm0_0 engine(<dm0>) domain(<phase>) reads(%0 : !tileplan.l1_buffer [full]) writes(%4 : !tileplan.l1_buffer [full]) {
          ...
          tileplan.temporal_for (%arg6) in (0, 10, 1) {
            %8 = affine.apply #map(%arg6, %arg3)
            tileflow.bulk_transfer %0 into %4 source_core(%5, %8) source_slice(%6, %7) multicast(%arg2, %c0, %c1, %c10_1) epoch(%arg6) {task.engine_label = "dm"} : !tileplan.l1_buffer into !tileplan.l1_buffer
          } {epoch_id = 0 : i64}
        }
        task.group @compute_1_1 engine(<compute>) domain(<phase>) reads(%1 : !tileplan.l1_buffer [full], %2 : !tileplan.l1_buffer [full]) writes(%2 : !tileplan.l1_buffer [full], %1 : !tileplan.l1_buffer [full]) after [#task.dep<@dm1_0, raw>, #task.dep<@dm0_0, raw>] {
