...
module {
  func.func @_Z11syrk_kerneliiPfS__driver(%arg0: memref<3200x3200xbf16> {tileplan.abi_index = 0 : i64, tileplan.tensor_role = #tileplan.tensor_role<input>}, %arg1: memref<3200x3200xbf16> {tileplan.abi_index = 1 : i64, tileplan.tensor_role = #tileplan.tensor_role<inout>}) attributes {tileplan.selected_compute, tt.l1_peak = 450560 : i64, tt.l1_persistent_base = 40960 : i64, tt.l1_pool = 40960 : i64} {
    %c10 = arith.constant 10 : index
    %c10_0 = arith.constant 10 : index
    tileplan.device_for (%arg2, %arg3) in (%c10_0, %c10) {
      %0 = tileplan.persistent_l1 elem bf16 tile(32, 32) domain(10, 10) order(0) {logical_tiles = [100, 100], partition = [10, 10], physical_grid = [10, 10], shard = [10, 10], tt.frame_pages = 100 : i64, tt.l1_offset = 40960 : i64, tt.storage_bytes = 204800 : i64, tt.storage_depth = 1 : i64, tt.storage_kind = "persistent"} : !tileplan.l1_buffer
      %1 = tileplan.persistent_l1 elem bf16 tile(32, 32) domain(10, 10) order(1) {logical_tiles = [100, 100], partition = [10, 10], physical_grid = [10, 10], shard = [10, 10], tt.frame_pages = 100 : i64, tt.l1_offset = 245760 : i64, tt.mailbox_depth = 1 : i64, tt.storage_bytes = 204800 : i64, tt.storage_depth = 1 : i64, tt.storage_kind = "persistent"} : !tileplan.l1_buffer
      ...
      ^bb0(%arg4: memref<3200x3200xbf16>, %arg5: memref<3200x3200xbf16>):
        %2 = tileplan.l1_buffer role<intermediate> elem bf16 tile(32, 32) domain(1, 1) order(2) {tt.cb_id = 2 : i64, tt.contraction_accumulator, tt.frame_pages = 1 : i64, tt.l1_offset = 8192 : i64, tt.storage_bytes = 2048 : i64, tt.storage_depth = 1 : i64, tt.storage_kind = "addressed"} : !tileplan.l1_buffer
        %3 = tileplan.l1_buffer role<receive> elem bf16 tile(32, 32) domain(1, 1) order(0) {task.buffer_depth = 2 : i64, task.delivery_initialized, task.slot_access = #task.slot_access<resident>, tt.cb_id = 0 : i64, tt.frame_pages = 1 : i64, tt.l1_offset = 0 : i64, tt.mailbox_depth = 2 : i64, tt.storage_bytes = 4096 : i64, tt.storage_depth = 2 : i64, tt.storage_kind = "addressed_mailbox"} : !tileplan.l1_buffer
        %4 = tileplan.l1_buffer role<receive> elem bf16 tile(32, 32) domain(1, 1) order(1) {task.buffer_depth = 2 : i64, task.delivery_initialized, task.slot_access = #task.slot_access<resident>, tt.cb_id = 1 : i64, tt.frame_pages = 1 : i64, tt.l1_offset = 4096 : i64, tt.mailbox_depth = 2 : i64, tt.storage_bytes = 4096 : i64, tt.storage_depth = 2 : i64, tt.storage_kind = "addressed_mailbox"} : !tileplan.l1_buffer
        %5 = tileplan.l1_buffer role<intermediate> name "dst_spill_3" elem bf16 tile(32, 32) domain(1, 1) order(3) {tt.cb_id = 3 : i64, tt.dst_spill, tt.frame_pages = 1 : i64, tt.l1_offset = 10240 : i64, tt.mailbox_depth = 1 : i64, tt.storage_bytes = 2048 : i64, tt.storage_depth = 1 : i64, tt.storage_kind = "addressed_mailbox"} : !tileplan.l1_buffer
        %6 = tileplan.l1_buffer role<intermediate> name "dst_spill_4" elem bf16 tile(32, 32) domain(1, 1) order(4) {tt.cb_id = 4 : i64, tt.dst_spill, tt.frame_pages = 1 : i64, tt.l1_offset = 12288 : i64, tt.mailbox_depth = 1 : i64, tt.storage_bytes = 2048 : i64, tt.storage_depth = 1 : i64, tt.storage_kind = "addressed_mailbox"} : !tileplan.l1_buffer
          ...
          tileplan.shard_for (%arg6) in (%c10_1) axis <row> {
            tileplan.shard_for (%arg7) in (%c10_2) axis <col> {
              tileplan.temporal_for (%arg8) in (0, 100, 1) {
                ...
                tileflow.bulk_transfer %0 into %3 source_core(%7, %8) source_slice(%9, %10) multicast(%c0, %arg3, %c10_3, %c1) epoch(%arg8) {task.engine_label = "dm"} : !tileplan.l1_buffer into !tileplan.l1_buffer
                %11 = affine.apply #map3(%arg2, %arg6)
                %12 = affine.apply #map1(%arg8, %arg3)
                %13 = affine.apply #map2(%arg6)
                %14 = affine.apply #map2(%arg8)
                tileflow.bulk_transfer %0 into %4 source_core(%11, %12) source_slice(%13, %14) multicast(%arg2, %c0_4, %c1_5, %c10_6) epoch(%arg8) {task.engine_label = "dm"} : !tileplan.l1_buffer into !tileplan.l1_buffer
              } {epoch_id = 0 : i64}
            }
          }
        }
