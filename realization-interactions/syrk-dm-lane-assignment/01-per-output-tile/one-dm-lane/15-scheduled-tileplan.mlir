...
#map2 = affine_map<(d0, d1, d2, d3, d4, d5) -> (d4 + d1 * 32 + d0 * 320, d2 * 32 + d5)>
#map3 = affine_map<(d0, d1, d2, d3, d4, d5) -> (d3 + d1 * 32 + d0 * 320, d2 * 32 + d5)>
        ...
        tileplan.shard_for (%arg6) in (%c10_1) axis <row> {
          ...
          tileplan.shard_for (%arg7) in (%c10_2) axis <col> {
            ...
            %4 = tileplan.temporal_for (%arg8) in (0, 100, 1) iter_args(%arg9 = %3) -> (!d2mtile.tile<bf16>) {
              %10 = tileplan.logical_read %0 access_dims(%arg3, %arg7, %arg8) element_map #map2 : !tileplan.shard_view -> !d2mtile.tile<bf16>
              %11 = tileplan.logical_read %0 access_dims(%arg2, %arg6, %arg8) element_map #map3 : !tileplan.shard_view -> !d2mtile.tile<bf16>
