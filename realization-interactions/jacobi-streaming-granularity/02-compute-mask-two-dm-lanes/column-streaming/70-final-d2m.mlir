...
module {
  func.func @_Z15runJacobi2DCUDAiiPfS__driver(%arg0: memref<3200x3200xbf16>) -> memref<3200x3200xbf16> attributes {tt.d2m_emittable = true, tt.d2m_unhandled = 0 : i64, tt.function_type = "forward_device", tt.l1_peak = 722944 : i64, tt.l1_persistent_base = 313344 : i64, tt.l1_pool = 313344 : i64} {
    ...
    d2m.generic {block_factors = [], grid = #ttcore.grid<10x10>, indexing_maps = [], iterator_types = [], threads = [#d2m.thread<datamovement>, #d2m.thread<datamovement>, #d2m.thread<compute>]}
      ...
      %10 = d2m.get_cb(11) resolution_stage =  compile : <memref<1x1x!ttcore.tile<32x32, bf16>, #l1>>
      ...
      scf.for %arg1 = %c0 to %c1000 step %c1 {
        ...
        scf.for %arg2 = %c0 to %c10 step %c1 {
          scf.for %arg3 = %c0 to %c10 step %c1 {
            ...
            %49 = d2m.reserve %9 {pin_cb = 10 : i64} : <memref<1x1x!ttcore.tile<32x32, bf16>, #l1>> -> memref<1x1x!ttcore.tile<32x32, bf16>, #l1>
            %50 = arith.muli %48, %c10 : index
            %51 = arith.addi %50, %47 : index
            %52 = arith.muli %51, %c2048 : index
            %tx_20 = d2m.dma_read %39[%52], %49[%c0], <1> {srcByteOffset = -32 : si32} : (memref<10x10x!ttcore.tile<32x32, bf16>, #l1>, memref<1x1x!ttcore.tile<32x32, bf16>, #l1>) -> !d2m.mem_tx<read>
            d2m.dma_wait %tx_20 : !d2m.mem_tx<read>
            d2m.copy_single_row_tile(%39, %c15) to %49 at %c16 from %51, %c0 : memref<10x10x!ttcore.tile<32x32, bf16>, #l1>, index, memref<1x1x!ttcore.tile<32x32, bf16>, #l1>, index, index, index
            scf.if %46 {
              d2m.copy_single_row_tile(%41, %c31) to %49 at %c0 from %47, %c0 : memref<1x10x!ttcore.tile<32x32, bf16>, #l1>, index, memref<1x1x!ttcore.tile<32x32, bf16>, #l1>, index, index, index
            } else {
              %55 = affine.apply #map3(%arg2)[%core0]
              %56 = arith.muli %55, %c10 : index
              %57 = arith.addi %56, %47 : index
              d2m.copy_single_row_tile(%39, %c31) to %49 at %c0 from %57, %c0 : memref<10x10x!ttcore.tile<32x32, bf16>, #l1>, index, memref<1x1x!ttcore.tile<32x32, bf16>, #l1>, index, index, index
            }
            d2m.push %9 {pin_cb = 10 : i64} : <memref<1x1x!ttcore.tile<32x32, bf16>, #l1>>
            %53 = arith.cmpi sge, %arg2, %c9 : index
            %54 = d2m.reserve %10 {pin_cb = 11 : i64} : <memref<1x1x!ttcore.tile<32x32, bf16>, #l1>> -> memref<1x1x!ttcore.tile<32x32, bf16>, #l1>
            %tx_21 = d2m.dma_read %39[%52], %54[%c0], <1> {srcByteOffset = 32 : si32} : (memref<10x10x!ttcore.tile<32x32, bf16>, #l1>, memref<1x1x!ttcore.tile<32x32, bf16>, #l1>) -> !d2m.mem_tx<read>
            d2m.dma_wait %tx_21 : !d2m.mem_tx<read>
            d2m.copy_single_row_tile(%39, %c16) to %54 at %c15 from %51, %c0 : memref<10x10x!ttcore.tile<32x32, bf16>, #l1>, index, memref<1x1x!ttcore.tile<32x32, bf16>, #l1>, index, index, index
            scf.if %53 {
              d2m.copy_single_row_tile(%42, %c0) to %54 at %c31 from %47, %c0 : memref<1x10x!ttcore.tile<32x32, bf16>, #l1>, index, memref<1x1x!ttcore.tile<32x32, bf16>, #l1>, index, index, index
            } else {
              %55 = affine.apply #map4(%arg2)[%core0]
              %56 = arith.muli %55, %c10 : index
              %57 = arith.addi %56, %47 : index
              d2m.copy_single_row_tile(%39, %c0) to %54 at %c31 from %57, %c0 : memref<10x10x!ttcore.tile<32x32, bf16>, #l1>, index, memref<1x1x!ttcore.tile<32x32, bf16>, #l1>, index, index, index
            }
            d2m.push %10 {pin_cb = 11 : i64} : <memref<1x1x!ttcore.tile<32x32, bf16>, #l1>>
          }
        }
      ...
      %6 = d2m.get_cb(12) resolution_stage =  compile : <memref<1x1x!ttcore.tile<32x32, bf16>, #l1>>
      %7 = d2m.get_cb(13) resolution_stage =  compile : <memref<1x1x!ttcore.tile<32x32, bf16>, #l1>>
      ...
      scf.for %arg1 = %c0 to %c1000 step %c1 {
        ...
        scf.for %arg2 = %c0 to %c10 step %c1 {
          scf.for %arg3 = %c0 to %c10 step %c1 {
            ...
            %21 = d2m.reserve %6 {pin_cb = 12 : i64} : <memref<1x1x!ttcore.tile<32x32, bf16>, #l1>> -> memref<1x1x!ttcore.tile<32x32, bf16>, #l1>
            ...
            d2m.push %6 {pin_cb = 12 : i64} : <memref<1x1x!ttcore.tile<32x32, bf16>, #l1>>
            %25 = arith.cmpi slt, %arg3, %c1 : index
            %26 = d2m.reserve %7 {pin_cb = 13 : i64} : <memref<1x1x!ttcore.tile<32x32, bf16>, #l1>> -> memref<1x1x!ttcore.tile<32x32, bf16>, #l1>
            ...
            d2m.push %7 {pin_cb = 13 : i64} : <memref<1x1x!ttcore.tile<32x32, bf16>, #l1>>
          }
        }
      ...
      scf.for %arg1 = %c0 to %c1000 step %c1 {
        ...
        scf.for %arg2 = %c0 to %c10 step %c1 {
          scf.for %arg3 = %c0 to %c10 step %c1 {
            ...
            %dst_20 = d2m.acquire_dst() : memref<16x!ttcore.tile<32x32, bf16>, #dst>
            %25 = memref.load %14[%23, %24] : memref<10x10x!ttcore.tile<32x32, bf16>, #l1>
            memref.store %25, %dst_20[%c0] : memref<16x!ttcore.tile<32x32, bf16>, #dst>
            %26 = memref.load %dst_20[%c0] : memref<16x!ttcore.tile<32x32, bf16>, #dst>
            ...
            %29 = d2m.wait %10 : <memref<1x1x!ttcore.tile<32x32, bf16>, #l1>> -> memref<1x1x!ttcore.tile<32x32, bf16>, #l1>
            %30 = memref.load %29[%c0, %c0] : memref<1x1x!ttcore.tile<32x32, bf16>, #l1>
            %31 = "d2m.tile_add"(%30, %28) : (!ttcore.tile<32x32, bf16>, !ttcore.tile<32x32, bf16>) -> !ttcore.tile<32x32, bf16>
            ...
            %35 = d2m.wait %8 : <memref<1x1x!ttcore.tile<32x32, bf16>, #l1>> -> memref<1x1x!ttcore.tile<32x32, bf16>, #l1>
            %36 = memref.load %35[%c0, %c0] : memref<1x1x!ttcore.tile<32x32, bf16>, #l1>
            %37 = "d2m.tile_add"(%26, %36) : (!ttcore.tile<32x32, bf16>, !ttcore.tile<32x32, bf16>) -> !ttcore.tile<32x32, bf16>
            memref.store %37, %dst_20[%c2] : memref<16x!ttcore.tile<32x32, bf16>, #dst>
            %38 = memref.load %dst_20[%c2] : memref<16x!ttcore.tile<32x32, bf16>, #dst>
            d2m.pop %8 : <memref<1x1x!ttcore.tile<32x32, bf16>, #l1>>
            %39 = d2m.wait %7 : <memref<1x1x!ttcore.tile<32x32, bf16>, #l1>> -> memref<1x1x!ttcore.tile<32x32, bf16>, #l1>
            %40 = memref.load %39[%c0, %c0] : memref<1x1x!ttcore.tile<32x32, bf16>, #l1>
            %41 = "d2m.tile_add"(%38, %40) : (!ttcore.tile<32x32, bf16>, !ttcore.tile<32x32, bf16>) -> !ttcore.tile<32x32, bf16>
            ...
            %43 = "d2m.tile_add"(%42, %34) : (!ttcore.tile<32x32, bf16>, !ttcore.tile<32x32, bf16>) -> !ttcore.tile<32x32, bf16>
            ...
            %55 = scf.if %54 -> (!ttcore.tile<32x32, bf16>) {
              ...
              %67 = scf.if %64 -> (!ttcore.tile<32x32, bf16>) {
                %68 = "d2m.tile_where"(%66, %47, %26) : (!ttcore.tile<32x32, bf16>, !ttcore.tile<32x32, bf16>, !ttcore.tile<32x32, bf16>) -> !ttcore.tile<32x32, bf16>
                ...
                %68 = "d2m.tile_where"(%66, %26, %47) : (!ttcore.tile<32x32, bf16>, !ttcore.tile<32x32, bf16>, !ttcore.tile<32x32, bf16>) -> !ttcore.tile<32x32, bf16>
                memref.store %68, %dst_20[%c2] : memref<16x!ttcore.tile<32x32, bf16>, #dst>
                %69 = memref.load %dst_20[%c2] : memref<16x!ttcore.tile<32x32, bf16>, #dst>
                scf.yield %69 : !ttcore.tile<32x32, bf16>
              }
            ...
            %63 = scf.if %62 -> (!ttcore.tile<32x32, bf16>) {
              ...
              %66 = memref.load %dst_20[%c1] : memref<16x!ttcore.tile<32x32, bf16>, #dst>
              %67 = scf.if %64 -> (!ttcore.tile<32x32, bf16>) {
                %68 = "d2m.tile_where"(%66, %55, %26) : (!ttcore.tile<32x32, bf16>, !ttcore.tile<32x32, bf16>, !ttcore.tile<32x32, bf16>) -> !ttcore.tile<32x32, bf16>
                memref.store %68, %dst_20[%c2] : memref<16x!ttcore.tile<32x32, bf16>, #dst>
                %69 = memref.load %dst_20[%c2] : memref<16x!ttcore.tile<32x32, bf16>, #dst>
                scf.yield %69 : !ttcore.tile<32x32, bf16>
              } else {
                %68 = "d2m.tile_where"(%66, %26, %55) : (!ttcore.tile<32x32, bf16>, !ttcore.tile<32x32, bf16>, !ttcore.tile<32x32, bf16>) -> !ttcore.tile<32x32, bf16>
                memref.store %68, %dst_20[%c2] : memref<16x!ttcore.tile<32x32, bf16>, #dst>
                %69 = memref.load %dst_20[%c2] : memref<16x!ttcore.tile<32x32, bf16>, #dst>
                scf.yield %69 : !ttcore.tile<32x32, bf16>
              }
