...
module {
  func.func @_Z15runJacobi2DCUDAiiPfS__driver(%arg0: memref<3200x3200xbf16>) -> memref<3200x3200xbf16> attributes {tt.d2m_emittable = true, tt.d2m_unhandled = 0 : i64, tt.function_type = "forward_device", tt.l1_peak = 870400 : i64, tt.l1_persistent_base = 460800 : i64, tt.l1_pool = 460800 : i64} {
    ...
    d2m.generic {block_factors = [], grid = #ttcore.grid<10x10>, indexing_maps = [], iterator_types = [], threads = [#d2m.thread<datamovement>, #d2m.thread<datamovement>, #d2m.thread<compute>]}
      ...
      %5 = d2m.get_cb(4) resolution_stage =  compile : <memref<2x1x!ttcore.tile<32x32, bf16>, #l1>>
      %6 = d2m.get_cb(5) resolution_stage =  compile : <memref<1x2x!ttcore.tile<32x32, bf16>, #l1>>
      %7 = d2m.get_cb(6) resolution_stage =  compile : <memref<1x10x!ttcore.tile<32x32, bf16>, #l1>>
      %8 = d2m.get_cb(7) resolution_stage =  compile : <memref<1x10x!ttcore.tile<32x32, bf16>, #l1>>
      ...
      %core0 = d2m.core_index(0) : index
      %core1 = d2m.core_index(1) : index
      %12 = d2m.reserve %5 {pin_cb = 4 : i64} : <memref<2x1x!ttcore.tile<32x32, bf16>, #l1>> -> memref<2x1x!ttcore.tile<32x32, bf16>, #l1>
      ...
      d2m.write_row_mask_tile(%17) to %5 at %c0 of %c2 : index, !d2m.cb<memref<2x1x!ttcore.tile<32x32, bf16>, #l1>>, index, index
      ...
      d2m.write_row_mask_tile(%22) to %5 at %c1 of %c2 : index, !d2m.cb<memref<2x1x!ttcore.tile<32x32, bf16>, #l1>>, index, index
      d2m.push %5 {pin_cb = 4 : i64} : <memref<2x1x!ttcore.tile<32x32, bf16>, #l1>>
      %23 = d2m.reserve %6 {pin_cb = 5 : i64} : <memref<1x2x!ttcore.tile<32x32, bf16>, #l1>> -> memref<1x2x!ttcore.tile<32x32, bf16>, #l1>
      ...
      d2m.write_col_mask_tile(%28) to %6 at %c0 of %c2 : index, !d2m.cb<memref<1x2x!ttcore.tile<32x32, bf16>, #l1>>, index, index
      ...
      d2m.write_col_mask_tile(%33) to %6 at %c1 of %c2 : index, !d2m.cb<memref<1x2x!ttcore.tile<32x32, bf16>, #l1>>, index, index
      d2m.push %6 {pin_cb = 5 : i64} : <memref<1x2x!ttcore.tile<32x32, bf16>, #l1>>
      %34 = d2m.reserve %11 {pin_cb = 2 : i64} : <memref<10x10x!ttcore.tile<32x32, bf16>, #l1>> -> memref<10x10x!ttcore.tile<32x32, bf16>, #l1>
      ...
      scf.for %arg1 = %c0 to %c1000 step %c1 {
        ...
        %39 = d2m.wait %11 : <memref<10x10x!ttcore.tile<32x32, bf16>, #l1>> -> memref<10x10x!ttcore.tile<32x32, bf16>, #l1>
        ...
        d2m.remote_load %alloc[%36, %core1] into %7 srcSlice[%c9, %c0] : memref<10x10x10x10x!ttcore.tile<32x32, bf16>, #ttcore.shard<20480x2048, 1>, #l1> into !d2m.cb<memref<1x10x!ttcore.tile<32x32, bf16>, #l1>>
        d2m.remote_load %alloc[%38, %core1] into %8 srcSlice[%c0, %c0] : memref<10x10x10x10x!ttcore.tile<32x32, bf16>, #ttcore.shard<20480x2048, 1>, #l1> into !d2m.cb<memref<1x10x!ttcore.tile<32x32, bf16>, #l1>>
        %41 = d2m.wait %7 : <memref<1x10x!ttcore.tile<32x32, bf16>, #l1>> -> memref<1x10x!ttcore.tile<32x32, bf16>, #l1>
        %42 = d2m.wait %8 : <memref<1x10x!ttcore.tile<32x32, bf16>, #l1>> -> memref<1x10x!ttcore.tile<32x32, bf16>, #l1>
        scf.for %arg2 = %c0 to %c10 step %c1 {
          %46 = d2m.reserve %9 {pin_cb = 10 : i64} : <memref<1x10x!ttcore.tile<32x32, bf16>, #l1>> -> memref<1x10x!ttcore.tile<32x32, bf16>, #l1>
          %47 = d2m.reserve %10 {pin_cb = 11 : i64} : <memref<1x10x!ttcore.tile<32x32, bf16>, #l1>> -> memref<1x10x!ttcore.tile<32x32, bf16>, #l1>
          %48 = affine.apply #map2(%arg2)
          %49 = arith.muli %48, %c20480 : index
          %tx_20 = d2m.dma_read %39[%49], %46[%c0], <10> {srcByteOffset = -32 : si32} : (memref<10x10x!ttcore.tile<32x32, bf16>, #l1>, memref<1x10x!ttcore.tile<32x32, bf16>, #l1>) -> !d2m.mem_tx<read>
          d2m.dma_wait %tx_20 : !d2m.mem_tx<read>
          %tx_21 = d2m.dma_read %39[%49], %47[%c0], <10> {srcByteOffset = 32 : si32} : (memref<10x10x!ttcore.tile<32x32, bf16>, #l1>, memref<1x10x!ttcore.tile<32x32, bf16>, #l1>) -> !d2m.mem_tx<read>
          d2m.dma_wait %tx_21 : !d2m.mem_tx<read>
          scf.for %arg3 = %c0 to %c10 step %c1 {
            %50 = arith.cmpi slt, %arg2, %c1 : index
            %51 = affine.apply #map2(%arg3)
            %52 = arith.muli %48, %c10 : index
            %53 = arith.addi %52, %51 : index
            d2m.copy_single_row_tile(%39, %c15) to %46 at %c16 from %53, %arg3 : memref<10x10x!ttcore.tile<32x32, bf16>, #l1>, index, memref<1x10x!ttcore.tile<32x32, bf16>, #l1>, index, index, index
            scf.if %50 {
              d2m.copy_single_row_tile(%41, %c31) to %46 at %c0 from %51, %arg3 : memref<1x10x!ttcore.tile<32x32, bf16>, #l1>, index, memref<1x10x!ttcore.tile<32x32, bf16>, #l1>, index, index, index
            } else {
              %55 = affine.apply #map3(%arg2)[%core0]
              %56 = arith.muli %55, %c10 : index
              %57 = arith.addi %56, %51 : index
              d2m.copy_single_row_tile(%39, %c31) to %46 at %c0 from %57, %arg3 : memref<10x10x!ttcore.tile<32x32, bf16>, #l1>, index, memref<1x10x!ttcore.tile<32x32, bf16>, #l1>, index, index, index
            }
            %54 = arith.cmpi sge, %arg2, %c9 : index
            d2m.copy_single_row_tile(%39, %c16) to %47 at %c15 from %53, %arg3 : memref<10x10x!ttcore.tile<32x32, bf16>, #l1>, index, memref<1x10x!ttcore.tile<32x32, bf16>, #l1>, index, index, index
            scf.if %54 {
              d2m.copy_single_row_tile(%42, %c0) to %47 at %c31 from %51, %arg3 : memref<1x10x!ttcore.tile<32x32, bf16>, #l1>, index, memref<1x10x!ttcore.tile<32x32, bf16>, #l1>, index, index, index
            } else {
              %55 = affine.apply #map4(%arg2)[%core0]
              %56 = arith.muli %55, %c10 : index
              %57 = arith.addi %56, %51 : index
              d2m.copy_single_row_tile(%39, %c0) to %47 at %c31 from %57, %arg3 : memref<10x10x!ttcore.tile<32x32, bf16>, #l1>, index, memref<1x10x!ttcore.tile<32x32, bf16>, #l1>, index, index, index
            }
          }
        ...
        %44 = d2m.reserve %11 {pin_cb = 2 : i64} : <memref<10x10x!ttcore.tile<32x32, bf16>, #l1>> -> memref<10x10x!ttcore.tile<32x32, bf16>, #l1>
        %45 = d2m.wait %4 : <memref<10x10x!ttcore.tile<32x32, bf16>, #l1>> -> memref<10x10x!ttcore.tile<32x32, bf16>, #l1>
        %tx = d2m.dma_read %45[%c0], %44[%c0], <100> : (memref<10x10x!ttcore.tile<32x32, bf16>, #l1>, memref<10x10x!ttcore.tile<32x32, bf16>, #l1>) -> !d2m.mem_tx<read>
      ...
      %c31 = arith.constant 31 : index
      %c1000 = arith.constant 1000 : index
      %4 = d2m.get_cb(8) resolution_stage =  compile : <memref<10x1x!ttcore.tile<32x32, bf16>, #l1>>
      %5 = d2m.get_cb(9) resolution_stage =  compile : <memref<10x1x!ttcore.tile<32x32, bf16>, #l1>>
      %6 = d2m.get_cb(12) resolution_stage =  compile : <memref<1x10x!ttcore.tile<32x32, bf16>, #l1>>
      %7 = d2m.get_cb(13) resolution_stage =  compile : <memref<1x10x!ttcore.tile<32x32, bf16>, #l1>>
      ...
      scf.for %arg1 = %c0 to %c1000 step %c1 {
        ...
        scf.for %arg2 = %c0 to %c10 step %c1 {
          %18 = d2m.reserve %6 {pin_cb = 12 : i64} : <memref<1x10x!ttcore.tile<32x32, bf16>, #l1>> -> memref<1x10x!ttcore.tile<32x32, bf16>, #l1>
          %19 = d2m.reserve %7 {pin_cb = 13 : i64} : <memref<1x10x!ttcore.tile<32x32, bf16>, #l1>> -> memref<1x10x!ttcore.tile<32x32, bf16>, #l1>
          ...
          d2m.dma_wait %tx : !d2m.mem_tx<read>
          %tx_20 = d2m.dma_read %13[%21], %19[%c0], <10> {srcByteOffset = -32 : si32} : (memref<10x10x!ttcore.tile<32x32, bf16>, #l1>, memref<1x10x!ttcore.tile<32x32, bf16>, #l1>) -> !d2m.mem_tx<read>
          d2m.dma_wait %tx_20 : !d2m.mem_tx<read>
          scf.for %arg3 = %c0 to %c10 step %c1 {
          ...
          d2m.push %7 {pin_cb = 13 : i64} : <memref<1x10x!ttcore.tile<32x32, bf16>, #l1>>
          d2m.push %6 {pin_cb = 12 : i64} : <memref<1x10x!ttcore.tile<32x32, bf16>, #l1>>
        }
      ...
      %9 = d2m.get_cb(12) resolution_stage =  compile : <memref<1x10x!ttcore.tile<32x32, bf16>, #l1>>
      %10 = d2m.get_cb(13) resolution_stage =  compile : <memref<1x10x!ttcore.tile<32x32, bf16>, #l1>>
      %11 = d2m.get_cb(14) resolution_stage =  compile : <memref<1x1x!ttcore.tile<32x32, bf16>, #l1>>
      %12 = d2m.get_cb(1) resolution_stage =  compile : <memref<10x10x!ttcore.tile<32x32, bf16>, #l1>>
      %13 = d2m.get_cb(2) resolution_stage =  compile : <memref<10x10x!ttcore.tile<32x32, bf16>, #l1>>
      scf.for %arg1 = %c0 to %c1000 step %c1 {
        %14 = d2m.wait %13 : <memref<10x10x!ttcore.tile<32x32, bf16>, #l1>> -> memref<10x10x!ttcore.tile<32x32, bf16>, #l1>
        %15 = d2m.reserve %12 {pin_cb = 1 : i64} : <memref<10x10x!ttcore.tile<32x32, bf16>, #l1>> -> memref<10x10x!ttcore.tile<32x32, bf16>, #l1>
        scf.for %arg2 = %c0 to %c10 step %c1 {
          scf.for %arg3 = %c0 to %c10 step %c1 {
            %dst_20 = d2m.acquire_dst() : memref<16x!ttcore.tile<32x32, bf16>, #dst>
            %23 = memref.load %14[%arg2, %arg3] : memref<10x10x!ttcore.tile<32x32, bf16>, #l1>
            ...
            %25 = "d2m.tile_transpose"(%24) : (!ttcore.tile<32x32, bf16>) -> !ttcore.tile<32x32, bf16>
            memref.store %25, %dst_20[%c0] : memref<16x!ttcore.tile<32x32, bf16>, #dst>
            %26 = memref.load %dst_20[%c0] : memref<16x!ttcore.tile<32x32, bf16>, #dst>
            memref.store %26, %15[%arg2, %arg3] : memref<10x10x!ttcore.tile<32x32, bf16>, #l1>
          }
        }
        d2m.push %12 {pin_cb = 1 : i64} : <memref<10x10x!ttcore.tile<32x32, bf16>, #l1>>
        %16 = d2m.reserve %11 {pin_cb = 14 : i64} : <memref<1x1x!ttcore.tile<32x32, bf16>, #l1>> -> memref<1x1x!ttcore.tile<32x32, bf16>, #l1>
        %dst = d2m.acquire_dst() : memref<16x!ttcore.tile<32x32, bf16>, #dst>
        %17 = d2m.tile_fill(%cst) : bf16 -> <32x32, bf16>
        memref.store %17, %dst[%c0] : memref<16x!ttcore.tile<32x32, bf16>, #dst>
        %18 = memref.load %dst[%c0] : memref<16x!ttcore.tile<32x32, bf16>, #dst>
        memref.store %18, %16[%c0, %c0] : memref<1x1x!ttcore.tile<32x32, bf16>, #l1>
        d2m.push %11 {pin_cb = 14 : i64} : <memref<1x1x!ttcore.tile<32x32, bf16>, #l1>>
        %19 = d2m.wait %5 : <memref<2x1x!ttcore.tile<32x32, bf16>, #l1>> -> memref<2x1x!ttcore.tile<32x32, bf16>, #l1>
        %20 = d2m.wait %6 : <memref<1x2x!ttcore.tile<32x32, bf16>, #l1>> -> memref<1x2x!ttcore.tile<32x32, bf16>, #l1>
        %21 = d2m.wait %11 : <memref<1x1x!ttcore.tile<32x32, bf16>, #l1>> -> memref<1x1x!ttcore.tile<32x32, bf16>, #l1>
        %22 = d2m.reserve %4 {pin_cb = 3 : i64} : <memref<10x10x!ttcore.tile<32x32, bf16>, #l1>> -> memref<10x10x!ttcore.tile<32x32, bf16>, #l1>
        scf.for %arg2 = %c0 to %c10 step %c1 {
          ...
          %25 = d2m.wait %9 : <memref<1x10x!ttcore.tile<32x32, bf16>, #l1>> -> memref<1x10x!ttcore.tile<32x32, bf16>, #l1>
          %26 = d2m.wait %10 : <memref<1x10x!ttcore.tile<32x32, bf16>, #l1>> -> memref<1x10x!ttcore.tile<32x32, bf16>, #l1>
          scf.for %arg3 = %c0 to %c10 step %c1 {
            %27 = affine.apply #map2(%arg2)
            %28 = affine.apply #map2(%arg3)
            %dst_20 = d2m.acquire_dst() : memref<16x!ttcore.tile<32x32, bf16>, #dst>
            %29 = memref.load %14[%27, %28] : memref<10x10x!ttcore.tile<32x32, bf16>, #l1>
            memref.store %29, %dst_20[%c0] : memref<16x!ttcore.tile<32x32, bf16>, #dst>
            %30 = memref.load %dst_20[%c0] : memref<16x!ttcore.tile<32x32, bf16>, #dst>
            %31 = memref.load %25[%c0, %arg3] : memref<1x10x!ttcore.tile<32x32, bf16>, #l1>
            %32 = memref.load %26[%c0, %arg3] : memref<1x10x!ttcore.tile<32x32, bf16>, #l1>
            %33 = "d2m.tile_add"(%32, %31) : (!ttcore.tile<32x32, bf16>, !ttcore.tile<32x32, bf16>) -> !ttcore.tile<32x32, bf16>
            ...
            %35 = "d2m.tile_transpose"(%34) : (!ttcore.tile<32x32, bf16>) -> !ttcore.tile<32x32, bf16>
            memref.store %35, %dst_20[%c1] : memref<16x!ttcore.tile<32x32, bf16>, #dst>
            %36 = memref.load %dst_20[%c1] : memref<16x!ttcore.tile<32x32, bf16>, #dst>
            %37 = memref.load %24[%c0, %arg3] : memref<1x10x!ttcore.tile<32x32, bf16>, #l1>
            %38 = "d2m.tile_add"(%30, %37) : (!ttcore.tile<32x32, bf16>, !ttcore.tile<32x32, bf16>) -> !ttcore.tile<32x32, bf16>
            memref.store %38, %dst_20[%c2] : memref<16x!ttcore.tile<32x32, bf16>, #dst>
            %39 = memref.load %dst_20[%c2] : memref<16x!ttcore.tile<32x32, bf16>, #dst>
            %40 = memref.load %23[%c0, %arg3] : memref<1x10x!ttcore.tile<32x32, bf16>, #l1>
            %41 = "d2m.tile_add"(%39, %40) : (!ttcore.tile<32x32, bf16>, !ttcore.tile<32x32, bf16>) -> !ttcore.tile<32x32, bf16>
            ...
            %43 = "d2m.tile_add"(%42, %36) : (!ttcore.tile<32x32, bf16>, !ttcore.tile<32x32, bf16>) -> !ttcore.tile<32x32, bf16>
            memref.store %43, %dst_20[%c2] : memref<16x!ttcore.tile<32x32, bf16>, #dst>
            %44 = memref.load %dst_20[%c2] : memref<16x!ttcore.tile<32x32, bf16>, #dst>
            %45 = memref.load %21[%c0, %c0] : memref<1x1x!ttcore.tile<32x32, bf16>, #l1>
            %46 = "d2m.tile_mul"(%44, %45) : (!ttcore.tile<32x32, bf16>, !ttcore.tile<32x32, bf16>) -> !ttcore.tile<32x32, bf16>
            memref.store %46, %dst_20[%c2] : memref<16x!ttcore.tile<32x32, bf16>, #dst>
            %47 = memref.load %dst_20[%c2] : memref<16x!ttcore.tile<32x32, bf16>, #dst>
            %48 = arith.cmpi eq, %arg2, %c9 : index
            %49 = arith.select %48, %c1, %c0 : index
            %50 = affine.apply #map5(%arg2)[%core0]
            %51 = arith.cmpi slt, %50, %c0 : index
            %52 = affine.apply #map6(%arg2)[%core0]
            %53 = arith.cmpi slt, %52, %c0 : index
            %54 = arith.ori %51, %53 : i1
            %55 = scf.if %54 -> (!ttcore.tile<32x32, bf16>) {
              %64 = arith.cmpi eq, %49, %c1 : index
              %65 = memref.load %19[%49, %c0] : memref<2x1x!ttcore.tile<32x32, bf16>, #l1>
              memref.store %65, %dst_20[%c1] : memref<16x!ttcore.tile<32x32, bf16>, #dst>
              %66 = memref.load %dst_20[%c1] : memref<16x!ttcore.tile<32x32, bf16>, #dst>
              %67 = scf.if %64 -> (!ttcore.tile<32x32, bf16>) {
                %68 = "d2m.tile_where"(%66, %47, %30) : (!ttcore.tile<32x32, bf16>, !ttcore.tile<32x32, bf16>, !ttcore.tile<32x32, bf16>) -> !ttcore.tile<32x32, bf16>
                memref.store %68, %dst_20[%c2] : memref<16x!ttcore.tile<32x32, bf16>, #dst>
                %69 = memref.load %dst_20[%c2] : memref<16x!ttcore.tile<32x32, bf16>, #dst>
                scf.yield %69 : !ttcore.tile<32x32, bf16>
              } else {
                %68 = "d2m.tile_where"(%66, %30, %47) : (!ttcore.tile<32x32, bf16>, !ttcore.tile<32x32, bf16>, !ttcore.tile<32x32, bf16>) -> !ttcore.tile<32x32, bf16>
                memref.store %68, %dst_20[%c2] : memref<16x!ttcore.tile<32x32, bf16>, #dst>
                %69 = memref.load %dst_20[%c2] : memref<16x!ttcore.tile<32x32, bf16>, #dst>
                scf.yield %69 : !ttcore.tile<32x32, bf16>
              }
              ...
              scf.yield %47 : !ttcore.tile<32x32, bf16>
            }
            %56 = arith.cmpi eq, %arg3, %c9 : index
            %57 = arith.select %56, %c1, %c0 : index
            %58 = affine.apply #map5(%arg3)[%core1]
            %59 = arith.cmpi slt, %58, %c0 : index
            %60 = affine.apply #map6(%arg3)[%core1]
            %61 = arith.cmpi slt, %60, %c0 : index
            %62 = arith.ori %59, %61 : i1
            %63 = scf.if %62 -> (!ttcore.tile<32x32, bf16>) {
              %64 = arith.cmpi eq, %57, %c1 : index
              %65 = memref.load %20[%c0, %57] : memref<1x2x!ttcore.tile<32x32, bf16>, #l1>
              memref.store %65, %dst_20[%c1] : memref<16x!ttcore.tile<32x32, bf16>, #dst>
              %66 = memref.load %dst_20[%c1] : memref<16x!ttcore.tile<32x32, bf16>, #dst>
              %67 = scf.if %64 -> (!ttcore.tile<32x32, bf16>) {
                %68 = "d2m.tile_where"(%66, %55, %30) : (!ttcore.tile<32x32, bf16>, !ttcore.tile<32x32, bf16>, !ttcore.tile<32x32, bf16>) -> !ttcore.tile<32x32, bf16>
                memref.store %68, %dst_20[%c2] : memref<16x!ttcore.tile<32x32, bf16>, #dst>
                %69 = memref.load %dst_20[%c2] : memref<16x!ttcore.tile<32x32, bf16>, #dst>
                scf.yield %69 : !ttcore.tile<32x32, bf16>
              } else {
                %68 = "d2m.tile_where"(%66, %30, %55) : (!ttcore.tile<32x32, bf16>, !ttcore.tile<32x32, bf16>, !ttcore.tile<32x32, bf16>) -> !ttcore.tile<32x32, bf16>
                memref.store %68, %dst_20[%c2] : memref<16x!ttcore.tile<32x32, bf16>, #dst>
                %69 = memref.load %dst_20[%c2] : memref<16x!ttcore.tile<32x32, bf16>, #dst>
                scf.yield %69 : !ttcore.tile<32x32, bf16>
              }
              ...
              scf.yield %55 : !ttcore.tile<32x32, bf16>
            }
            memref.store %63, %22[%arg2, %arg3] : memref<10x10x!ttcore.tile<32x32, bf16>, #l1>
          }
          d2m.pop %10 : <memref<1x10x!ttcore.tile<32x32, bf16>, #l1>>
          d2m.pop %9 : <memref<1x10x!ttcore.tile<32x32, bf16>, #l1>>
          d2m.pop %8 : <memref<1x10x!ttcore.tile<32x32, bf16>, #l1>>
          d2m.pop %7 : <memref<1x10x!ttcore.tile<32x32, bf16>, #l1>>
        }
