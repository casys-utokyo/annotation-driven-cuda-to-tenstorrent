...
module {
  func.func @_Z15runJacobi2DCUDAiiPfS__driver(%arg0: memref<3200x3200xbf16>) -> memref<3200x3200xbf16> attributes {tt.d2m_emittable = true, tt.d2m_unhandled = 0 : i64, tt.function_type = "forward_device", tt.l1_peak = 718848 : i64, tt.l1_persistent_base = 309248 : i64, tt.l1_pool = 309248 : i64} {
    %alloc = memref.alloc() {address = 420352 : i64, alignment = 16 : i64} : memref<10x10x10x10x!ttcore.tile<32x32, bf16>, #ttcore.shard<20480x2048, 1>, #l1>
    %alloc_0 = memref.alloc() {address = 625152 : i64, alignment = 16 : i64} : memref<10x10x10x10x!ttcore.tile<32x32, bf16>, #ttcore.shard<20480x2048, 1>, #l1>
    ...
    %alloc_6 = memref.alloc() {address = 397824 : i64, alignment = 16 : i64} : memref<1x1x!ttcore.tile<32x32, bf16>, #ttcore.cb_layout<2048x2048, 2>, #l1>
    ...
    %alloc_11 = memref.alloc() {address = 418304 : i64, alignment = 16 : i64} : memref<1x1x!ttcore.tile<32x32, bf16>, #ttcore.cb_layout<2048x2048, 1>, #l1>
    ...
    d2m.generic {block_factors = [], grid = #ttcore.grid<10x10>, indexing_maps = [], iterator_types = [], threads = [#d2m.thread<datamovement>, #d2m.thread<datamovement>, #d2m.thread<compute>]}
      ...
      %7 = d2m.get_cb(8) resolution_stage =  compile : <memref<1x1x!ttcore.tile<32x32, bf16>, #l1>>
      ...
      scf.for %arg1 = %c0 to %c1000 step %c1 {
        ...
        scf.for %arg2 = %c0 to %c10 step %c1 {
          scf.for %arg3 = %c0 to %c10 step %c1 {
            ...
            %26 = d2m.reserve %7 {pin_cb = 8 : i64} : <memref<1x1x!ttcore.tile<32x32, bf16>, #l1>> -> memref<1x1x!ttcore.tile<32x32, bf16>, #l1>
            %27 = arith.muli %25, %c10 : index
            %28 = arith.addi %27, %24 : index
            %29 = arith.muli %28, %c2048 : index
            %tx = d2m.dma_read %16[%29], %26[%c0], <1> {srcByteOffset = -32 : si32} : (memref<10x10x!ttcore.tile<32x32, bf16>, #l1>, memref<1x1x!ttcore.tile<32x32, bf16>, #l1>) -> !d2m.mem_tx<read>
            d2m.dma_wait %tx : !d2m.mem_tx<read>
            d2m.copy_single_row_tile(%16, %c15) to %26 at %c16 from %28, %c0 : memref<10x10x!ttcore.tile<32x32, bf16>, #l1>, index, memref<1x1x!ttcore.tile<32x32, bf16>, #l1>, index, index, index
            scf.if %23 {
              d2m.copy_single_row_tile(%18, %c31) to %26 at %c0 from %24, %c0 : memref<1x10x!ttcore.tile<32x32, bf16>, #l1>, index, memref<1x1x!ttcore.tile<32x32, bf16>, #l1>, index, index, index
            } else {
              %32 = affine.apply #map1(%arg2)[%core0]
              %33 = arith.muli %32, %c10 : index
              %34 = arith.addi %33, %24 : index
              d2m.copy_single_row_tile(%16, %c31) to %26 at %c0 from %34, %c0 : memref<10x10x!ttcore.tile<32x32, bf16>, #l1>, index, memref<1x1x!ttcore.tile<32x32, bf16>, #l1>, index, index, index
            }
            d2m.push %7 {pin_cb = 8 : i64} : <memref<1x1x!ttcore.tile<32x32, bf16>, #l1>>
            %30 = arith.cmpi sge, %arg2, %c9 : index
            %31 = d2m.reserve %8 {pin_cb = 9 : i64} : <memref<1x1x!ttcore.tile<32x32, bf16>, #l1>> -> memref<1x1x!ttcore.tile<32x32, bf16>, #l1>
            %tx_19 = d2m.dma_read %16[%29], %31[%c0], <1> {srcByteOffset = 32 : si32} : (memref<10x10x!ttcore.tile<32x32, bf16>, #l1>, memref<1x1x!ttcore.tile<32x32, bf16>, #l1>) -> !d2m.mem_tx<read>
            d2m.dma_wait %tx_19 : !d2m.mem_tx<read>
            d2m.copy_single_row_tile(%16, %c16) to %31 at %c15 from %28, %c0 : memref<10x10x!ttcore.tile<32x32, bf16>, #l1>, index, memref<1x1x!ttcore.tile<32x32, bf16>, #l1>, index, index, index
            scf.if %30 {
              d2m.copy_single_row_tile(%19, %c0) to %31 at %c31 from %24, %c0 : memref<1x10x!ttcore.tile<32x32, bf16>, #l1>, index, memref<1x1x!ttcore.tile<32x32, bf16>, #l1>, index, index, index
            } else {
              %32 = affine.apply #map2(%arg2)[%core0]
              %33 = arith.muli %32, %c10 : index
              %34 = arith.addi %33, %24 : index
              d2m.copy_single_row_tile(%16, %c0) to %31 at %c31 from %34, %c0 : memref<10x10x!ttcore.tile<32x32, bf16>, #l1>, index, memref<1x1x!ttcore.tile<32x32, bf16>, #l1>, index, index, index
            }
      ...
      scf.for %arg1 = %c0 to %c1000 step %c1 {
        ...
        scf.for %arg2 = %c0 to %c10 step %c1 {
          scf.for %arg3 = %c0 to %c10 step %c1 {
            ...
            %21 = d2m.reserve %6 {pin_cb = 10 : i64} : <memref<1x1x!ttcore.tile<32x32, bf16>, #l1>> -> memref<1x1x!ttcore.tile<32x32, bf16>, #l1>
            ...
            d2m.push %6 {pin_cb = 10 : i64} : <memref<1x1x!ttcore.tile<32x32, bf16>, #l1>>
            %25 = arith.cmpi slt, %arg3, %c1 : index
            %26 = d2m.reserve %7 {pin_cb = 11 : i64} : <memref<1x1x!ttcore.tile<32x32, bf16>, #l1>> -> memref<1x1x!ttcore.tile<32x32, bf16>, #l1>
            %tx_19 = d2m.dma_read %13[%24], %26[%c0], <1> {srcByteOffset = -32 : si32} : (memref<10x10x!ttcore.tile<32x32, bf16>, #l1>, memref<1x1x!ttcore.tile<32x32, bf16>, #l1>) -> !d2m.mem_tx<read>
            d2m.dma_wait %tx_19 : !d2m.mem_tx<read>
      ...
      scf.for %arg1 = %c0 to %c1000 step %c1 {
        ...
        scf.for %arg2 = %c0 to %c10 step %c1 {
          scf.for %arg3 = %c0 to %c10 step %c1 {
            ...
            %21 = memref.load %12[%19, %20] : memref<10x10x!ttcore.tile<32x32, bf16>, #l1>
            %22 = d2m.wait %7 : <memref<1x1x!ttcore.tile<32x32, bf16>, #l1>> -> memref<1x1x!ttcore.tile<32x32, bf16>, #l1>
            %23 = memref.load %22[%c0, %c0] : memref<1x1x!ttcore.tile<32x32, bf16>, #l1>
            %24 = d2m.wait %8 : <memref<1x1x!ttcore.tile<32x32, bf16>, #l1>> -> memref<1x1x!ttcore.tile<32x32, bf16>, #l1>
            %25 = memref.load %24[%c0, %c0] : memref<1x1x!ttcore.tile<32x32, bf16>, #l1>
            %dst_19 = d2m.acquire_dst() : memref<16x!ttcore.tile<32x32, bf16>, #dst>
            %26 = "d2m.tile_add"(%25, %23) : (!ttcore.tile<32x32, bf16>, !ttcore.tile<32x32, bf16>) -> !ttcore.tile<32x32, bf16>
            ...
            %28 = "d2m.tile_transpose"(%27) : (!ttcore.tile<32x32, bf16>) -> !ttcore.tile<32x32, bf16>
            ...
            %32 = "d2m.tile_add"(%21, %31) : (!ttcore.tile<32x32, bf16>, !ttcore.tile<32x32, bf16>) -> !ttcore.tile<32x32, bf16>
            memref.store %32, %dst_19[%c1] : memref<16x!ttcore.tile<32x32, bf16>, #dst>
            %33 = memref.load %dst_19[%c1] : memref<16x!ttcore.tile<32x32, bf16>, #dst>
            d2m.pop %6 : <memref<1x1x!ttcore.tile<32x32, bf16>, #l1>>
            %34 = d2m.wait %5 : <memref<1x1x!ttcore.tile<32x32, bf16>, #l1>> -> memref<1x1x!ttcore.tile<32x32, bf16>, #l1>
            %35 = memref.load %34[%c0, %c0] : memref<1x1x!ttcore.tile<32x32, bf16>, #l1>
            %36 = "d2m.tile_add"(%33, %35) : (!ttcore.tile<32x32, bf16>, !ttcore.tile<32x32, bf16>) -> !ttcore.tile<32x32, bf16>
            ...
            %38 = "d2m.tile_add"(%37, %29) : (!ttcore.tile<32x32, bf16>, !ttcore.tile<32x32, bf16>) -> !ttcore.tile<32x32, bf16>
