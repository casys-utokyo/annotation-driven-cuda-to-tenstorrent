      ...
      ^bb0(%arg3: memref<5120x5120xf32>):
        ...
        tileplan.temporal_for (%arg4) in (0, 5119, 1) {
          task.group @dm0_0 engine(<dm0>) domain(<phase>) reads(%0 : !tileplan.l1_buffer [full]) writes(%1 : !tileplan.l1_buffer [full], %3 : !tileplan.l1_buffer [full], %4 : !tileplan.l1_buffer [full]) {
            ...
            tileplan.shard_for (%arg5) in (%c16) axis <row> {
              ...
              scf.for %arg6 = %c0_14 to %c32 step %c1_15 {
                ...
                %cst_19 = arith.constant 0.000000e+00 : f32
                %29 = arith.select %28, %26, %cst_19 : f32
                tileflow.element_store %29 to %6[%arg5, %c0_16] at(%arg6, %c0_14) {task.engine_label = "dm"} : f32 to !tileplan.l1_buffer
              } {task.engine_label = "dm"}
            }
          }
          task.group @compute_0 engine(<compute>) domain(<phase>) reads(%2 : !tileplan.l1_buffer [full], %6 : !tileplan.l1_buffer [full], %0 : !tileplan.l1_buffer [full], %5 : !tileplan.l1_buffer [full]) writes(%0 : !tileplan.l1_buffer [full]) {
            ...
            tileplan.shard_for (%arg5) in (%c16) axis <row> {
              %c0_3 = arith.constant 0 : index
              %11 = tileflow.read_l1_buffer %6 at(%arg5, %c0_3) on col(%9) epoch(%arg4) : !tileplan.l1_buffer -> !d2mtile.tile<f32>
              %12 = d2mtile.binary tile_mul %10, %11 -> "source_ssa" bcast col {task.engine_label = "compute"} : !d2mtile.tile<f32>
              tileplan.shard_for (%arg6) in (%c16_1) axis <col> {
                ...
                %c0_4 = arith.constant 0 : index
                %16 = tileflow.read_l1_buffer %5 at(%c0_4, %arg6) epoch(%arg4) : !tileplan.l1_buffer -> !d2mtile.tile<f32>
                %17 = d2mtile.binary tile_mul %12, %16 -> "source_ssa" {task.engine_label = "compute"} : !d2mtile.tile<f32>
                %18 = d2mtile.binary tile_sub %15, %17 -> "source_ssa" {task.engine_label = "compute"} : !d2mtile.tile<f32>
                tileflow.write_l1_buffer %0 at(%arg5, %arg6) epoch(%arg4) to %18 {task.engine_label = "compute"} : !tileplan.l1_buffer to !d2mtile.tile<f32>
              }
            }
          }
        } {epoch_id = 0 : i64}
