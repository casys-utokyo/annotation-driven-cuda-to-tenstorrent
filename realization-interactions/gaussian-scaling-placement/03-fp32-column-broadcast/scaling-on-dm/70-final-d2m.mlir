...
module {
  func.func @_Z10ForwardSubPfS__driver(%arg0: memref<5120x5120xf32>) -> memref<5120x5120xf32> attributes {tt.d2m_emittable = true, tt.d2m_unhandled = 0 : i64, tt.function_type = "forward_device", tt.l1_peak = 1261568 : i64, tt.l1_persistent_base = 212992 : i64, tt.l1_pool = 212992 : i64} {
    ...
    d2m.generic {block_factors = [], grid = #ttcore.grid<10x10>, indexing_maps = [], iterator_types = [], threads = [#d2m.thread<datamovement>, #d2m.thread<compute>]}
      ...
      d2m.remote_load %alloc_7[%core0, %core1] into %2 : memref<10x10x16x16x!ttcore.tile<32x32, f32>, #ttcore.shard<65536x4096, 1>, #dram> into !d2m.cb<memref<16x16x!ttcore.tile<32x32, f32>, #l1>>
    }, {
    ^compute0:
    }
    ...
    d2m.generic {block_factors = [], grid = #ttcore.grid<10x10>, indexing_maps = [], iterator_types = [], threads = [#d2m.thread<datamovement>, #d2m.thread<datamovement>, #d2m.thread<compute>]}
      ...
      scf.for %arg1 = %c0 to %c5119 step %c1 {
        ...
        %22 = d2m.get_arg(9) : !d2m.local_semaphore
        scf.for %arg2 = %c0 to %c10 step %c1 {
          scf.for %arg3 = %c0 to %c10 step %c1 {
        ...
        scf.for %arg2 = %c0 to %c16 step %c1 {
          scf.for %arg3 = %c0 to %c32 step %c1 {
            ...
            d2m.tile_elem_store %31, %6[%arg2, %12, %arg3] : i32, !d2m.cb<memref<1x16x!ttcore.tile<32x32, f32>, #l1>>, index, index, index
          }
          d2m.bcast_row_to_tile(%24, %12) to %24 at %arg2, %arg2 of %c16 : memref<1x16x!ttcore.tile<32x32, f32>, #l1>, index, memref<1x16x!ttcore.tile<32x32, f32>, #l1>, index, index, index
        }
        ...
        scf.for %arg2 = %c0 to %c16 step %c1 {
          ...
          scf.for %arg3 = %c0 to %c32 step %c1 {
            ...
            d2m.tile_elem_store %35, %7[%c0, %arg3, %c0] : i32, !d2m.cb<memref<1x1x!ttcore.tile<32x32, f32>, #l1>>, index, index, index
          }
    ...
    ^datamovement1:
      ...
      %c16 = arith.constant 16 : index
      %c5119 = arith.constant 5119 : index
      %2 = d2m.get_cb(6) resolution_stage =  compile : <memref<1x16x!ttcore.tile<32x32, f32>, #l1>>
      %3 = d2m.get_cb(7) resolution_stage =  compile : <memref<1x1x!ttcore.tile<32x32, f32>, #l1>>
      ...
      scf.for %arg1 = %c0 to %c5119 step %c1 {
        ...
        scf.for %arg2 = %c0 to %c16 step %c1 {
          ...
          scf.for %arg3 = %c0 to %c16 step %c1 {
            ...
            %17 = "d2m.tile_bcast_binary"(%14, %16) <{bcast_type = #d2m<tile_bcast_type col>, binop_type = #d2m<tile_bcast_binary_op_type mul>}> : (!ttcore.tile<32x32, f32>, !ttcore.tile<32x32, f32>) -> !ttcore.tile<32x32, f32>
            ...
            memref.store %19, %dst[%c1] : memref<16x!ttcore.tile<32x32, f32>, #dst>
            %20 = memref.load %dst[%c1] : memref<16x!ttcore.tile<32x32, f32>, #dst>
    ...
    d2m.generic {block_factors = [], grid = #ttcore.grid<10x10>, indexing_maps = [], iterator_types = [], threads = [#d2m.thread<datamovement>, #d2m.thread<compute>]}
      ...
      d2m.remote_store %alloc_7[%core0, %core1] from %2 : memref<10x10x16x16x!ttcore.tile<32x32, f32>, #ttcore.shard<65536x4096, 1>, #dram> from !d2m.cb<memref<16x16x!ttcore.tile<32x32, f32>, #l1>>
    }, {
      %2 = d2m.get_cb(0) resolution_stage =  compile : <memref<16x16x!ttcore.tile<32x32, f32>, #l1>>
