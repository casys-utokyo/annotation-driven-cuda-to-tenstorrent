        ...
        tileplan.temporal_for (%arg6) in (0, 5119, 1) {
          ...
          tileplan.shard_for (%arg7) in (%c16_1) axis <row> {
            ...
            tileplan.shard_for (%arg8) in (%c16_3) axis <col> {
              ...
              %14 = tileflow.broadcast %13 kind row from(%8) : !d2mtile.tile<f32> -> !d2mtile.tile<f32>
              ...
              %21 = d2mtile.binary tile_mul %18, %7 -> "source_ssa" {tileflow.realization_engine = #tileflow.engine<dm>} : !d2mtile.tile<f32>
