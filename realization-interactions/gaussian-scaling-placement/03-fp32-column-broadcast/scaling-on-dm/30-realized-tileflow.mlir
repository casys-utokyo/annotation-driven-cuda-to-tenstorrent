      ...
      ^bb0(%arg4: memref<5120x5120xf32>, %arg5: memref<5120x5120xf32>):
        ...
        tileplan.temporal_for (%arg6) in (0, 5119, 1) {
          ...
          tileplan.shard_for (%arg7) in (%c16_1) axis <row> {
            ...
            %30 = d2mtile.binary tile_mul %29, %15 -> "source_ssa" at col(%16) {tileflow.execution = "dm"} : !d2mtile.tile<f32>
            %31 = tileflow.broadcast %30 kind col from(%16) {tileflow.consumer_bcast} : !d2mtile.tile<f32> -> !d2mtile.tile<f32>
            tileplan.shard_for (%arg8) in (%c16_3) axis <col> {
              ...
              %34 = d2mtile.binary tile_mul %33, %31 -> "source_ssa" bcast col : !d2mtile.tile<f32>
