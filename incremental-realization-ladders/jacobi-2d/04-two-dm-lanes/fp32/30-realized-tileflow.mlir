    ...
    tileplan.device_for (%arg2, %arg3) in (%c10_0, %c10) {
      ...
      ^bb0(%arg4: memref<3200x3200xf32>, %arg5: memref<3200x3200xf32>):
        ...
        tileplan.temporal_for (%arg6) in (0, 1000, 1) {
          ...
          %40 = tileflow.frame_delivery %2 source_core(%arg2, %11) source_slice(%c0_15, %c0_16) shape(10, 1) {task.dm_lane = #task.engine<dm1>} : !tileplan.l1_buffer -> !tileflow.frame<!d2mtile.tile<f32>>
          %41 = tileflow.frame_delivery %2 source_core(%arg2, %13) source_slice(%c0_19, %c9_20) shape(10, 1) {task.dm_lane = #task.engine<dm1>} : !tileplan.l1_buffer -> !tileflow.frame<!d2mtile.tile<f32>>
          tileplan.shard_for (%arg7) in (%c10_1) axis <row> {
            ...
            tileplan.shard_for (%arg8) in (%c10_3) axis <col> {
              ...
              %84 = tileflow.roll %83 axis row by 1 {task.dm_lane = #task.engine<dm1>, tileflow.execution = "dm"} : !d2mtile.tile<f32>
              ...
              %92 = tileflow.roll %91 axis row by -1 {task.dm_lane = #task.engine<dm1>, tileflow.execution = "dm"} : !d2mtile.tile<f32>
