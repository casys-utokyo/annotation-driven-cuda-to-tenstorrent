...
module {
  func.func @_Z15runJacobi2DCUDAiiPfS__driver(%arg0: memref<3200x3200xbf16> {tileplan.abi_index = 0 : i64, tileplan.tensor_role = #tileplan.tensor_role<inout>}) attributes {tileplan.selected_compute, tt.l1_peak = 722944 : i64, tt.l1_persistent_base = 313344 : i64, tt.l1_pool = 313344 : i64} {
    %c10 = arith.constant 10 : index
    %c10_0 = arith.constant 10 : index
    tileplan.device_for (%arg1, %arg2) in (%c10_0, %c10) {
      %0 = tileplan.persistent_l1 elem bf16 tile(32, 32) domain(10, 10) order(0) {logical_tiles = [100, 100], partition = [10, 10], physical_grid = [10, 10], shard = [10, 10], tt.frame_pages = 100 : i64, tt.l1_offset = 313344 : i64, tt.mailbox_depth = 1 : i64, tt.storage_bytes = 204800 : i64, tt.storage_depth = 1 : i64, tt.storage_kind = "persistent"} : !tileplan.l1_buffer
      %1 = tileplan.persistent_l1 name "frame.converted" elem bf16 tile(32, 32) domain(10, 10) order(1) {tt.frame_pages = 100 : i64, tt.l1_offset = 518144 : i64, tt.mailbox_depth = 1 : i64, tt.storage_bytes = 204800 : i64, tt.storage_depth = 1 : i64, tt.storage_kind = "persistent"} : !tileplan.l1_buffer
      tileplan.phase name "compute" ins() outs(%arg0 : memref<3200x3200xbf16>) {
      ^bb0(%arg3: memref<3200x3200xbf16>):
        %2 = tileplan.l1_buffer role<constructed> elem bf16 tile(32, 32) domain(10, 10) order(0) {frame_axis = #tileplan.axis<row_col>, task.fill_axis = #tileplan.axis<col>, task.slot_access = #task.slot_access<resident>, tt.cb_id = 0 : i64, tt.frame_pages = 100 : i64, tt.l1_offset = 0 : i64, tt.mailbox_depth = 1 : i64, tt.storage_bytes = 204800 : i64, tt.storage_depth = 1 : i64, tt.storage_kind = "addressed_mailbox"} : !tileplan.l1_buffer
        %3 = tileplan.l1_buffer role<constructed> elem bf16 tile(32, 32) domain(1, 2) order(1) {frame_axis = #tileplan.axis<col>, task.frame_access = "replay", task.reuse = 10 : i64, task.slot_access = #task.slot_access<resident>, tt.cb_id = 1 : i64, tt.frame_pages = 2 : i64, tt.l1_offset = 204800 : i64, tt.mailbox_depth = 1 : i64, tt.storage_bytes = 4096 : i64, tt.storage_depth = 1 : i64, tt.storage_kind = "addressed_mailbox"} : !tileplan.l1_buffer
        %4 = tileplan.l1_buffer role<receive> elem bf16 tile(32, 32) domain(1, 10) order(2) {frame_axis = #tileplan.axis<col>, task.delivery_initialized, task.slot_access = #task.slot_access<resident>, tt.cb_id = 2 : i64, tt.frame_pages = 10 : i64, tt.l1_offset = 208896 : i64, tt.mailbox_depth = 1 : i64, tt.storage_bytes = 20480 : i64, tt.storage_depth = 1 : i64, tt.storage_kind = "addressed_mailbox"} : !tileplan.l1_buffer
        %5 = tileplan.l1_buffer role<receive> elem bf16 tile(32, 32) domain(1, 10) order(3) {frame_axis = #tileplan.axis<col>, task.delivery_initialized, task.slot_access = #task.slot_access<resident>, tt.cb_id = 3 : i64, tt.frame_pages = 10 : i64, tt.l1_offset = 229376 : i64, tt.mailbox_depth = 1 : i64, tt.storage_bytes = 20480 : i64, tt.storage_depth = 1 : i64, tt.storage_kind = "addressed_mailbox"} : !tileplan.l1_buffer
        %6 = tileplan.l1_buffer role<receive> elem bf16 tile(32, 32) domain(10, 1) order(4) {frame_axis = #tileplan.axis<row>, task.delivery_initialized, task.slot_access = #task.slot_access<resident>, tt.cb_id = 4 : i64, tt.frame_pages = 10 : i64, tt.l1_offset = 249856 : i64, tt.mailbox_depth = 1 : i64, tt.storage_bytes = 20480 : i64, tt.storage_depth = 1 : i64, tt.storage_kind = "addressed_mailbox"} : !tileplan.l1_buffer
        %7 = tileplan.l1_buffer role<receive> elem bf16 tile(32, 32) domain(10, 1) order(5) {frame_axis = #tileplan.axis<row>, task.delivery_initialized, task.slot_access = #task.slot_access<resident>, tt.cb_id = 5 : i64, tt.frame_pages = 10 : i64, tt.l1_offset = 270336 : i64, tt.mailbox_depth = 1 : i64, tt.storage_bytes = 20480 : i64, tt.storage_depth = 1 : i64, tt.storage_kind = "addressed_mailbox"} : !tileplan.l1_buffer
        %8 = tileplan.l1_buffer role<constructed> elem bf16 tile(32, 32) domain(10, 10) resident(1, 1) order(6) {frame_axis = #tileplan.axis<row_col>, task.drain_axis = #tileplan.axis<col>, task.fill_axis = #tileplan.axis<col>, task.slot_access = #task.slot_access<single_pass>, task.stream = #tileplan.axis<col>, tt.cb_id = 6 : i64, tt.frame_pages = 1 : i64, tt.l1_offset = 290816 : i64, tt.mailbox_depth = 2 : i64, tt.storage_bytes = 4096 : i64, tt.storage_depth = 2 : i64, tt.storage_kind = "addressed_mailbox"} : !tileplan.l1_buffer
        ...
        %10 = tileplan.l1_buffer role<constructed> elem bf16 tile(32, 32) domain(10, 10) resident(1, 1) order(8) {frame_axis = #tileplan.axis<row_col>, task.drain_axis = #tileplan.axis<col>, task.fill_axis = #tileplan.axis<col>, task.slot_access = #task.slot_access<single_pass>, task.stream = #tileplan.axis<col>, tt.cb_id = 8 : i64, tt.frame_pages = 1 : i64, tt.l1_offset = 299008 : i64, tt.mailbox_depth = 2 : i64, tt.storage_bytes = 4096 : i64, tt.storage_depth = 2 : i64, tt.storage_kind = "addressed_mailbox"} : !tileplan.l1_buffer
        %11 = tileplan.l1_buffer role<constructed> elem bf16 tile(32, 32) domain(10, 10) resident(1, 1) order(9) {frame_axis = #tileplan.axis<row_col>, task.drain_axis = #tileplan.axis<col>, task.fill_axis = #tileplan.axis<col>, task.slot_access = #task.slot_access<single_pass>, task.stream = #tileplan.axis<col>, tt.cb_id = 9 : i64, tt.frame_pages = 1 : i64, tt.l1_offset = 303104 : i64, tt.mailbox_depth = 2 : i64, tt.storage_bytes = 4096 : i64, tt.storage_depth = 2 : i64, tt.storage_kind = "addressed_mailbox"} : !tileplan.l1_buffer
        %12 = tileplan.l1_buffer role<constructed> elem bf16 tile(32, 32) domain(10, 10) resident(1, 1) order(10) {frame_axis = #tileplan.axis<row_col>, task.drain_axis = #tileplan.axis<col>, task.slot_access = #task.slot_access<single_pass>, tt.cb_id = 10 : i64, tt.frame_pages = 1 : i64, tt.l1_offset = 307200 : i64, tt.mailbox_depth = 2 : i64, tt.storage_bytes = 4096 : i64, tt.storage_depth = 2 : i64, tt.storage_kind = "addressed_mailbox"} : !tileplan.l1_buffer
        %13 = tileplan.l1_buffer role<intermediate> name "dst_spill_11" elem bf16 tile(32, 32) domain(1, 1) order(11) {tt.cb_id = 11 : i64, tt.dst_spill, tt.frame_pages = 1 : i64, tt.l1_offset = 311296 : i64, tt.mailbox_depth = 1 : i64, tt.storage_bytes = 2048 : i64, tt.storage_depth = 1 : i64, tt.storage_kind = "addressed_mailbox"} : !tileplan.l1_buffer
        tileplan.bind_persistent %0 : !tileplan.l1_buffer reads(%arg3 : memref<3200x3200xbf16>) writes(%arg3 : memref<3200x3200xbf16>) {producer = "dm", tt.cb_id = 12 : i64}
        ...
        task.group @dm0_0 engine(<dm0>) domain(<phase>) reads() writes(%3 : !tileplan.l1_buffer [full]) {
          ...
          tileplan.shard_for (%arg4) in (%c1) axis <col> {
            ...
            tileflow.write_l1_buffer %3 at(%c0, %c0_1) to %15 : !tileplan.l1_buffer to !tileflow.mask<bf16>
            ...
            tileflow.write_l1_buffer %3 at(%c0_3, %c1_4) to %17 : !tileplan.l1_buffer to !tileflow.mask<bf16>
          }
          ...
          task.group @dm0_0_1 engine(<dm0>) domain(<phase>) reads() writes() {
            ...
            tileplan.shard_for (%arg5) in (%c10_1) axis <row> {
              tileplan.shard_for (%arg6) in (%c10_2) axis <col> {
                ...
                %30 = tileflow.read_l1_buffer %4 at(%20, %29) epoch(%arg4) : !tileplan.l1_buffer -> !d2mtile.tile<bf16>
                ...
                tileflow.write_l1_buffer %8 at(%arg5, %arg6) epoch(%arg4) to %37 : !tileplan.l1_buffer to !d2mtile.tile<bf16>
                ...
                %49 = tileflow.read_l1_buffer %5 at(%21, %48) epoch(%arg4) : !tileplan.l1_buffer -> !d2mtile.tile<bf16>
                ...
                tileflow.write_l1_buffer %9 at(%arg5, %arg6) epoch(%arg4) to %53 : !tileplan.l1_buffer to !d2mtile.tile<bf16>
          ...
          task.group @dm1_0 engine(<dm1>) domain(<phase>) reads() writes() after [#task.dep<@compute_0, raw>] {
            ...
            tileplan.shard_for (%arg5) in (%c10_1) axis <row> {
              tileplan.shard_for (%arg6) in (%c10_2) axis <col> {
                ...
                %35 = tileflow.read_l1_buffer %6 at(%34, %19) epoch(%arg4) : !tileplan.l1_buffer -> !d2mtile.tile<bf16>
                ...
                tileflow.write_l1_buffer %10 at(%arg5, %arg6) epoch(%arg4) to %37 : !tileplan.l1_buffer to !d2mtile.tile<bf16>
                ...
                %51 = tileflow.read_l1_buffer %7 at(%50, %21) epoch(%arg4) : !tileplan.l1_buffer -> !d2mtile.tile<bf16>
                ...
                tileflow.write_l1_buffer %11 at(%arg5, %arg6) epoch(%arg4) to %53 : !tileplan.l1_buffer to !d2mtile.tile<bf16>
          ...
          task.group @compute_0_1 engine(<compute>) domain(<phase>) reads(%4 : !tileplan.l1_buffer [full], %5 : !tileplan.l1_buffer [full], %6 : !tileplan.l1_buffer [full], %1 : !tileplan.l1_buffer [full], %7 : !tileplan.l1_buffer [full], %3 : !tileplan.l1_buffer [full]) writes() after [#task.dep<@dm0_0, raw>] {
            ...
            tileplan.shard_for (%arg5) in (%c10_2) axis <row> {
              tileplan.shard_for (%arg6) in (%c10_3) axis <col> {
                ...
                %20 = tileflow.read_l1_buffer %10 at(%arg5, %arg6) epoch(%arg4) : !tileplan.l1_buffer -> !d2mtile.tile<bf16>
                task.epoch_wait %11 epoch(%arg4) : !tileplan.l1_buffer
                %21 = tileflow.read_l1_buffer %11 at(%arg5, %arg6) epoch(%arg4) : !tileplan.l1_buffer -> !d2mtile.tile<bf16>
                ...
                %24 = tileflow.read_l1_buffer %9 at(%arg5, %arg6) epoch(%arg4) : !tileplan.l1_buffer -> !d2mtile.tile<bf16>
                ...
                %26 = tileflow.read_l1_buffer %8 at(%arg5, %arg6) epoch(%arg4) : !tileplan.l1_buffer -> !d2mtile.tile<bf16>
                ...
                %29 = tileflow.read_l1_buffer %13 at(%c0_6, %c0_7) epoch(%arg4) : !tileplan.l1_buffer -> !d2mtile.tile<bf16>
                ...
                %33 = tileflow.read_l1_buffer %3 at(%c0_8, %32) {tt.dst_slot = 1 : i64} : !tileplan.l1_buffer -> !tileflow.mask<bf16>
                ...
                tileflow.write_l1_buffer %2 at(%arg5, %arg6) epoch(%arg4) to %41 {task.engine_label = "compute"} : !tileplan.l1_buffer to !d2mtile.tile<bf16>
          ...
          task.group @dm0_1 engine(<dm0>) domain(<phase>) reads() writes() after [#task.dep<@compute_0_1, raw>] {
            ...
            tileplan.shard_for (%arg5) in (%c10_1) axis <row> {
              tileplan.shard_for (%arg6) in (%c10_2) axis <col> {
                ...
                %19 = tileflow.read_l1_buffer %2 at(%17, %18) epoch(%arg4) : !tileplan.l1_buffer -> !d2mtile.tile<bf16>
                ...
                scf.if %28 {
                  %29 = tileflow.lane_copy %19 with %16 if(%23) axis row src_lane 0 dst_lane 0 {task.engine_label = "dm", tileflow.overlay = #tileflow.overlay_realization<dm_copy>} : !d2mtile.tile<bf16>
                  %30 = tileflow.lane_copy %29 with %16 if(%27) axis row src_lane 31 dst_lane 31 {task.engine_label = "dm", tileflow.overlay = #tileflow.overlay_realization<dm_copy>} : !d2mtile.tile<bf16>
                  task.epoch_acquire %12 epoch(%arg4) : !tileplan.l1_buffer
                  tileflow.write_l1_buffer %12 at(%arg5, %arg6) epoch(%arg4) to %30 : !tileplan.l1_buffer to !d2mtile.tile<bf16>
                  task.epoch_ready %12 epoch(%arg4) : !tileplan.l1_buffer
                  task.epoch_wait %12 epoch(%arg4) : !tileplan.l1_buffer
                  %31 = tileflow.read_l1_buffer %12 at(%arg5, %arg6) epoch(%arg4) : !tileplan.l1_buffer -> !d2mtile.tile<bf16>
                  tileflow.write_l1_buffer %0 at(%arg5, %arg6) epoch(%arg4) to %31 {task.engine_label = "dm"} : !tileplan.l1_buffer to !d2mtile.tile<bf16>
