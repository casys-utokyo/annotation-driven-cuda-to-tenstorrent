        ...
        tileplan.temporal_for (%arg6) in (0, 1000, 1) {
          ...
          tileplan.shard_for (%arg7) in (%c10_1) axis <row> {
            ...
            tileplan.shard_for (%arg8) in (%c10_3) axis <col> {
              %2 = tileplan.logical_read %0 access_dims(%arg2, %arg3, %arg7, %arg8) element_map #map1 : !tileplan.shard_view -> !d2mtile.tile<bf16>
              %3 = tileplan.logical_read %1 access_dims(%arg2, %arg3, %arg7, %arg8) element_map #map2 : !tileplan.shard_view -> !d2mtile.tile<bf16>
              %4 = tileplan.logical_read %1 access_dims(%arg2, %arg3, %arg7, %arg8) element_map #map3 : !tileplan.shard_view -> !d2mtile.tile<bf16>
              %5 = tileplan.logical_read %1 access_dims(%arg2, %arg3, %arg7, %arg8) element_map #map4 : !tileplan.shard_view -> !d2mtile.tile<bf16>
              %6 = tileplan.logical_read %1 access_dims(%arg2, %arg3, %arg7, %arg8) element_map #map5 : !tileplan.shard_view -> !d2mtile.tile<bf16>
              %7 = tileplan.logical_read %1 access_dims(%arg2, %arg3, %arg7, %arg8) element_map #map1 : !tileplan.shard_view -> !d2mtile.tile<bf16>
              %8 = d2mtile.binary tile_add %7, %6 -> "source_ssa" : !d2mtile.tile<bf16>
              %9 = d2mtile.binary tile_add %8, %5 -> "source_ssa" : !d2mtile.tile<bf16>
              %10 = d2mtile.binary tile_add %9, %4 -> "source_ssa" : !d2mtile.tile<bf16>
              %11 = d2mtile.binary tile_add %10, %3 -> "source_ssa" : !d2mtile.tile<bf16>
              %12 = d2mtile.fill "2.000000e-01" -> "source_ssa" : !d2mtile.tile<bf16>
              %13 = d2mtile.binary tile_mul %11, %12 -> "source_ssa" : !d2mtile.tile<bf16>
              ...
              tileplan.write_if %13, %0[%arg7, %arg8] when(%15, %17, %19, %21) preserve %2 : !d2mtile.tile<bf16> : !d2mtile.tile<bf16>, !tileplan.shard_view
            }
          }
          ...
          tileplan.shard_for (%arg7) in (%c10_2) axis <row> {
            %c10_3 = arith.constant 10 : index
            tileplan.shard_for (%arg8) in (%c10_3) axis <col> {
              %2 = tileplan.logical_read %1 access_dims(%arg2, %arg3, %arg7, %arg8) element_map #map1 : !tileplan.shard_view -> !d2mtile.tile<bf16>
              %3 = tileplan.logical_read %0 access_dims(%arg2, %arg3, %arg7, %arg8) element_map #map1 : !tileplan.shard_view -> !d2mtile.tile<bf16>
              ...
              tileplan.write_if %3, %1[%arg7, %arg8] when(%5, %7, %9, %11) preserve %2 : !d2mtile.tile<bf16> : !d2mtile.tile<bf16>, !tileplan.shard_view
            }
          }
        } {loop_name = "t"}
      } {tileplan.schedule = [#tileplan.place_transient_guard<producer_writes_abi = 1, consumer_writes_abi = 0, keep = consumer, except = [2, 3]>]}
    }
    return
  }
}
