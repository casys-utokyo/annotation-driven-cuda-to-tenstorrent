        ...
        tileplan.temporal_for (%arg6) in (0, 1000, 1) {
          tileplan.shard_for (%arg7) in (%c10_1) axis <row> {
            tileplan.shard_for (%arg8) in (%c10_3) axis <col> {
              ...
              %41 = tileflow.col_mask symbols(%39) set #set2 invert : !tileflow.mask<bf16>
              %42 = tileflow.col_mask symbols(%40) set #set3 invert : !tileflow.mask<bf16>
              ...
              %48 = tileflow.col_mask symbols(%39, %40) set #set4 invert : !tileflow.mask<bf16>
              %49 = tileflow.compute_select %38 with %33 active(%48 : !tileflow.mask<bf16>) if(%47) {tileflow.overlay = #tileflow.overlay_realization<compute_select>, tileflow.realization_engine = #tileflow.engine<compute>} : !d2mtile.tile<bf16>
              tileplan.write %49, %0[%arg7, %arg8] : !d2mtile.tile<bf16>, !tileplan.shard_view
            }
          }
          tileplan.shard_for (%arg7) in (%c10_2) axis <row> {
            ...
            tileplan.shard_for (%arg8) in (%c10_4) axis <col> {
              ...
              %13 = tileflow.row_copy %12 with %11 active(%9) source_map #map symbols() {tileflow.realization_engine = #tileflow.engine<dm>} : !d2mtile.tile<bf16>
              %14 = tileflow.row_copy %13 with %11 active(%10) source_map #map symbols() {tileflow.realization_engine = #tileflow.engine<dm>} : !d2mtile.tile<bf16>
              tileplan.write %14, %1[%arg7, %arg8] : !d2mtile.tile<bf16>, !tileplan.shard_view
            }
          }
        }
