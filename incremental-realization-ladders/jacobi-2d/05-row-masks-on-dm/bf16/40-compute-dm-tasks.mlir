  ...
  func.func @_Z15runJacobi2DCUDAiiPfS__driver(%arg0: memref<3200x3200xbf16> {tileplan.abi_index = 0 : i64, tileplan.tensor_role = #tileplan.tensor_role<inout>}) attributes {tileplan.selected_compute} {
    ...
    tileplan.device_for (%arg1, %arg2) in (%c10_0, %c10) {
      ...
      ^bb0(%arg3: memref<3200x3200xbf16>):
        ...
        %3 = tileplan.l1_buffer role<constructed> elem bf16 tile(32, 32) domain(1, 2) order(1) {frame_axis = #tileplan.axis<col>, task.frame_access = "replay", task.reuse = 10 : i64} : !tileplan.l1_buffer
        ...
        task.group @dm0_0 engine(<dm0>) domain(<phase>) reads() writes(%3 : !tileplan.l1_buffer [full]) {
          ...
          tileplan.shard_for (%arg4) in (%c1) axis <col> {
            ...
            tileflow.write_l1_buffer %3 at(%c0, %c0_1) to %14 : !tileplan.l1_buffer to !tileflow.mask<bf16>
            ...
            tileflow.write_l1_buffer %3 at(%c0_3, %c1_4) to %16 : !tileplan.l1_buffer to !tileflow.mask<bf16>
          }
        }
          ...
          task.group @dm0_0_1 engine(<dm0>) domain(<phase>) reads(%0 : !tileplan.l1_buffer [full]) writes(%4 : !tileplan.l1_buffer [full], %5 : !tileplan.l1_buffer [full], %8 : !tileplan.l1_buffer [full], %9 : !tileplan.l1_buffer [full]) {
            ...
            tileplan.shard_for (%arg5) in (%c10_1) axis <row> {
              tileplan.shard_for (%arg6) in (%c10_2) axis <col> {
                ...
                %29 = tileflow.read_l1_buffer %4 at(%19, %28) epoch(%arg4) : !tileplan.l1_buffer -> !d2mtile.tile<bf16>
                ...
                tileflow.write_l1_buffer %8 at(%arg5, %arg6) epoch(%arg4) to %36 : !tileplan.l1_buffer to !d2mtile.tile<bf16>
                ...
                %48 = tileflow.read_l1_buffer %5 at(%20, %47) epoch(%arg4) : !tileplan.l1_buffer -> !d2mtile.tile<bf16>
                ...
                tileflow.write_l1_buffer %9 at(%arg5, %arg6) epoch(%arg4) to %52 : !tileplan.l1_buffer to !d2mtile.tile<bf16>
              }
            }
          }
          ...
          task.group @dm1_0 engine(<dm1>) domain(<phase>) reads(%1 : !tileplan.l1_buffer [full]) writes(%6 : !tileplan.l1_buffer [full], %7 : !tileplan.l1_buffer [full], %10 : !tileplan.l1_buffer [full], %11 : !tileplan.l1_buffer [full]) after [#task.dep<@compute_0, raw>] {
            ...
            tileplan.shard_for (%arg5) in (%c10_1) axis <row> {
              tileplan.shard_for (%arg6) in (%c10_2) axis <col> {
                ...
                %34 = tileflow.read_l1_buffer %6 at(%33, %18) epoch(%arg4) : !tileplan.l1_buffer -> !d2mtile.tile<bf16>
                ...
                tileflow.write_l1_buffer %10 at(%arg5, %arg6) epoch(%arg4) to %36 : !tileplan.l1_buffer to !d2mtile.tile<bf16>
                %37 = affine.apply #map6(%arg1, %arg2, %arg5, %arg6)
                %38 = affine.apply #map5(%arg1, %arg2, %arg5, %arg6)
                ...
                %50 = tileflow.read_l1_buffer %7 at(%49, %20) epoch(%arg4) : !tileplan.l1_buffer -> !d2mtile.tile<bf16>
                ...
                tileflow.write_l1_buffer %11 at(%arg5, %arg6) epoch(%arg4) to %52 : !tileplan.l1_buffer to !d2mtile.tile<bf16>
              }
            }
          }
          task.group @compute_0_1 engine(<compute>) domain(<phase>) reads(%4 : !tileplan.l1_buffer [full], %0 : !tileplan.l1_buffer [full], %5 : !tileplan.l1_buffer [full], %6 : !tileplan.l1_buffer [full], %1 : !tileplan.l1_buffer [full], %7 : !tileplan.l1_buffer [full], %10 : !tileplan.l1_buffer [full], %11 : !tileplan.l1_buffer [full], %9 : !tileplan.l1_buffer [full], %8 : !tileplan.l1_buffer [full], %3 : !tileplan.l1_buffer [full]) writes(%2 : !tileplan.l1_buffer [full]) after [#task.dep<@dm0_0, raw>] {
            ...
            tileplan.shard_for (%arg5) in (%c10_1) axis <row> {
              tileplan.shard_for (%arg6) in (%c10_2) axis <col> {
                ...
                %18 = tileflow.read_l1_buffer %11 at(%arg5, %arg6) epoch(%arg4) : !tileplan.l1_buffer -> !d2mtile.tile<bf16>
                ...
                %21 = tileflow.read_l1_buffer %9 at(%arg5, %arg6) epoch(%arg4) : !tileplan.l1_buffer -> !d2mtile.tile<bf16>
                ...
                %29 = tileflow.read_l1_buffer %3 at(%c0_4, %28) : !tileplan.l1_buffer -> !tileflow.mask<bf16>
                ...
                tileflow.write_l1_buffer %2 at(%arg5, %arg6) epoch(%arg4) to %37 {task.engine_label = "compute"} : !tileplan.l1_buffer to !d2mtile.tile<bf16>
              }
            }
          }
          task.group @dm0_1 engine(<dm0>) domain(<phase>) reads(%0 : !tileplan.l1_buffer [full], %2 : !tileplan.l1_buffer [full], %12 : !tileplan.l1_buffer [full]) writes(%12 : !tileplan.l1_buffer [full], %0 : !tileplan.l1_buffer [full]) after [#task.dep<@compute_0_1, raw>] {
            ...
            tileplan.shard_for (%arg5) in (%c10_1) axis <row> {
              tileplan.shard_for (%arg6) in (%c10_2) axis <col> {
                ...
                scf.if %27 {
                  %28 = tileflow.lane_copy %18 with %15 if(%22) axis row src_lane 0 dst_lane 0 {task.engine_label = "dm", tileflow.overlay = #tileflow.overlay_realization<dm_copy>} : !d2mtile.tile<bf16>
                  %29 = tileflow.lane_copy %28 with %15 if(%26) axis row src_lane 31 dst_lane 31 {task.engine_label = "dm", tileflow.overlay = #tileflow.overlay_realization<dm_copy>} : !d2mtile.tile<bf16>
                  tileflow.write_l1_buffer %12 at(%arg5, %arg6) epoch(%arg4) to %29 : !tileplan.l1_buffer to !d2mtile.tile<bf16>
                  %30 = tileflow.read_l1_buffer %12 at(%arg5, %arg6) epoch(%arg4) : !tileplan.l1_buffer -> !d2mtile.tile<bf16>
                  tileflow.write_l1_buffer %0 at(%arg5, %arg6) epoch(%arg4) to %30 {task.engine_label = "dm"} : !tileplan.l1_buffer to !d2mtile.tile<bf16>
                } else {
