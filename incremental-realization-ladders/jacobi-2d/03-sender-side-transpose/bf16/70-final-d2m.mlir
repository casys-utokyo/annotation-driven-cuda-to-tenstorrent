...
module {
  func.func @_Z15runJacobi2DCUDAiiPfS__driver(%arg0: memref<3200x3200xbf16>) -> memref<3200x3200xbf16> attributes {tt.d2m_emittable = true, tt.d2m_unhandled = 0 : i64, tt.function_type = "forward_device", tt.l1_peak = 722944 : i64, tt.l1_persistent_base = 313344 : i64, tt.l1_pool = 313344 : i64} {
    ...
    d2m.generic {block_factors = [], grid = #ttcore.grid<10x10>, indexing_maps = [], iterator_types = [], threads = [#d2m.thread<datamovement>, #d2m.thread<datamovement>, #d2m.thread<compute>]}
      ...
      %11 = d2m.get_cb(12) resolution_stage =  compile : <memref<1x1x!ttcore.tile<32x32, bf16>, #l1>>
      %12 = d2m.get_cb(13) resolution_stage =  compile : <memref<1x1x!ttcore.tile<32x32, bf16>, #l1>>
      ...
      scf.for %arg1 = %c0 to %c1000 step %c1 {
        ...
        scf.for %arg2 = %c0 to %c10 step %c1 {
          scf.for %arg3 = %c0 to %c10 step %c1 {
            ...
            %59 = d2m.reserve %9 {pin_cb = 10 : i64} : <memref<1x1x!ttcore.tile<32x32, bf16>, #l1>> -> memref<1x1x!ttcore.tile<32x32, bf16>, #l1>
            %60 = arith.muli %58, %c10 : index
            %61 = arith.addi %60, %57 : index
            %62 = arith.muli %61, %c2048 : index
            %tx_20 = d2m.dma_read %46[%62], %59[%c0], <1> {srcByteOffset = -32 : si32} : (memref<10x10x!ttcore.tile<32x32, bf16>, #l1>, memref<1x1x!ttcore.tile<32x32, bf16>, #l1>) -> !d2m.mem_tx<read>
            d2m.dma_wait %tx_20 : !d2m.mem_tx<read>
            d2m.copy_single_row_tile(%46, %c15) to %59 at %c16 from %61, %c0 : memref<10x10x!ttcore.tile<32x32, bf16>, #l1>, index, memref<1x1x!ttcore.tile<32x32, bf16>, #l1>, index, index, index
            scf.if %56 {
              d2m.copy_single_row_tile(%49, %c31) to %59 at %c0 from %57, %c0 : memref<1x10x!ttcore.tile<32x32, bf16>, #l1>, index, memref<1x1x!ttcore.tile<32x32, bf16>, #l1>, index, index, index
            } else {
              %69 = affine.apply #map3(%arg2)[%core0]
              %70 = arith.muli %69, %c10 : index
              %71 = arith.addi %70, %57 : index
              d2m.copy_single_row_tile(%46, %c31) to %59 at %c0 from %71, %c0 : memref<10x10x!ttcore.tile<32x32, bf16>, #l1>, index, memref<1x1x!ttcore.tile<32x32, bf16>, #l1>, index, index, index
            }
            d2m.push %9 {pin_cb = 10 : i64} : <memref<1x1x!ttcore.tile<32x32, bf16>, #l1>>
            %63 = arith.cmpi sge, %arg2, %c9 : index
            %64 = d2m.reserve %10 {pin_cb = 11 : i64} : <memref<1x1x!ttcore.tile<32x32, bf16>, #l1>> -> memref<1x1x!ttcore.tile<32x32, bf16>, #l1>
            %tx_21 = d2m.dma_read %46[%62], %64[%c0], <1> {srcByteOffset = 32 : si32} : (memref<10x10x!ttcore.tile<32x32, bf16>, #l1>, memref<1x1x!ttcore.tile<32x32, bf16>, #l1>) -> !d2m.mem_tx<read>
            d2m.dma_wait %tx_21 : !d2m.mem_tx<read>
            d2m.copy_single_row_tile(%46, %c16) to %64 at %c15 from %61, %c0 : memref<10x10x!ttcore.tile<32x32, bf16>, #l1>, index, memref<1x1x!ttcore.tile<32x32, bf16>, #l1>, index, index, index
            scf.if %63 {
              d2m.copy_single_row_tile(%50, %c0) to %64 at %c31 from %57, %c0 : memref<1x10x!ttcore.tile<32x32, bf16>, #l1>, index, memref<1x1x!ttcore.tile<32x32, bf16>, #l1>, index, index, index
            } else {
              %69 = affine.apply #map4(%arg2)[%core0]
              %70 = arith.muli %69, %c10 : index
              %71 = arith.addi %70, %57 : index
              d2m.copy_single_row_tile(%46, %c0) to %64 at %c31 from %71, %c0 : memref<10x10x!ttcore.tile<32x32, bf16>, #l1>, index, memref<1x1x!ttcore.tile<32x32, bf16>, #l1>, index, index, index
            }
            d2m.push %10 {pin_cb = 11 : i64} : <memref<1x1x!ttcore.tile<32x32, bf16>, #l1>>
            %65 = arith.cmpi sge, %arg3, %c9 : index
            %66 = d2m.reserve %11 {pin_cb = 12 : i64} : <memref<1x1x!ttcore.tile<32x32, bf16>, #l1>> -> memref<1x1x!ttcore.tile<32x32, bf16>, #l1>
            %tx_22 = d2m.dma_read %47[%62], %66[%c0], <1> {srcByteOffset = 32 : si32} : (memref<10x10x!ttcore.tile<32x32, bf16>, #l1>, memref<1x1x!ttcore.tile<32x32, bf16>, #l1>) -> !d2m.mem_tx<read>
            d2m.dma_wait %tx_22 : !d2m.mem_tx<read>
            d2m.copy_single_row_tile(%47, %c16) to %66 at %c15 from %61, %c0 : memref<10x10x!ttcore.tile<32x32, bf16>, #l1>, index, memref<1x1x!ttcore.tile<32x32, bf16>, #l1>, index, index, index
            scf.if %65 {
              d2m.copy_single_row_tile(%51, %c0) to %66 at %c31 from %58, %c0 : memref<10x1x!ttcore.tile<32x32, bf16>, #l1>, index, memref<1x1x!ttcore.tile<32x32, bf16>, #l1>, index, index, index
            } else {
              %69 = affine.apply #map4(%arg3)[%core1]
              %70 = arith.addi %60, %69 : index
              d2m.copy_single_row_tile(%47, %c0) to %66 at %c31 from %70, %c0 : memref<10x10x!ttcore.tile<32x32, bf16>, #l1>, index, memref<1x1x!ttcore.tile<32x32, bf16>, #l1>, index, index, index
            }
            d2m.push %11 {pin_cb = 12 : i64} : <memref<1x1x!ttcore.tile<32x32, bf16>, #l1>>
            %67 = arith.cmpi slt, %arg3, %c1 : index
            %68 = d2m.reserve %12 {pin_cb = 13 : i64} : <memref<1x1x!ttcore.tile<32x32, bf16>, #l1>> -> memref<1x1x!ttcore.tile<32x32, bf16>, #l1>
            %tx_23 = d2m.dma_read %47[%62], %68[%c0], <1> {srcByteOffset = -32 : si32} : (memref<10x10x!ttcore.tile<32x32, bf16>, #l1>, memref<1x1x!ttcore.tile<32x32, bf16>, #l1>) -> !d2m.mem_tx<read>
            d2m.dma_wait %tx_23 : !d2m.mem_tx<read>
            d2m.copy_single_row_tile(%47, %c15) to %68 at %c16 from %61, %c0 : memref<10x10x!ttcore.tile<32x32, bf16>, #l1>, index, memref<1x1x!ttcore.tile<32x32, bf16>, #l1>, index, index, index
            scf.if %67 {
              d2m.copy_single_row_tile(%52, %c31) to %68 at %c0 from %58, %c0 : memref<10x1x!ttcore.tile<32x32, bf16>, #l1>, index, memref<1x1x!ttcore.tile<32x32, bf16>, #l1>, index, index, index
            } else {
              %69 = affine.apply #map3(%arg3)[%core1]
              %70 = arith.addi %60, %69 : index
              d2m.copy_single_row_tile(%47, %c31) to %68 at %c0 from %70, %c0 : memref<10x10x!ttcore.tile<32x32, bf16>, #l1>, index, memref<1x1x!ttcore.tile<32x32, bf16>, #l1>, index, index, index
            }
            d2m.push %12 {pin_cb = 13 : i64} : <memref<1x1x!ttcore.tile<32x32, bf16>, #l1>>
          }
        }
    ...
    ^datamovement1:
      ...
      %3 = d2m.get_cb(4) resolution_stage =  compile : <memref<2x1x!ttcore.tile<32x32, bf16>, #l1>>
      %4 = d2m.get_cb(5) resolution_stage =  compile : <memref<1x2x!ttcore.tile<32x32, bf16>, #l1>>
      %5 = d2m.get_cb(10) resolution_stage =  compile : <memref<1x1x!ttcore.tile<32x32, bf16>, #l1>>
      ...
      %8 = d2m.get_cb(13) resolution_stage =  compile : <memref<1x1x!ttcore.tile<32x32, bf16>, #l1>>
      ...
      scf.for %arg1 = %c0 to %c1000 step %c1 {
        ...
        scf.for %arg2 = %c0 to %c10 step %c1 {
          scf.for %arg3 = %c0 to %c10 step %c1 {
            ...
            %dst_20 = d2m.acquire_dst() : memref<16x!ttcore.tile<32x32, bf16>, #dst>
            %23 = memref.load %12[%21, %22] : memref<10x10x!ttcore.tile<32x32, bf16>, #l1>
            memref.store %23, %dst_20[%c0] : memref<16x!ttcore.tile<32x32, bf16>, #dst>
            %24 = memref.load %dst_20[%c0] : memref<16x!ttcore.tile<32x32, bf16>, #dst>
            %25 = d2m.wait %7 : <memref<1x1x!ttcore.tile<32x32, bf16>, #l1>> -> memref<1x1x!ttcore.tile<32x32, bf16>, #l1>
            %26 = memref.load %25[%c0, %c0] : memref<1x1x!ttcore.tile<32x32, bf16>, #l1>
            %27 = d2m.wait %8 : <memref<1x1x!ttcore.tile<32x32, bf16>, #l1>> -> memref<1x1x!ttcore.tile<32x32, bf16>, #l1>
            ...
            %33 = d2m.wait %6 : <memref<1x1x!ttcore.tile<32x32, bf16>, #l1>> -> memref<1x1x!ttcore.tile<32x32, bf16>, #l1>
            ...
            %37 = d2m.wait %5 : <memref<1x1x!ttcore.tile<32x32, bf16>, #l1>> -> memref<1x1x!ttcore.tile<32x32, bf16>, #l1>
            ...
            %53 = scf.if %52 -> (!ttcore.tile<32x32, bf16>) {
              ...
              %65 = scf.if %62 -> (!ttcore.tile<32x32, bf16>) {
                %66 = "d2m.tile_where"(%64, %45, %24) : (!ttcore.tile<32x32, bf16>, !ttcore.tile<32x32, bf16>, !ttcore.tile<32x32, bf16>) -> !ttcore.tile<32x32, bf16>
                ...
                %66 = "d2m.tile_where"(%64, %24, %45) : (!ttcore.tile<32x32, bf16>, !ttcore.tile<32x32, bf16>, !ttcore.tile<32x32, bf16>) -> !ttcore.tile<32x32, bf16>
                memref.store %66, %dst_20[%c2] : memref<16x!ttcore.tile<32x32, bf16>, #dst>
                %67 = memref.load %dst_20[%c2] : memref<16x!ttcore.tile<32x32, bf16>, #dst>
                scf.yield %67 : !ttcore.tile<32x32, bf16>
              }
            ...
            %61 = scf.if %60 -> (!ttcore.tile<32x32, bf16>) {
              ...
              %64 = memref.load %dst_20[%c1] : memref<16x!ttcore.tile<32x32, bf16>, #dst>
              %65 = scf.if %62 -> (!ttcore.tile<32x32, bf16>) {
                %66 = "d2m.tile_where"(%64, %53, %24) : (!ttcore.tile<32x32, bf16>, !ttcore.tile<32x32, bf16>, !ttcore.tile<32x32, bf16>) -> !ttcore.tile<32x32, bf16>
                memref.store %66, %dst_20[%c2] : memref<16x!ttcore.tile<32x32, bf16>, #dst>
                %67 = memref.load %dst_20[%c2] : memref<16x!ttcore.tile<32x32, bf16>, #dst>
                scf.yield %67 : !ttcore.tile<32x32, bf16>
              } else {
                %66 = "d2m.tile_where"(%64, %24, %53) : (!ttcore.tile<32x32, bf16>, !ttcore.tile<32x32, bf16>, !ttcore.tile<32x32, bf16>) -> !ttcore.tile<32x32, bf16>
                memref.store %66, %dst_20[%c2] : memref<16x!ttcore.tile<32x32, bf16>, #dst>
                %67 = memref.load %dst_20[%c2] : memref<16x!ttcore.tile<32x32, bf16>, #dst>
                scf.yield %67 : !ttcore.tile<32x32, bf16>
              }
