        ...
        tileplan.temporal_for (%arg6) in (0, 1000, 1) {
          tileplan.shard_for (%arg7) in (%c10_1) axis <row> {
            ...
            tileplan.shard_for (%arg8) in (%c10_3) axis <col> {
              ...
              %14 = tileflow.masked_overlay %13 with %11 active(%2) source_map #map6 symbols() {tileflow.realization_engine = #tileflow.engine<dm>} : !d2mtile.tile<f32>
              ...
              %18 = tileflow.masked_overlay %17 with %16 active(%3) source_map #map9 symbols() {tileflow.realization_engine = #tileflow.engine<dm>} : !d2mtile.tile<f32>
              ...
              %22 = tileflow.masked_overlay %21 with %20 active(%4) source_map #map12 symbols() {tileflow.realization_basis = #tileflow.realization_basis<transposed>, tileflow.realization_engine = #tileflow.engine<dm>} : !d2mtile.tile<f32>
              ...
              %26 = tileflow.masked_overlay %25 with %23 active(%5) source_map #map15 symbols() {tileflow.realization_basis = #tileflow.realization_basis<transposed>, tileflow.realization_engine = #tileflow.engine<dm>} : !d2mtile.tile<f32>
              ...
              %37 = tileflow.masked_overlay %32 with %27 active(%9, %10, %35, %36) source_map #map symbols() {tileflow.realization_engine = [#tileflow.engine_entry<mask = 0, engine = compute>, #tileflow.engine_entry<mask = 1, engine = compute>, #tileflow.engine_entry<mask = 2, engine = compute>, #tileflow.engine_entry<mask = 3, engine = compute>]} : !d2mtile.tile<f32>
