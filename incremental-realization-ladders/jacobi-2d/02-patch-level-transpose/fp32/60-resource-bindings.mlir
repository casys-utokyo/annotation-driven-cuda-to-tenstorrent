...
module {
  func.func @_Z15runJacobi2DCUDAiiPfS__driver(%arg0: memref<3200x3200xf32> {tileplan.abi_index = 0 : i64, tileplan.tensor_role = #tileplan.tensor_role<inout>}) attributes {tileplan.selected_compute, tt.l1_peak = 1069056 : i64, tt.l1_persistent_base = 659456 : i64, tt.l1_pool = 659456 : i64} {
    %c10 = arith.constant 10 : index
    %c10_0 = arith.constant 10 : index
    tileplan.device_for (%arg1, %arg2) in (%c10_0, %c10) {
      %0 = tileplan.persistent_l1 elem f32 tile(32, 32) domain(10, 10) order(0) {logical_tiles = [100, 100], partition = [10, 10], physical_grid = [10, 10], shard = [10, 10], tt.frame_pages = 100 : i64, tt.l1_offset = 659456 : i64, tt.mailbox_depth = 1 : i64, tt.storage_bytes = 409600 : i64, tt.storage_depth = 1 : i64, tt.storage_kind = "persistent"} : !tileplan.l1_buffer
      ...
      ^bb0(%arg3: memref<3200x3200xf32>):
        ...
        %16 = tileplan.l1_buffer role<intermediate> name "dst_spill_15" elem f32 tile(32, 32) domain(1, 1) order(15) {tt.cb_id = 15 : i64, tt.dst_spill, tt.frame_pages = 1 : i64, tt.l1_offset = 655360 : i64, tt.mailbox_depth = 1 : i64, tt.storage_bytes = 4096 : i64, tt.storage_depth = 1 : i64, tt.storage_kind = "addressed_mailbox"} : !tileplan.l1_buffer
        tileplan.bind_persistent %0 : !tileplan.l1_buffer reads(%arg3 : memref<3200x3200xf32>) writes(%arg3 : memref<3200x3200xf32>) {producer = "dm", tt.cb_id = 16 : i64}
