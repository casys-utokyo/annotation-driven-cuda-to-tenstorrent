  ...
  func.func @_Z15runJacobi2DCUDAiiPfS__driver(%arg0: memref<3200x3200xf32> {tileplan.abi_index = 0 : i64, tileplan.tensor_role = #tileplan.tensor_role<inout>}, %arg1: memref<3200x3200xf32> {tileplan.abi_index = 1 : i64, tileplan.tensor_role = #tileplan.tensor_role<transient>}) attributes {tileplan.selected_compute} {
    ...
    tileplan.device_for (%arg2, %arg3) in (%c10_0, %c10) {
      ...
      ^bb0(%arg4: memref<3200x3200xf32>, %arg5: memref<3200x3200xf32>):
        ...
        %4 = d2mtile.fill "2.000000e-01" -> "source_ssa" : !d2mtile.tile<f32>
        ...
        tileplan.temporal_for (%arg6) in (0, 1000, 1) {
          %37 = tileflow.frame_delivery %1 source_core(%6, %arg3) source_slice(%c9, %c0_8) shape(1, 10) : !tileplan.shard_view -> !tileflow.frame<!d2mtile.tile<f32>>
          %38 = tileflow.frame_delivery %1 source_core(%8, %arg3) source_slice(%c0_10, %c0_11) shape(1, 10) : !tileplan.shard_view -> !tileflow.frame<!d2mtile.tile<f32>>
          %39 = tileflow.frame_delivery %1 source_core(%arg2, %10) source_slice(%c0_14, %c0_15) shape(10, 1) : !tileplan.shard_view -> !tileflow.frame<!d2mtile.tile<f32>>
          %40 = tileflow.frame_delivery %1 source_core(%arg2, %12) source_slice(%c0_18, %c9_19) shape(10, 1) : !tileplan.shard_view -> !tileflow.frame<!d2mtile.tile<f32>>
          tileplan.shard_for (%arg7) in (%c10_1) axis <row> {
            ...
            tileplan.shard_for (%arg8) in (%c10_3) axis <col> {
              ...
              %69 = scf.if %67 -> (!d2mtile.tile<f32>) {
                %122 = tileflow.frame_at %37 at(%13, %68) : !tileflow.frame<!d2mtile.tile<f32>> -> !d2mtile.tile<f32>
                scf.yield %122 : !d2mtile.tile<f32>
              } else {
                %122 = tileflow.local_read %1 tile_dims(%arg2, %arg3, %arg7, %arg8) tile_symbols() tile_map #map7 tile_boundary in_bounds : !tileplan.shard_view -> !d2mtile.tile<f32>
                scf.yield %122 : !d2mtile.tile<f32>
              }
              ...
              %79 = scf.if %77 -> (!d2mtile.tile<f32>) {
                %122 = tileflow.frame_at %38 at(%14, %78) : !tileflow.frame<!d2mtile.tile<f32>> -> !d2mtile.tile<f32>
                scf.yield %122 : !d2mtile.tile<f32>
              } else {
                %122 = tileflow.local_read %1 tile_dims(%arg2, %arg3, %arg7, %arg8) tile_symbols() tile_map #map9 tile_boundary in_bounds : !tileplan.shard_view -> !d2mtile.tile<f32>
                scf.yield %122 : !d2mtile.tile<f32>
              }
              ...
              %87 = scf.if %86 -> (!d2mtile.tile<f32>) {
                %122 = tileflow.frame_at %39 at(%52, %15) : !tileflow.frame<!d2mtile.tile<f32>> -> !d2mtile.tile<f32>
                scf.yield %122 : !d2mtile.tile<f32>
              } else {
                %122 = tileflow.local_read %1 tile_dims(%arg2, %arg3, %arg7, %arg8) tile_symbols() tile_map #map10 tile_boundary in_bounds : !tileplan.shard_view -> !d2mtile.tile<f32>
                scf.yield %122 : !d2mtile.tile<f32>
              }
              ...
              %90 = d2mtile.unary tile_transpose %87 -> "source_ssa" : !d2mtile.tile<f32>
              %91 = tileflow.lane_copy %89 with %90 if(%16) axis row src_lane 0 dst_lane 31 {tileflow.overlay = #tileflow.overlay_realization<dm_copy>} : !d2mtile.tile<f32>
              ...
              %96 = scf.if %95 -> (!d2mtile.tile<f32>) {
                %122 = tileflow.frame_at %40 at(%56, %17) : !tileflow.frame<!d2mtile.tile<f32>> -> !d2mtile.tile<f32>
                scf.yield %122 : !d2mtile.tile<f32>
              } else {
                %122 = tileflow.local_read %1 tile_dims(%arg2, %arg3, %arg7, %arg8) tile_symbols() tile_map #map11 tile_boundary in_bounds : !tileplan.shard_view -> !d2mtile.tile<f32>
                scf.yield %122 : !d2mtile.tile<f32>
              }
              ...
              %100 = d2mtile.unary tile_transpose %96 -> "source_ssa" : !d2mtile.tile<f32>
              %101 = tileflow.lane_copy %99 with %100 if(%18) axis row src_lane 31 dst_lane 0 {tileflow.overlay = #tileflow.overlay_realization<dm_copy>} : !d2mtile.tile<f32>
              ...
              %103 = d2mtile.binary tile_add %101, %91 -> "source_ssa" : !d2mtile.tile<f32>
              %104 = d2mtile.unary tile_transpose %103 -> "source_ssa" : !d2mtile.tile<f32>
              %105 = d2mtile.binary tile_add %102, %81 -> "source_ssa" : !d2mtile.tile<f32>
              %106 = d2mtile.binary tile_add %105, %72 -> "source_ssa" : !d2mtile.tile<f32>
              %107 = d2mtile.binary tile_add %106, %104 -> "source_ssa" : !d2mtile.tile<f32>
              %108 = d2mtile.binary tile_mul %107, %4 -> "source_ssa" : !d2mtile.tile<f32>
              ...
              %118 = tileflow.frame_at %27 at(%63, %c0_53) : !tileflow.frame<!tileflow.mask<f32>> -> !tileflow.mask<f32>
              %119 = tileflow.compute_select %108 with %102 active(%118 : !tileflow.mask<f32>) if(%61) {tileflow.overlay = #tileflow.overlay_realization<compute_select>} : !d2mtile.tile<f32>
              %120 = tileflow.frame_at %36 at(%c0_57, %117) : !tileflow.frame<!tileflow.mask<f32>> -> !tileflow.mask<f32>
              %121 = tileflow.compute_select %119 with %102 active(%120 : !tileflow.mask<f32>) if(%115) {tileflow.overlay = #tileflow.overlay_realization<compute_select>} : !d2mtile.tile<f32>
              tileplan.write %121, %0[%arg7, %arg8] : !d2mtile.tile<f32>, !tileplan.shard_view
            }
          }
