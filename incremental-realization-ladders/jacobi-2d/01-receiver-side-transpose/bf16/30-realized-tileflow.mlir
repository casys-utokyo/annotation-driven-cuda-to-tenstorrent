    ...
    tileplan.device_for (%arg2, %arg3) in (%c10_0, %c10) {
      ...
      ^bb0(%arg4: memref<3200x3200xbf16>, %arg5: memref<3200x3200xbf16>):
        ...
        tileplan.temporal_for (%arg6) in (0, 1000, 1) {
          %37 = tileflow.frame_delivery %1 source_core(%8, %arg3) source_slice(%c9, %c0_12) shape(1, 10) : !tileplan.shard_view -> !tileflow.frame<!d2mtile.tile<bf16>>
          %38 = tileflow.frame_delivery %1 source_core(%10, %arg3) source_slice(%c0_14, %c0_15) shape(1, 10) : !tileplan.shard_view -> !tileflow.frame<!d2mtile.tile<bf16>>
          %39 = tileflow.frame_delivery %1 source_core(%arg2, %12) source_slice(%c0_18, %c0_19) shape(10, 1) : !tileplan.shard_view -> !tileflow.frame<!d2mtile.tile<bf16>>
          %40 = tileflow.frame_delivery %1 source_core(%arg2, %14) source_slice(%c0_22, %c9_23) shape(10, 1) : !tileplan.shard_view -> !tileflow.frame<!d2mtile.tile<bf16>>
          tileplan.shard_for (%arg7) in (%c10_1) axis <row> {
            ...
            tileplan.shard_for (%arg8) in (%c10_3) axis <col> {
              ...
              %69 = scf.if %67 -> (!d2mtile.tile<bf16>) {
                %121 = tileflow.frame_at %37 at(%15, %68) : !tileflow.frame<!d2mtile.tile<bf16>> -> !d2mtile.tile<bf16>
                scf.yield %121 : !d2mtile.tile<bf16>
              } else {
                %121 = tileflow.local_read %1 tile_dims(%arg2, %arg3, %arg7, %arg8) tile_symbols() tile_map #map7 tile_boundary in_bounds : !tileplan.shard_view -> !d2mtile.tile<bf16>
                scf.yield %121 : !d2mtile.tile<bf16>
              }
              ...
              %79 = scf.if %77 -> (!d2mtile.tile<bf16>) {
                %121 = tileflow.frame_at %38 at(%16, %78) : !tileflow.frame<!d2mtile.tile<bf16>> -> !d2mtile.tile<bf16>
                scf.yield %121 : !d2mtile.tile<bf16>
              } else {
                %121 = tileflow.local_read %1 tile_dims(%arg2, %arg3, %arg7, %arg8) tile_symbols() tile_map #map9 tile_boundary in_bounds : !tileplan.shard_view -> !d2mtile.tile<bf16>
                scf.yield %121 : !d2mtile.tile<bf16>
              }
              ...
              %87 = scf.if %86 -> (!d2mtile.tile<bf16>) {
                %121 = tileflow.frame_at %39 at(%52, %17) : !tileflow.frame<!d2mtile.tile<bf16>> -> !d2mtile.tile<bf16>
                scf.yield %121 : !d2mtile.tile<bf16>
              } else {
                %121 = tileflow.local_read %1 tile_dims(%arg2, %arg3, %arg7, %arg8) tile_symbols() tile_map #map10 tile_boundary in_bounds : !tileplan.shard_view -> !d2mtile.tile<bf16>
                scf.yield %121 : !d2mtile.tile<bf16>
              }
              ...
              %90 = d2mtile.unary tile_transpose %89 -> "source_ssa" : !d2mtile.tile<bf16>
              %91 = tileflow.lane_copy %90 with %87 if(%4) axis col src_lane 0 dst_lane 31 {tileflow.overlay = #tileflow.overlay_realization<dm_copy>} : !d2mtile.tile<bf16>
              ...
              %96 = scf.if %95 -> (!d2mtile.tile<bf16>) {
                %121 = tileflow.frame_at %40 at(%56, %18) : !tileflow.frame<!d2mtile.tile<bf16>> -> !d2mtile.tile<bf16>
                scf.yield %121 : !d2mtile.tile<bf16>
              } else {
                %121 = tileflow.local_read %1 tile_dims(%arg2, %arg3, %arg7, %arg8) tile_symbols() tile_map #map11 tile_boundary in_bounds : !tileplan.shard_view -> !d2mtile.tile<bf16>
                scf.yield %121 : !d2mtile.tile<bf16>
              }
              ...
              %100 = d2mtile.unary tile_transpose %99 -> "source_ssa" : !d2mtile.tile<bf16>
              %101 = tileflow.lane_copy %100 with %96 if(%5) axis col src_lane 31 dst_lane 0 {tileflow.overlay = #tileflow.overlay_realization<dm_copy>} : !d2mtile.tile<bf16>
              ...
              %103 = d2mtile.binary tile_add %102, %101 -> "source_ssa" : !d2mtile.tile<bf16>
              %104 = d2mtile.binary tile_add %103, %91 -> "source_ssa" : !d2mtile.tile<bf16>
              %105 = d2mtile.binary tile_add %104, %81 -> "source_ssa" : !d2mtile.tile<bf16>
              %106 = d2mtile.binary tile_add %105, %72 -> "source_ssa" : !d2mtile.tile<bf16>
              %107 = d2mtile.binary tile_mul %106, %6 -> "source_ssa" : !d2mtile.tile<bf16>
              ...
              %117 = tileflow.frame_at %27 at(%63, %c0_53) : !tileflow.frame<!tileflow.mask<bf16>> -> !tileflow.mask<bf16>
              %118 = tileflow.compute_select %107 with %102 active(%117 : !tileflow.mask<bf16>) if(%61) {tileflow.overlay = #tileflow.overlay_realization<compute_select>} : !d2mtile.tile<bf16>
              %119 = tileflow.frame_at %36 at(%c0_57, %116) : !tileflow.frame<!tileflow.mask<bf16>> -> !tileflow.mask<bf16>
              %120 = tileflow.compute_select %118 with %102 active(%119 : !tileflow.mask<bf16>) if(%114) {tileflow.overlay = #tileflow.overlay_realization<compute_select>} : !d2mtile.tile<bf16>
              tileplan.write %120, %0[%arg7, %arg8] : !d2mtile.tile<bf16>, !tileplan.shard_view
            }
          }
