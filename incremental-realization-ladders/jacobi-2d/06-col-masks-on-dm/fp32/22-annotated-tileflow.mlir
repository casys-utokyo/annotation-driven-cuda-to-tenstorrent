        ...
        tileplan.temporal_for (%arg6) in (0, 1000, 1) {
          tileplan.shard_for (%arg7) in (%c10_1) axis <row> {
            tileplan.shard_for (%arg8) in (%c10_3) axis <col> {
              ...
              tileplan.write %38, %0[%arg7, %arg8] : !d2mtile.tile<f32>, !tileplan.shard_view
            }
          }
          tileplan.shard_for (%arg7) in (%c10_2) axis <row> {
            ...
            tileplan.shard_for (%arg8) in (%c10_4) axis <col> {
              ...
              %15 = tileflow.col_mask symbols(%13) set #set2 invert : !tileflow.mask<f32>
              %16 = tileflow.col_mask symbols(%14) set #set3 invert : !tileflow.mask<f32>
              %17 = tileflow.row_copy %12 with %11 active(%9) source_map #map symbols() {tileflow.realization_engine = #tileflow.engine<dm>} : !d2mtile.tile<f32>
              %18 = tileflow.row_copy %17 with %11 active(%10) source_map #map symbols() {tileflow.realization_engine = #tileflow.engine<dm>} : !d2mtile.tile<f32>
              %19 = tileflow.col_copy %18 with %11 active(%15) source_map #map symbols() {tileflow.realization_engine = #tileflow.engine<dm>} : !d2mtile.tile<f32>
              %20 = tileflow.col_copy %19 with %11 active(%16) source_map #map symbols() {tileflow.realization_engine = #tileflow.engine<dm>} : !d2mtile.tile<f32>
              tileplan.write %20, %1[%arg7, %arg8] : !d2mtile.tile<f32>, !tileplan.shard_view
            }
          }
        }
