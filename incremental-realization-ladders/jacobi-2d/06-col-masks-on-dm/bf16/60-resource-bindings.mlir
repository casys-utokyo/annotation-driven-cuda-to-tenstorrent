...
module {
  func.func @_Z15runJacobi2DCUDAiiPfS__driver(%arg0: memref<3200x3200xbf16> {tileplan.abi_index = 0 : i64, tileplan.tensor_role = #tileplan.tensor_role<inout>}) attributes {tileplan.selected_compute, tt.l1_peak = 718848 : i64, tt.l1_persistent_base = 309248 : i64, tt.l1_pool = 309248 : i64} {
    %c10 = arith.constant 10 : index
    %c10_0 = arith.constant 10 : index
    tileplan.device_for (%arg1, %arg2) in (%c10_0, %c10) {
      %0 = tileplan.persistent_l1 elem bf16 tile(32, 32) domain(10, 10) order(0) {logical_tiles = [100, 100], partition = [10, 10], physical_grid = [10, 10], shard = [10, 10], tt.frame_pages = 100 : i64, tt.l1_offset = 309248 : i64, tt.mailbox_depth = 1 : i64, tt.storage_bytes = 204800 : i64, tt.storage_depth = 1 : i64, tt.storage_kind = "persistent"} : !tileplan.l1_buffer
      %1 = tileplan.persistent_l1 name "frame.converted" elem bf16 tile(32, 32) domain(10, 10) order(1) {tt.frame_pages = 100 : i64, tt.l1_offset = 514048 : i64, tt.mailbox_depth = 1 : i64, tt.storage_bytes = 204800 : i64, tt.storage_depth = 1 : i64, tt.storage_kind = "persistent"} : !tileplan.l1_buffer
      ...
      ^bb0(%arg3: memref<3200x3200xbf16>):
        ...
        %7 = tileplan.l1_buffer role<constructed> elem bf16 tile(32, 32) domain(10, 10) resident(1, 1) order(5) {frame_axis = #tileplan.axis<row_col>, task.drain_axis = #tileplan.axis<col>, task.fill_axis = #tileplan.axis<col>, task.slot_access = #task.slot_access<single_pass>, task.stream = #tileplan.axis<col>, tt.cb_id = 5 : i64, tt.frame_pages = 1 : i64, tt.l1_offset = 286720 : i64, tt.mailbox_depth = 2 : i64, tt.storage_bytes = 4096 : i64, tt.storage_depth = 2 : i64, tt.storage_kind = "addressed_mailbox"} : !tileplan.l1_buffer
        ...
        %11 = tileplan.l1_buffer role<constructed> elem bf16 tile(32, 32) domain(10, 10) resident(1, 1) order(9) {frame_axis = #tileplan.axis<row_col>, task.drain_axis = #tileplan.axis<col>, task.slot_access = #task.slot_access<single_pass>, tt.cb_id = 9 : i64, tt.frame_pages = 1 : i64, tt.l1_offset = 303104 : i64, tt.mailbox_depth = 2 : i64, tt.storage_bytes = 4096 : i64, tt.storage_depth = 2 : i64, tt.storage_kind = "addressed_mailbox"} : !tileplan.l1_buffer
        %12 = tileplan.l1_buffer role<intermediate> name "dst_spill_10" elem bf16 tile(32, 32) domain(1, 1) order(10) {tt.cb_id = 10 : i64, tt.dst_spill, tt.frame_pages = 1 : i64, tt.l1_offset = 307200 : i64, tt.mailbox_depth = 1 : i64, tt.storage_bytes = 2048 : i64, tt.storage_depth = 1 : i64, tt.storage_kind = "addressed_mailbox"} : !tileplan.l1_buffer
