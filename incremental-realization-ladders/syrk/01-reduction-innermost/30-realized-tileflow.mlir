        ...
        tileplan.shard_for (%arg6) in (%c10_1) axis <row> {
          ...
          tileplan.shard_for (%arg7) in (%c10_2) axis <col> {
            ...
            %10 = tileplan.temporal_for (%arg8) in (0, 100, 1) iter_args(%arg9 = %2) -> (!d2mtile.tile<bf16>) {
              ...
              %16 = tileflow.frame_delivery %0 source_core(%8, %14) source_slice(%9, %15) multicast(%c0, %arg3, %c10_3, %c1) shape(1, 1) : !tileplan.shard_view -> !tileflow.frame<!d2mtile.tile<bf16>>
              ...
              %20 = tileflow.frame_delivery %0 source_core(%5, %18) source_slice(%6, %19) multicast(%arg2, %c0_5, %c1_6, %c10_7) shape(1, 1) : !tileplan.shard_view -> !tileflow.frame<!d2mtile.tile<bf16>>
