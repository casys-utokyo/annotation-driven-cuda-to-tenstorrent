...
#map1 = affine_map<(d0)[s0] -> (d0 + (s0 floordiv 10) * 10)>
#map2 = affine_map<(d0) -> (d0 mod 10)>
#map3 = affine_map<(d0)[s0] -> (d0 floordiv 10 + s0 + (s0 floordiv 10) * 10)>
module {
  func.func @_Z11syrk_kerneliiPfS__driver(%arg0: memref<3200x3200xbf16>, %arg1: memref<3200x3200xbf16>) -> memref<3200x3200xbf16> attributes {tt.d2m_emittable = true, tt.d2m_unhandled = 0 : i64, tt.function_type = "forward_device", tt.l1_peak = 456704 : i64, tt.l1_persistent_base = 47104 : i64, tt.l1_pool = 47104 : i64} {
    %alloc = memref.alloc() {address = 158208 : i64, alignment = 16 : i64} : memref<10x10x10x10x!ttcore.tile<32x32, bf16>, #ttcore.shard<20480x2048, 1>, #l1>
    %alloc_0 = memref.alloc() {address = 363008 : i64, alignment = 16 : i64} : memref<10x10x10x10x!ttcore.tile<32x32, bf16>, #ttcore.shard<20480x2048, 1>, #l1>
    %alloc_1 = memref.alloc() {address = 152064 : i64, alignment = 16 : i64} : memref<1x1x!ttcore.tile<32x32, bf16>, #ttcore.cb_layout<2048x2048, 1>, #l1>
    %alloc_2 = memref.alloc() {address = 111104 : i64, alignment = 16 : i64} : memref<1x10x!ttcore.tile<32x32, bf16>, #ttcore.cb_layout<20480x2048, 1>, #l1>
    %alloc_3 = memref.alloc() {address = 131584 : i64, alignment = 16 : i64} : memref<1x10x!ttcore.tile<32x32, bf16>, #ttcore.cb_layout<20480x2048, 1>, #l1>
    %alloc_4 = memref.alloc() {address = 154112 : i64, alignment = 16 : i64} : memref<1x1x!ttcore.tile<32x32, bf16>, #ttcore.cb_layout<2048x2048, 1>, #l1>
    %alloc_5 = memref.alloc() {address = 156160 : i64, alignment = 16 : i64} : memref<1x1x!ttcore.tile<32x32, bf16>, #ttcore.cb_layout<2048x2048, 1>, #l1>
    ...
    d2m.generic {block_factors = [], grid = #ttcore.grid<10x10>, indexing_maps = [], iterator_types = [], threads = [#d2m.thread<datamovement>, #d2m.thread<datamovement>, #d2m.thread<compute>]}
        ...
        outs(%alloc_0 : memref<10x10x10x10x!ttcore.tile<32x32, bf16>, #ttcore.shard<20480x2048, 1>, #l1>)
        additionalArgs(%alloc_1, %alloc_2, %alloc_3, %alloc_4, %alloc_5 : memref<1x1x!ttcore.tile<32x32, bf16>, #ttcore.cb_layout<2048x2048, 1>, #l1>, memref<1x10x!ttcore.tile<32x32, bf16>, #ttcore.cb_layout<20480x2048, 1>, #l1>, memref<1x10x!ttcore.tile<32x32, bf16>, #ttcore.cb_layout<20480x2048, 1>, #l1>, memref<1x1x!ttcore.tile<32x32, bf16>, #ttcore.cb_layout<2048x2048, 1>, #l1>, memref<1x1x!ttcore.tile<32x32, bf16>, #ttcore.cb_layout<2048x2048, 1>, #l1>)
        {
      %c0 = arith.constant 0 : index
      %c10 = arith.constant 10 : index
      %c1 = arith.constant 1 : index
      %0 = d2m.get_cb(4) resolution_stage =  compile : <memref<1x10x!ttcore.tile<32x32, bf16>, #l1>>
      %1 = d2m.get_cb(5) resolution_stage =  compile : <memref<1x10x!ttcore.tile<32x32, bf16>, #l1>>
      %core0 = d2m.core_index(0) : index
      %core1 = d2m.core_index(1) : index
      scf.for %arg2 = %c0 to %c10 step %c1 {
        scf.for %arg3 = %c0 to %c10 step %c1 {
          scf.for %arg4 = %c0 to %c10 step %c1 {
            ...
            d2m.remote_load %alloc[%2, %3] into %0 mcore[%c0, %core1] mshape[%c10, %c1] srcSlice[%4, %c0] : memref<10x10x10x10x!ttcore.tile<32x32, bf16>, #ttcore.shard<20480x2048, 1>, #l1> into !d2m.cb<memref<1x10x!ttcore.tile<32x32, bf16>, #l1>>
            %5 = affine.apply #map3(%arg2)[%core0]
            %6 = affine.apply #map2(%arg2)
            d2m.remote_load %alloc[%5, %3] into %1 mcore[%core0, %c0] mshape[%c1, %c10] srcSlice[%6, %c0] : memref<10x10x10x10x!ttcore.tile<32x32, bf16>, #ttcore.shard<20480x2048, 1>, #l1> into !d2m.cb<memref<1x10x!ttcore.tile<32x32, bf16>, #l1>>
    ...
    ^datamovement1:
      ...
      %1 = d2m.get_cb(4) resolution_stage =  compile : <memref<1x10x!ttcore.tile<32x32, bf16>, #l1>>
      %2 = d2m.get_cb(5) resolution_stage =  compile : <memref<1x10x!ttcore.tile<32x32, bf16>, #l1>>
      ...
      scf.for %arg2 = %c0 to %c10 step %c1 {
        scf.for %arg3 = %c0 to %c10 step %c1 {
          ...
          scf.for %arg4 = %c0 to %c10 step %c1 {
            %28 = d2m.wait %1 : <memref<1x10x!ttcore.tile<32x32, bf16>, #l1>> -> memref<1x10x!ttcore.tile<32x32, bf16>, #l1>
            %29 = d2m.wait %2 : <memref<1x10x!ttcore.tile<32x32, bf16>, #l1>> -> memref<1x10x!ttcore.tile<32x32, bf16>, #l1>
            %cast_20 = memref.cast %29 : memref<1x10x!ttcore.tile<32x32, bf16>, #l1> to memref<1x10x!ttcore.tile<32x32, bf16>, strided<[10, 1], offset: ?>, #l1>
            %cast_21 = memref.cast %28 : memref<1x10x!ttcore.tile<32x32, bf16>, #l1> to memref<1x10x!ttcore.tile<32x32, bf16>, strided<[10, 1], offset: ?>, #l1>
            "d2m.tile_matmul_block"(%cast_20, %cast_21, %cast) <{transpose_b = true}> : (memref<1x10x!ttcore.tile<32x32, bf16>, strided<[10, 1], offset: ?>, #l1>, memref<1x10x!ttcore.tile<32x32, bf16>, strided<[10, 1], offset: ?>, #l1>, memref<1x1x!ttcore.tile<32x32, bf16>, strided<[1, 1], offset: ?>, #l1>) -> ()
            d2m.pop %2 : <memref<1x10x!ttcore.tile<32x32, bf16>, #l1>>
            d2m.pop %1 : <memref<1x10x!ttcore.tile<32x32, bf16>, #l1>>
          } {d2m.blocking_loop = 1 : i64}
