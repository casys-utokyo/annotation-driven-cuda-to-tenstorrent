...
#map2 = affine_map<(d0, d1, d2, d3, d4) -> ((d3 floordiv 10) * 10 + d1 floordiv 10 + d0, (d4 floordiv 10) * 10 + d2)>
#map3 = affine_map<(d0, d1, d2) -> (d1 mod 10, 0)>
      ...
      ^bb0(%arg4: memref<3200x3200xbf16>, %arg5: memref<3200x3200xbf16>):
        ...
        tileplan.shard_for (%arg6) in (%c10_1) axis <row> {
          tileplan.shard_for (%arg7) in (%c10_2) axis <col> {
            ...
            %6 = tileplan.temporal_for (%arg8) in (0, 10, 1) iter_args(%arg9 = %2) -> (!d2mtile.tile<bf16>) {
              %10 = tileflow.transfer %0 core_dims(%arg3, %arg7, %arg8, %arg2, %arg3) core_symbols() core_map #map2 tile_dims(%arg3, %arg7, %arg8) tile_symbols() tile_map #map3 core_boundary in_bounds tile_boundary in_bounds {frameShape = array<i64: 1, 10>} : !tileplan.shard_view -> !d2mtile.tile<bf16>
              %11 = tileflow.transfer %0 core_dims(%arg2, %arg6, %arg8, %arg2, %arg3) core_symbols() core_map #map2 tile_dims(%arg2, %arg6, %arg8) tile_symbols() tile_map #map3 core_boundary in_bounds tile_boundary in_bounds {frameShape = array<i64: 1, 10>} : !tileplan.shard_view -> !d2mtile.tile<bf16>
