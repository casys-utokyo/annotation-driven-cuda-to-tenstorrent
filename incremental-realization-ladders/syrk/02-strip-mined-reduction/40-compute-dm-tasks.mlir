  ...
  func.func @_Z11syrk_kerneliiPfS__driver(%arg0: memref<3200x3200xbf16> {tileplan.abi_index = 0 : i64, tileplan.tensor_role = #tileplan.tensor_role<input>}, %arg1: memref<3200x3200xbf16> {tileplan.abi_index = 1 : i64, tileplan.tensor_role = #tileplan.tensor_role<inout>}) attributes {tileplan.selected_compute} {
    ...
    tileplan.device_for (%arg2, %arg3) in (%c10_0, %c10) {
      ...
      ^bb0(%arg4: memref<3200x3200xbf16>, %arg5: memref<3200x3200xbf16>):
        %2 = tileplan.l1_buffer role<receive> elem bf16 tile(32, 32) domain(1, 10) order(0) {frame_axis = #tileplan.axis<col>} : !tileplan.l1_buffer
          ...
          tileplan.shard_for (%arg6) in (%c10_1) axis <row> {
            tileplan.shard_for (%arg7) in (%c10_2) axis <col> {
              tileplan.temporal_for (%arg8) in (0, 10, 1) {
                %6 = affine.apply #map1(%arg3, %arg7, %arg2)
                %7 = affine.apply #map2(%arg8, %arg3)
                %8 = affine.apply #map3(%arg7)
                tileflow.bulk_transfer %0 into %2 source_core(%6, %7) source_slice(%8, %4) multicast(%c0, %arg3, %c10_3, %c1) epoch(%arg8) {task.engine_label = "dm"} : !tileplan.l1_buffer into !tileplan.l1_buffer
                %9 = affine.apply #map4(%arg2, %arg6)
                %10 = affine.apply #map2(%arg8, %arg3)
                %11 = affine.apply #map3(%arg6)
                tileflow.bulk_transfer %0 into %3 source_core(%9, %10) source_slice(%11, %5) multicast(%arg2, %c0_4, %c1_5, %c10_6) epoch(%arg8) {task.engine_label = "dm"} : !tileplan.l1_buffer into !tileplan.l1_buffer
              } {epoch_id = 0 : i64}
            }
          }
        }
        task.group @compute_1 engine(<compute>) domain(<phase>) reads(%1 : !tileplan.l1_buffer [full], %2 : !tileplan.l1_buffer [full], %3 : !tileplan.l1_buffer [full]) writes(%1 : !tileplan.l1_buffer [full]) {
          ...
          tileplan.shard_for (%arg6) in (%c10_1) axis <row> {
            tileplan.shard_for (%arg7) in (%c10_2) axis <col> {
              %7 = affine.apply #map5(%arg2, %arg3, %arg6, %arg7)
              %8 = affine.apply #map6(%arg2, %arg3, %arg6, %arg7)
              %9 = tileflow.read_l1_buffer %1 at(%7, %8) : !tileplan.l1_buffer -> !d2mtile.tile<bf16>
              %10 = tileplan.temporal_for (%arg8) in (0, 10, 1) iter_args(%arg9 = %4) -> (!d2mtile.tile<bf16>) {
                ...
                %16 = d2mtile.matmul_block %15, %14 acc %arg9 block [1, 1, 10] {task.engine_label = "compute", transpose = true} : !d2mtile.tile<bf16>
