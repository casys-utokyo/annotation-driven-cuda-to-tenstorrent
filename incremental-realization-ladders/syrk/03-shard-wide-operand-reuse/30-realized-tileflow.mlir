    ...
    tileplan.device_for (%arg2, %arg3) in (%c10_0, %c10) {
      ...
      ^bb0(%arg4: memref<3200x3200xbf16>, %arg5: memref<3200x3200xbf16>):
        ...
        tileplan.temporal_for (%arg6) in (0, 10, 1) {
          ...
          %13 = tileflow.frame_delivery %0 source_core(%3, %12) source_slice(%4, %5) multicast(%c0_1, %arg3, %c10_2, %c1) shape(10, 10) : !tileplan.shard_view -> !tileflow.frame<!d2mtile.tile<bf16>>
          %14 = tileflow.frame_at %13 at(%c0_3, %c0_3) : !tileflow.frame<!d2mtile.tile<bf16>> -> !d2mtile.tile<bf16>
          %15 = affine.apply #map1(%arg6, %arg3)
          %16 = tileflow.frame_delivery %0 source_core(%6, %15) source_slice(%7, %8) multicast(%arg2, %c0_4, %c1_5, %c10_6) shape(10, 10) : !tileplan.shard_view -> !tileflow.frame<!d2mtile.tile<bf16>>
