...
module {
  func.func @_Z11syrk_kerneliiPfS__driver(%arg0: memref<3200x3200xbf16> {tileplan.abi_index = 0 : i64, tileplan.tensor_role = #tileplan.tensor_role<input>}, %arg1: memref<3200x3200xbf16> {tileplan.abi_index = 1 : i64, tileplan.tensor_role = #tileplan.tensor_role<inout>}) attributes {tileplan.selected_compute, tt.l1_peak = 1028096 : i64, tt.l1_persistent_base = 618496 : i64, tt.l1_pool = 618496 : i64} {
    %c10 = arith.constant 10 : index
    %c10_0 = arith.constant 10 : index
    tileplan.device_for (%arg2, %arg3) in (%c10_0, %c10) {
      %0 = tileplan.persistent_l1 elem bf16 tile(32, 32) domain(10, 10) order(0) {logical_tiles = [100, 100], partition = [10, 10], physical_grid = [10, 10], shard = [10, 10], tt.frame_pages = 100 : i64, tt.l1_offset = 618496 : i64, tt.storage_bytes = 204800 : i64, tt.storage_depth = 1 : i64, tt.storage_kind = "persistent"} : !tileplan.l1_buffer
      %1 = tileplan.persistent_l1 elem bf16 tile(32, 32) domain(10, 10) order(1) {logical_tiles = [100, 100], partition = [10, 10], physical_grid = [10, 10], shard = [10, 10], tt.frame_pages = 100 : i64, tt.l1_offset = 823296 : i64, tt.mailbox_depth = 1 : i64, tt.storage_bytes = 204800 : i64, tt.storage_depth = 1 : i64, tt.storage_kind = "persistent"} : !tileplan.l1_buffer
      ...
      ^bb0(%arg4: memref<3200x3200xbf16>, %arg5: memref<3200x3200xbf16>):
        ...
        %3 = tileplan.l1_buffer role<receive> elem bf16 tile(32, 32) domain(10, 10) order(1) {frame_axis = #tileplan.axis<row_col>, task.delivery_initialized, task.slot_access = #task.slot_access<resident>, tt.cb_id = 1 : i64, tt.frame_pages = 100 : i64, tt.l1_offset = 204800 : i64, tt.mailbox_depth = 1 : i64, tt.storage_bytes = 204800 : i64, tt.storage_depth = 1 : i64, tt.storage_kind = "addressed_mailbox"} : !tileplan.l1_buffer
        %4 = tileplan.l1_buffer role<receive> elem bf16 tile(32, 32) domain(10, 10) order(2) {frame_axis = #tileplan.axis<row_col>, task.delivery_initialized, task.slot_access = #task.slot_access<resident>, tt.cb_id = 2 : i64, tt.frame_pages = 100 : i64, tt.l1_offset = 409600 : i64, tt.mailbox_depth = 1 : i64, tt.storage_bytes = 204800 : i64, tt.storage_depth = 1 : i64, tt.storage_kind = "addressed_mailbox"} : !tileplan.l1_buffer
        %5 = tileplan.l1_buffer role<intermediate> name "dst_spill_3" elem bf16 tile(32, 32) domain(1, 1) order(3) {tt.cb_id = 3 : i64, tt.dst_spill, tt.frame_pages = 1 : i64, tt.l1_offset = 614400 : i64, tt.mailbox_depth = 1 : i64, tt.storage_bytes = 2048 : i64, tt.storage_depth = 1 : i64, tt.storage_kind = "addressed_mailbox"} : !tileplan.l1_buffer
        %6 = tileplan.l1_buffer role<intermediate> name "dst_spill_4" elem bf16 tile(32, 32) domain(1, 1) order(4) {tt.cb_id = 4 : i64, tt.dst_spill, tt.frame_pages = 1 : i64, tt.l1_offset = 616448 : i64, tt.mailbox_depth = 1 : i64, tt.storage_bytes = 2048 : i64, tt.storage_depth = 1 : i64, tt.storage_kind = "addressed_mailbox"} : !tileplan.l1_buffer
