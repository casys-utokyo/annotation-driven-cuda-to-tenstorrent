        ...
        tileplan.temporal_for (%arg6) in (0, 5119, 1) {
          ...
          tileplan.shard_for (%arg7) in (%c16_1) axis <row> {
            ...
            tileplan.shard_for (%arg8) in (%c16_3) axis <col> {
              ...
              %17 = tileflow.col_mask symbols(%16) set #set invert : !tileflow.mask<f32>
              %18 = tileflow.row_mask symbols(%12) set #set : !tileflow.mask<f32>
              %19 = tileflow.mask_fill %10 active(%18 : !tileflow.mask<f32>) policy zero : !d2mtile.tile<f32> -> !d2mtile.tile<f32>
              %20 = d2mtile.binary tile_mul %19, %7 -> "source_ssa" : !d2mtile.tile<f32>
              %21 = d2mtile.binary tile_mul %20, %14 -> "source_ssa" : !d2mtile.tile<f32>
              %22 = d2mtile.binary tile_sub %15, %21 -> "source_ssa" : !d2mtile.tile<f32>
              %23 = tileflow.masked_overlay %22 with %15 active(%17) source_map #map symbols() : !d2mtile.tile<f32>
