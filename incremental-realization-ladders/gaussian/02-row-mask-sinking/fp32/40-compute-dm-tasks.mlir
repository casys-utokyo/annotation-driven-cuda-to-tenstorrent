        ...
        tileplan.temporal_for (%arg4) in (0, 5119, 1) {
          task.group @dm0_0 engine(<dm0>) domain(<phase>) reads(%0 : !tileplan.l1_buffer [full]) writes(%1 : !tileplan.l1_buffer [full], %3 : !tileplan.l1_buffer [full], %4 : !tileplan.l1_buffer [full], %6 : !tileplan.l1_buffer [full], %8 : !tileplan.l1_buffer [full]) {
            ...
            tileplan.shard_for (%arg5) in (%c16_1) axis <col> {
              ...
              %24 = tileflow.col_mask symbols(%23) set #set invert {task.engine_label = "dm"} : !tileflow.mask<f32>
              tileflow.write_l1_buffer %6 at(%c0_15, %arg5) epoch(%arg4) to %24 : !tileplan.l1_buffer to !tileflow.mask<f32>
            }
            tileplan.shard_for (%arg5) in (%c16) axis <row> {
              ...
              %25 = tileflow.row_mask symbols(%24) set #set {task.engine_label = "dm"} : !tileflow.mask<f32>
              tileflow.write_l1_buffer %8 at(%arg5, %c0_16) epoch(%arg4) to %25 : !tileplan.l1_buffer to !tileflow.mask<f32>
            }
          }
          task.group @compute_1 engine(<compute>) domain(<phase>) reads(%2 : !tileplan.l1_buffer [full], %7 : !tileplan.l1_buffer [full], %8 : !tileplan.l1_buffer [full], %5 : !tileplan.l1_buffer [full], %0 : !tileplan.l1_buffer [full], %6 : !tileplan.l1_buffer [full]) writes(%0 : !tileplan.l1_buffer [full]) {
            ...
            %c0 = arith.constant 0 : index
            %c0_2 = arith.constant 0 : index
            %9 = d2mtile.fill "0.000000e+00" {task.engine_label = "compute"} : !d2mtile.tile<f32>
            %c0_3 = arith.constant 0 : index
            %c0_4 = arith.constant 0 : index
            %10 = affine.apply #map4(%arg4)
            %11 = affine.apply #map4(%arg4)
            %12 = tileflow.read_l1_buffer %2 at(%c0_3, %c0_4) on cell(%10, %11) epoch(%arg4) : !tileplan.l1_buffer -> !d2mtile.tile<f32>
            %13 = d2mtile.unary tile_recip %12 -> "source_ssa" {task.engine_label = "compute"} : !d2mtile.tile<f32>
            tileplan.shard_for (%arg5) in (%c16) axis <row> {
              %c0_5 = arith.constant 0 : index
              %14 = affine.apply #map4(%arg4)
              %15 = tileflow.read_l1_buffer %7 at(%arg5, %c0_5) on col(%14) epoch(%arg4) : !tileplan.l1_buffer -> !d2mtile.tile<f32>
              %c0_6 = arith.constant 0 : index
              %16 = tileflow.read_l1_buffer %8 at(%arg5, %c0_6) epoch(%arg4) : !tileplan.l1_buffer -> !tileflow.mask<f32>
              %17 = tileflow.compute_select %9 with %15 active(%16 : !tileflow.mask<f32>) {task.engine_label = "compute"} : !d2mtile.tile<f32>
              %18 = d2mtile.binary tile_mul %17, %13 -> "source_ssa" {task.engine_label = "compute"} : !d2mtile.tile<f32>
              tileplan.shard_for (%arg6) in (%c16_1) axis <col> {
                %19 = tileflow.read_l1_buffer %5 at(%c0, %arg6) epoch(%arg4) : !tileplan.l1_buffer -> !d2mtile.tile<f32>
                %20 = affine.apply #map7(%arg1, %arg2, %arg5, %arg6)
                %21 = affine.apply #map8(%arg1, %arg2, %arg5, %arg6)
                %22 = tileflow.read_l1_buffer %0 at(%20, %21) epoch(%arg4) : !tileplan.l1_buffer -> !d2mtile.tile<f32>
                %23 = d2mtile.binary tile_mul %18, %19 -> "source_ssa" {task.engine_label = "compute"} : !d2mtile.tile<f32>
                %24 = d2mtile.binary tile_sub %22, %23 -> "source_ssa" {task.engine_label = "compute"} : !d2mtile.tile<f32>
                %25 = tileflow.read_l1_buffer %6 at(%c0_2, %arg6) epoch(%arg4) : !tileplan.l1_buffer -> !tileflow.mask<f32>
                %26 = tileflow.compute_select %24 with %22 active(%25 : !tileflow.mask<f32>) {task.engine_label = "compute", tileflow.overlay = #tileflow.overlay_realization<compute_select>} : !d2mtile.tile<f32>
