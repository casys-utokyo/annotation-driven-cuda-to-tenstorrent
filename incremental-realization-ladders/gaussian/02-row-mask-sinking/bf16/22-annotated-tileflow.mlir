        ...
        tileplan.temporal_for (%arg6) in (0, 5119, 1) {
          ...
          tileplan.shard_for (%arg7) in (%c16_1) axis <row> {
            ...
            tileplan.shard_for (%arg8) in (%c16_3) axis <col> {
              ...
              %14 = tileflow.broadcast %13 kind row from(%8) : !d2mtile.tile<bf16> -> !d2mtile.tile<bf16>
              ...
              %17 = tileflow.col_mask symbols(%16) set #set invert : !tileflow.mask<bf16>
              %18 = tileflow.row_mask symbols(%12) set #set : !tileflow.mask<bf16>
              %19 = tileflow.mask_fill %10 active(%18 : !tileflow.mask<bf16>) policy zero : !d2mtile.tile<bf16> -> !d2mtile.tile<bf16>
              %20 = d2mtile.binary tile_mul %19, %7 -> "source_ssa" : !d2mtile.tile<bf16>
              %21 = d2mtile.binary tile_mul %20, %14 -> "source_ssa" : !d2mtile.tile<bf16>
              %22 = d2mtile.binary tile_sub %15, %21 -> "source_ssa" : !d2mtile.tile<bf16>
              %23 = tileflow.masked_overlay %22 with %15 active(%17) source_map #map symbols() : !d2mtile.tile<bf16>
