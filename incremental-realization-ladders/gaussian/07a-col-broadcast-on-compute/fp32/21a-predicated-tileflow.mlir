        ...
        tileplan.temporal_for (%arg6) in (0, 5119, 1) {
          ...
          tileplan.shard_for (%arg7) in (%c16_1) axis <row> {
            ...
            tileplan.shard_for (%arg8) in (%c16_3) axis <col> {
              ...
              %18 = tileflow.mask_fill %10 active(%17 : !tileflow.mask<f32>) policy zero : !d2mtile.tile<f32> -> !d2mtile.tile<f32>
              %19 = tileflow.col_mask symbols(%16) set #set : !tileflow.mask<f32>
              %20 = tileflow.mask_fill %14 active(%19 : !tileflow.mask<f32>) policy zero : !d2mtile.tile<f32> -> !d2mtile.tile<f32>
