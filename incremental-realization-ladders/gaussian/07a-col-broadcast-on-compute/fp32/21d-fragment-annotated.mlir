    ...
    tileplan.device_for (%arg2, %arg3) in (%c10_0, %c10) {
      ...
      ^bb0(%arg4: memref<5120x5120xf32>, %arg5: memref<5120x5120xf32>):
        ...
        tileplan.temporal_for (%arg6) in (0, 5119, 1) {
          %2 = tileflow.transfer %1 core_dims(%arg6, %arg2, %arg3) core_symbols() core_map #map1 tile_dims(%arg6) tile_symbols() tile_map #map2 core_boundary in_bounds tile_boundary in_bounds : !tileplan.shard_view -> !d2mtile.tile<f32>
          ...
          %7 = d2mtile.unary tile_recip %5 -> "source_ssa" {tileflow.realization_engine = #tileflow.engine<dm>} : !d2mtile.tile<f32>
          %8 = affine.apply #map3(%arg6)
          tileplan.shard_for (%arg7) in (%c16_1) axis <row> {
            %9 = tileflow.transfer %1 core_dims(%arg2, %arg7, %arg6, %arg2, %arg3) core_symbols() core_map #map4 tile_dims(%arg2, %arg7, %arg6) tile_symbols() tile_map #map5 core_boundary in_bounds tile_boundary in_bounds : !tileplan.shard_view -> !d2mtile.tile<f32>
            %10 = tileflow.broadcast %9 kind col from(%6) {tileflow.realization_engine = #tileflow.engine<compute>} : !d2mtile.tile<f32> -> !d2mtile.tile<f32>
            %11 = affine.apply #map6(%arg6, %arg2, %arg7)
            %12 = affine.apply #map6(%arg6, %arg2, %arg7)
            tileplan.shard_for (%arg8) in (%c16_3) axis <col> {
              %13 = tileflow.transfer %1 core_dims(%arg3, %arg8, %arg6, %arg2, %arg3) core_symbols() core_map #map7 tile_dims(%arg3, %arg8, %arg6) tile_symbols() tile_map #map8 core_boundary in_bounds tile_boundary in_bounds : !tileplan.shard_view -> !d2mtile.tile<f32>
              %14 = tileflow.broadcast %13 kind row from(%8) {tileflow.realization_engine = #tileflow.engine<compute>} : !d2mtile.tile<f32> -> !d2mtile.tile<f32>
              ...
              tileplan.write %23, %1[%arg7, %arg8] : !d2mtile.tile<f32>, !tileplan.shard_view
            }
          }
        }
