    ...
    tileplan.device_for (%arg2, %arg3) in (%c10_0, %c10) {
      ...
      ^bb0(%arg4: memref<5120x5120xbf16>, %arg5: memref<5120x5120xbf16>):
        ...
        tileplan.temporal_for (%arg6) in (0, 5119, 1) {
          ...
          %14 = d2mtile.unary tile_recip %11 -> "source_ssa" at cell(%12, %13) {tileflow.execution = "dm"} : !d2mtile.tile<bf16>
          %15 = tileflow.broadcast %14 kind scalar from(%12, %13) : !d2mtile.tile<bf16> -> !d2mtile.tile<bf16>
          ...
          %24 = tileflow.frame_generate (%arg7) in (%c16_3) shape(1, 16) reuse 16 {
            %25 = tileflow.frame_at %23 at(%c0_16, %arg7) : !tileflow.frame<!d2mtile.tile<bf16>> -> !d2mtile.tile<bf16>
            %26 = affine.apply #map6(%arg6, %arg3, %arg7)
            %27 = tileflow.col_mask symbols(%26) set #set : !tileflow.mask<bf16>
            %28 = tileflow.mask_fill %25 active(%27 : !tileflow.mask<bf16>) policy zero at row(%17) {tileflow.execution = "dm"} : !d2mtile.tile<bf16> -> !d2mtile.tile<bf16>
            %29 = tileflow.broadcast %28 kind row from(%17) {tileflow.consumer_bcast} : !d2mtile.tile<bf16> -> !d2mtile.tile<bf16>
            tileflow.frame_yield %29 : !d2mtile.tile<bf16>
          }
          tileplan.shard_for (%arg7) in (%c16_1) axis <row> {
            %25 = tileflow.frame_at %20 at(%arg7, %c0_15) : !tileflow.frame<!d2mtile.tile<bf16>> -> !d2mtile.tile<bf16>
            %26 = affine.apply #map7(%arg6, %arg2, %arg7)
            %27 = affine.apply #map7(%arg6, %arg2, %arg7)
            %28 = tileflow.row_mask symbols(%27) set #set : !tileflow.mask<bf16>
            %29 = tileflow.mask_fill %25 active(%28 : !tileflow.mask<bf16>) policy zero at col(%16) {tileflow.execution = "dm"} : !d2mtile.tile<bf16> -> !d2mtile.tile<bf16>
            %30 = tileflow.broadcast %29 kind col from(%16) {tileflow.consumer_bcast} : !d2mtile.tile<bf16> -> !d2mtile.tile<bf16>
            %31 = d2mtile.binary tile_mul %15, %30 -> "source_ssa" bcast col : !d2mtile.tile<bf16>
            tileplan.shard_for (%arg8) in (%c16_3) axis <col> {
              %32 = tileflow.local_read %1 tile_dims(%arg2, %arg3, %arg7, %arg8) tile_symbols() tile_map #map8 tile_boundary in_bounds : !tileplan.shard_view -> !d2mtile.tile<bf16>
              %33 = tileflow.frame_at %24 at(%c0_17, %arg8) : !tileflow.frame<!d2mtile.tile<bf16>> -> !d2mtile.tile<bf16>
              %34 = d2mtile.binary tile_mul %31, %33 -> "source_ssa" bcast row : !d2mtile.tile<bf16>
              %35 = d2mtile.binary tile_sub %32, %34 -> "source_ssa" : !d2mtile.tile<bf16>
              tileplan.write %35, %1[%arg7, %arg8] : !d2mtile.tile<bf16>, !tileplan.shard_view
            }
          }
        }
