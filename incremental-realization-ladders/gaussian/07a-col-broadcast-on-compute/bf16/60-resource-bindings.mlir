        ...
        tileplan.temporal_for (%arg4) in (0, 5119, 1) {
          task.group @dm0_0 engine(<dm0>) domain(<phase>) reads() writes() {
            ...
            tileplan.shard_for (%arg5) in (%c16_1) axis <col> {
              ...
              scf.for %arg6 = %c0_14 to %c32 step %c1_15 {
                ...
                tileflow.element_store %32 to %5[%c0_16, %arg5] at(%c0_14, %arg6) {task.engine_label = "dm"} : bf16 to !tileplan.l1_buffer
            ...
            tileplan.shard_for (%arg5) in (%c16) axis <row> {
              ...
              scf.for %arg6 = %c0_14 to %c32 step %c1_15 {
                ...
                %cst_19 = arith.constant 0.000000e+00 : bf16
                %32 = arith.select %31, %29, %cst_19 : bf16
                tileflow.element_store %32 to %6[%arg5, %c0_16] at(%arg6, %c0_14) {task.engine_label = "dm"} : bf16 to !tileplan.l1_buffer
              } {task.engine_label = "dm"}
          ...
          task.group @compute_0 engine(<compute>) domain(<phase>) reads() writes() {
            ...
            tileplan.shard_for (%arg5) in (%c16) axis <row> {
              ...
              %14 = d2mtile.binary tile_mul %12, %11 -> "source_ssa" bcast col {task.engine_label = "compute", tt.dst_slot = 0 : i64} : !d2mtile.tile<bf16>
              ...
              tileplan.shard_for (%arg6) in (%c16_1) axis <col> {
                ...
                %21 = d2mtile.binary tile_mul %19, %18 -> "source_ssa" bcast row {task.engine_label = "compute", tt.dst_slot = 0 : i64} : !d2mtile.tile<bf16>
