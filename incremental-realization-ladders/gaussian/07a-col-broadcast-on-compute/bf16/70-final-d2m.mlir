      ...
      scf.for %arg1 = %c0 to %c5119 step %c1 {
        ...
        scf.for %arg2 = %c0 to %c16 step %c1 {
          ...
          scf.for %arg3 = %c0 to %c32 step %c1 {
            ...
            d2m.tile_elem_store %37, %7[%c0, %arg3, %c0] : i16, !d2m.cb<memref<1x1x!ttcore.tile<32x32, bf16>, #l1>>, index, index, index
          }
    ...
    ^datamovement1:
      ...
      scf.for %arg1 = %c0 to %c5119 step %c1 {
        ...
        scf.for %arg2 = %c0 to %c16 step %c1 {
          ...
          %15 = "d2m.tile_bcast_binary"(%13, %12) <{bcast_type = #d2m<tile_bcast_type col>, binop_type = #d2m<tile_bcast_binary_op_type mul>}> : (!ttcore.tile<32x32, bf16>, !ttcore.tile<32x32, bf16>) -> !ttcore.tile<32x32, bf16>
