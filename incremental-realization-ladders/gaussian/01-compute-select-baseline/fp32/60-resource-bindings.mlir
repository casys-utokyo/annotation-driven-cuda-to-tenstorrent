...
module {
  func.func @_Z10ForwardSubPfS__driver(%arg0: memref<5120x5120xf32> {tileplan.abi_index = 1 : i64, tileplan.tensor_role = #tileplan.tensor_role<inout>}) attributes {tileplan.selected_compute, tt.l1_peak = 1343488 : i64, tt.l1_persistent_base = 294912 : i64, tt.l1_pool = 294912 : i64} {
    %c10 = arith.constant 10 : index
    %c10_0 = arith.constant 10 : index
    tileplan.device_for (%arg1, %arg2) in (%c10_0, %c10) {
      %0 = tileplan.persistent_l1 elem f32 tile(32, 32) domain(16, 16) order(0) {logical_tiles = [160, 160], partition = [10, 10], physical_grid = [10, 10], shard = [16, 16], tt.frame_pages = 256 : i64, tt.l1_offset = 294912 : i64, tt.mailbox_depth = 1 : i64, tt.storage_bytes = 1048576 : i64, tt.storage_depth = 1 : i64, tt.storage_kind = "persistent"} : !tileplan.l1_buffer
      ...
      ^bb0(%arg3: memref<5120x5120xf32>):
        ...
        tileplan.bind_persistent %0 : !tileplan.l1_buffer reads(%arg3 : memref<5120x5120xf32>) writes(%arg3 : memref<5120x5120xf32>) {producer = "compute", tt.cb_id = 10 : i64}
        ...
        tileplan.temporal_for (%arg4) in (0, 5119, 1) {
          task.group @dm0_0 engine(<dm0>) domain(<phase>) reads() writes() {
            ...
            tileplan.shard_for (%arg5) in (%c16_1) axis <col> {
              ...
              %28 = tileflow.col_mask symbols(%27) set #set invert {task.engine_label = "dm"} : !tileflow.mask<f32>
              tileflow.write_l1_buffer %6 at(%c0_13, %arg5) epoch(%arg4) to %28 : !tileplan.l1_buffer to !tileflow.mask<f32>
            }
            ...
            tileplan.shard_for (%arg5) in (%c16) axis <row> {
              ...
              %28 = tileflow.row_mask symbols(%27) set #set invert {task.engine_label = "dm"} : !tileflow.mask<f32>
              task.epoch_acquire %8 epoch(%arg4) : !tileplan.l1_buffer
              tileflow.write_l1_buffer %8 at(%arg5, %c0_15) epoch(%arg4) to %28 : !tileplan.l1_buffer to !tileflow.mask<f32>
          ...
          task.group @compute_1 engine(<compute>) domain(<phase>) reads() writes() {
            ...
            %15 = tileflow.read_l1_buffer %2 at(%c0, %c0_2) on cell(%11, %12) epoch(%arg4) {tt.dst_slot = 0 : i64} : !tileplan.l1_buffer -> !d2mtile.tile<f32>
            %16 = d2mtile.unary tile_recip %15 -> "source_ssa" {task.engine_label = "compute", tt.dst_slot = 0 : i64} : !d2mtile.tile<f32>
            task.epoch_free %2 epoch(%arg4) : !tileplan.l1_buffer
            %c0_3 = arith.constant 0 : index
            %c0_4 = arith.constant 0 : index
            tileflow.write_l1_buffer %9 at(%c0_3, %c0_4) epoch(%arg4) to %16 : !tileplan.l1_buffer to !d2mtile.tile<f32>
            ...
            tileplan.shard_for (%arg5) in (%c16) axis <row> {
              ...
              %18 = tileflow.read_l1_buffer %7 at(%arg5, %c0_5) on col(%13) epoch(%arg4) {tt.dst_slot = 0 : i64} : !tileplan.l1_buffer -> !d2mtile.tile<f32>
              %c0_6 = arith.constant 0 : index
              %c0_7 = arith.constant 0 : index
              %19 = tileflow.read_l1_buffer %9 at(%c0_6, %c0_7) epoch(%arg4) {tt.dst_slot = 1 : i64} : !tileplan.l1_buffer -> !d2mtile.tile<f32>
              %20 = d2mtile.binary tile_mul %18, %19 -> "source_ssa" {task.engine_label = "compute", tt.dst_slot = 0 : i64} : !d2mtile.tile<f32>
              task.epoch_free %7 epoch(%arg4) : !tileplan.l1_buffer
              %c0_8 = arith.constant 0 : index
              %c0_9 = arith.constant 0 : index
              tileflow.write_l1_buffer %10 at(%c0_8, %c0_9) epoch(%arg4) to %20 : !tileplan.l1_buffer to !d2mtile.tile<f32>
              ...
              tileplan.shard_for (%arg6) in (%c16_1) axis <col> {
                ...
                %22 = tileflow.read_l1_buffer %5 at(%c0_11, %arg6) epoch(%arg4) {tt.dst_slot = 0 : i64} : !tileplan.l1_buffer -> !d2mtile.tile<f32>
                %23 = affine.apply #map7(%arg1, %arg2, %arg5, %arg6)
                %24 = affine.apply #map8(%arg1, %arg2, %arg5, %arg6)
                %25 = tileflow.read_l1_buffer %0 at(%23, %24) epoch(%arg4) {tt.dst_slot = 1 : i64} : !tileplan.l1_buffer -> !d2mtile.tile<f32>
                %c0_12 = arith.constant 0 : index
                %c0_13 = arith.constant 0 : index
                %26 = tileflow.read_l1_buffer %10 at(%c0_12, %c0_13) epoch(%arg4) {tt.dst_slot = 2 : i64} : !tileplan.l1_buffer -> !d2mtile.tile<f32>
                %27 = d2mtile.binary tile_mul %26, %22 -> "source_ssa" {task.engine_label = "compute", tt.dst_slot = 2 : i64} : !d2mtile.tile<f32>
                %28 = d2mtile.binary tile_sub %25, %27 -> "source_ssa" {task.engine_label = "compute", tt.dst_slot = 2 : i64} : !d2mtile.tile<f32>
                %29 = tileflow.read_l1_buffer %8 at(%arg5, %c0_10) epoch(%arg4) {tt.dst_slot = 0 : i64} : !tileplan.l1_buffer -> !tileflow.mask<f32>
                %30 = tileflow.compute_select %28 with %25 active(%29 : !tileflow.mask<f32>) {task.engine_label = "compute", tileflow.overlay = #tileflow.overlay_realization<compute_select>, tt.dst_slot = 2 : i64} : !d2mtile.tile<f32>
                %c0_14 = arith.constant 0 : index
                %31 = tileflow.read_l1_buffer %6 at(%c0_14, %arg6) epoch(%arg4) {tt.dst_slot = 0 : i64} : !tileplan.l1_buffer -> !tileflow.mask<f32>
                %32 = tileflow.compute_select %30 with %25 active(%31 : !tileflow.mask<f32>) {task.engine_label = "compute", tileflow.overlay = #tileflow.overlay_realization<compute_select>, tt.dst_slot = 2 : i64} : !d2mtile.tile<f32>
                tileflow.write_l1_buffer %0 at(%arg5, %arg6) epoch(%arg4) to %32 {task.engine_label = "compute"} : !tileplan.l1_buffer to !d2mtile.tile<f32>
