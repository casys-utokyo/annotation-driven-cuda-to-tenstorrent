    ...
    tileplan.device_for (%arg2, %arg3) in (%c10_0, %c10) {
      ...
      ^bb0(%arg4: memref<5120x5120xf32>, %arg5: memref<5120x5120xf32>):
        ...
        tileplan.temporal_for (%arg6) in (0, 5119, 1) {
          ...
          %14 = tileflow.broadcast %11 kind scalar from(%12, %13) : !d2mtile.tile<f32> -> !d2mtile.tile<f32>
          %15 = affine.apply #map5(%arg6)
          %16 = d2mtile.unary tile_recip %14 -> "source_ssa" : !d2mtile.tile<f32>
          ...
          %24 = tileflow.frame_generate (%arg7) in (%c16_3) shape(1, 16) reuse 16 {
            %26 = tileflow.frame_at %23 at(%c0_16, %arg7) : !tileflow.frame<!d2mtile.tile<f32>> -> !d2mtile.tile<f32>
            %27 = tileflow.broadcast %26 kind row from(%17) : !d2mtile.tile<f32> -> !d2mtile.tile<f32>
            tileflow.frame_yield %27 : !d2mtile.tile<f32>
          }
          %25 = tileflow.frame_generate (%arg7) in (%c16_3) shape(1, 16) reuse 16 {
            %26 = affine.apply #map6(%arg6, %arg3, %arg7)
            %27 = tileflow.col_mask symbols(%26) set #set invert : !tileflow.mask<f32>
            tileflow.frame_yield %27 : !tileflow.mask<f32>
          }
          tileplan.shard_for (%arg7) in (%c16_1) axis <row> {
            %26 = tileflow.frame_at %20 at(%arg7, %c0_15) : !tileflow.frame<!d2mtile.tile<f32>> -> !d2mtile.tile<f32>
            %27 = tileflow.broadcast %26 kind col from(%15) : !d2mtile.tile<f32> -> !d2mtile.tile<f32>
            %28 = d2mtile.binary tile_mul %27, %16 -> "source_ssa" : !d2mtile.tile<f32>
            %29 = affine.apply #map7(%arg6, %arg2, %arg7)
            %30 = affine.apply #map7(%arg6, %arg2, %arg7)
            %31 = tileflow.row_mask symbols(%30) set #set invert : !tileflow.mask<f32>
            tileplan.shard_for (%arg8) in (%c16_3) axis <col> {
              %32 = tileflow.frame_at %24 at(%c0_17, %arg8) : !tileflow.frame<!d2mtile.tile<f32>> -> !d2mtile.tile<f32>
              %33 = tileflow.local_read %1 tile_dims(%arg2, %arg3, %arg7, %arg8) tile_symbols() tile_map #map8 tile_boundary in_bounds : !tileplan.shard_view -> !d2mtile.tile<f32>
              %34 = d2mtile.binary tile_mul %28, %32 -> "source_ssa" : !d2mtile.tile<f32>
              %35 = d2mtile.binary tile_sub %33, %34 -> "source_ssa" : !d2mtile.tile<f32>
              %36 = tileflow.compute_select %35 with %33 active(%31 : !tileflow.mask<f32>) {tileflow.overlay = #tileflow.overlay_realization<compute_select>} : !d2mtile.tile<f32>
              %37 = tileflow.frame_at %25 at(%c0_18, %arg8) : !tileflow.frame<!tileflow.mask<f32>> -> !tileflow.mask<f32>
              %38 = tileflow.compute_select %36 with %33 active(%37 : !tileflow.mask<f32>) {tileflow.overlay = #tileflow.overlay_realization<compute_select>} : !d2mtile.tile<f32>
              tileplan.write %38, %1[%arg7, %arg8] : !d2mtile.tile<f32>, !tileplan.shard_view
            }
          }
        }
