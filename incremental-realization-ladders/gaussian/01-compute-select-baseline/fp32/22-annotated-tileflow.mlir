      ...
      ^bb0(%arg4: memref<5120x5120xf32>, %arg5: memref<5120x5120xf32>):
        ...
        tileplan.temporal_for (%arg6) in (0, 5119, 1) {
          ...
          tileplan.shard_for (%arg7) in (%c16_1) axis <row> {
            ...
            %14 = tileflow.row_mask symbols(%13) set #set invert : !tileflow.mask<f32>
            tileplan.shard_for (%arg8) in (%c16_3) axis <col> {
              %15 = tileflow.transfer %1 core_dims(%arg3, %arg8, %arg6, %arg2, %arg3) core_symbols() core_map #map7 tile_dims(%arg3, %arg8, %arg6) tile_symbols() tile_map #map8 core_boundary in_bounds tile_boundary in_bounds : !tileplan.shard_view -> !d2mtile.tile<f32>
              %16 = tileflow.broadcast %15 kind row from(%8) : !d2mtile.tile<f32> -> !d2mtile.tile<f32>
              %17 = tileflow.local_read %1 tile_dims(%arg2, %arg3, %arg7, %arg8) tile_symbols() tile_map #map9 tile_boundary in_bounds : !tileplan.shard_view -> !d2mtile.tile<f32>
              ...
              %21 = tileflow.col_mask symbols(%20) set #set invert : !tileflow.mask<f32>
              %22 = tileflow.masked_overlay %19 with %17 active(%14, %21) source_map #map symbols() : !d2mtile.tile<f32>
