        ...
        tileplan.temporal_for (%arg4) in (0, 5119, 1) {
          task.group @dm0_0 engine(<dm0>) domain(<phase>) reads(%0 : !tileplan.l1_buffer [full]) writes(%1 : !tileplan.l1_buffer [full], %3 : !tileplan.l1_buffer [full], %4 : !tileplan.l1_buffer [full], %6 : !tileplan.l1_buffer [full], %8 : !tileplan.l1_buffer [full]) {
            ...
            tileplan.shard_for (%arg5) in (%c16_1) axis <col> {
              ...
              %26 = tileflow.col_mask symbols(%25) set #set invert {task.engine_label = "dm"} : !tileflow.mask<bf16>
              tileflow.write_l1_buffer %6 at(%c0_13, %arg5) epoch(%arg4) to %26 : !tileplan.l1_buffer to !tileflow.mask<bf16>
            }
            tileplan.shard_for (%arg5) in (%c16) axis <row> {
              ...
              %26 = tileflow.row_mask symbols(%25) set #set invert {task.engine_label = "dm"} : !tileflow.mask<bf16>
              tileflow.write_l1_buffer %8 at(%arg5, %c0_15) epoch(%arg4) to %26 : !tileplan.l1_buffer to !tileflow.mask<bf16>
            }
          }
          task.group @compute_1 engine(<compute>) domain(<phase>) reads(%2 : !tileplan.l1_buffer [full], %7 : !tileplan.l1_buffer [full], %8 : !tileplan.l1_buffer [full], %5 : !tileplan.l1_buffer [full], %0 : !tileplan.l1_buffer [full], %6 : !tileplan.l1_buffer [full]) writes(%0 : !tileplan.l1_buffer [full]) {
            ...
            %c0 = arith.constant 0 : index
            %c0_2 = arith.constant 0 : index
            %12 = tileflow.read_l1_buffer %2 at(%c0, %c0_2) on cell(%9, %10) epoch(%arg4) : !tileplan.l1_buffer -> !d2mtile.tile<bf16>
            %13 = d2mtile.unary tile_recip %12 -> "source_ssa" {task.engine_label = "compute"} : !d2mtile.tile<bf16>
            tileplan.shard_for (%arg5) in (%c16) axis <row> {
              %c0_3 = arith.constant 0 : index
              %14 = tileflow.read_l1_buffer %7 at(%arg5, %c0_3) on col(%11) epoch(%arg4) : !tileplan.l1_buffer -> !d2mtile.tile<bf16>
              %15 = d2mtile.binary tile_mul %14, %13 -> "source_ssa" {task.engine_label = "compute"} : !d2mtile.tile<bf16>
              %c0_4 = arith.constant 0 : index
              %16 = tileflow.read_l1_buffer %8 at(%arg5, %c0_4) epoch(%arg4) : !tileplan.l1_buffer -> !tileflow.mask<bf16>
              tileplan.shard_for (%arg6) in (%c16_1) axis <col> {
                %c0_5 = arith.constant 0 : index
                %17 = tileflow.read_l1_buffer %5 at(%c0_5, %arg6) epoch(%arg4) : !tileplan.l1_buffer -> !d2mtile.tile<bf16>
                %18 = affine.apply #map7(%arg1, %arg2, %arg5, %arg6)
                %19 = affine.apply #map8(%arg1, %arg2, %arg5, %arg6)
                %20 = tileflow.read_l1_buffer %0 at(%18, %19) epoch(%arg4) : !tileplan.l1_buffer -> !d2mtile.tile<bf16>
                %21 = d2mtile.binary tile_mul %15, %17 -> "source_ssa" {task.engine_label = "compute"} : !d2mtile.tile<bf16>
                %22 = d2mtile.binary tile_sub %20, %21 -> "source_ssa" {task.engine_label = "compute"} : !d2mtile.tile<bf16>
                %23 = tileflow.compute_select %22 with %20 active(%16 : !tileflow.mask<bf16>) {task.engine_label = "compute", tileflow.overlay = #tileflow.overlay_realization<compute_select>} : !d2mtile.tile<bf16>
                %c0_6 = arith.constant 0 : index
                %24 = tileflow.read_l1_buffer %6 at(%c0_6, %arg6) epoch(%arg4) : !tileplan.l1_buffer -> !tileflow.mask<bf16>
                %25 = tileflow.compute_select %23 with %20 active(%24 : !tileflow.mask<bf16>) {task.engine_label = "compute", tileflow.overlay = #tileflow.overlay_realization<compute_select>} : !d2mtile.tile<bf16>
                tileflow.write_l1_buffer %0 at(%arg5, %arg6) epoch(%arg4) to %25 {task.engine_label = "compute"} : !tileplan.l1_buffer to !d2mtile.tile<bf16>
              }
            }
          }
        } {epoch_id = 0 : i64}
