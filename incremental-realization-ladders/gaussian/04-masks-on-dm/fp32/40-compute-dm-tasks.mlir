      ...
      ^bb0(%arg3: memref<5120x5120xf32>):
        ...
        tileplan.temporal_for (%arg4) in (0, 5119, 1) {
          task.group @dm0_0 engine(<dm0>) domain(<phase>) reads(%0 : !tileplan.l1_buffer [full]) writes(%1 : !tileplan.l1_buffer [full], %3 : !tileplan.l1_buffer [full], %4 : !tileplan.l1_buffer [full]) {
            ...
            tileplan.shard_for (%arg5) in (%c16_1) axis <col> {
              ...
              scf.for %arg6 = %c0_13 to %c32 step %c1_14 {
                ...
                %24 = tileflow.element_load %4[%c0_16, %arg5] at(%14, %arg6) {task.engine_label = "dm"} : !tileplan.l1_buffer -> f32
                %c0_17 = arith.constant 0 : index
                %25 = affine.apply #map6(%arg6)[%23]
                %26 = arith.cmpi sge, %25, %c0_17 : index
                %cst = arith.constant 0.000000e+00 : f32
                %27 = arith.select %26, %24, %cst : f32
                tileflow.element_store %27 to %5[%c0_15, %arg5] at(%14, %arg6) {task.engine_label = "dm"} : f32 to !tileplan.l1_buffer
            ...
            tileplan.shard_for (%arg5) in (%c16) axis <row> {
              ...
              scf.for %arg6 = %c0_13 to %c32 step %c1_14 {
                %c0_16 = arith.constant 0 : index
                %24 = tileflow.element_load %3[%arg5, %c0_16] at(%arg6, %13) {task.engine_label = "dm"} : !tileplan.l1_buffer -> f32
                %c0_17 = arith.constant 0 : index
                %25 = affine.apply #map6(%arg6)[%23]
                %26 = arith.cmpi sge, %25, %c0_17 : index
                %cst = arith.constant 0.000000e+00 : f32
                %27 = arith.select %26, %24, %cst : f32
                tileflow.element_store %27 to %6[%arg5, %c0_15] at(%arg6, %13) {task.engine_label = "dm"} : f32 to !tileplan.l1_buffer
              } {task.engine_label = "dm"}
          ...
          task.group @compute_0 engine(<compute>) domain(<phase>) reads(%2 : !tileplan.l1_buffer [full], %6 : !tileplan.l1_buffer [full], %0 : !tileplan.l1_buffer [full], %5 : !tileplan.l1_buffer [full]) writes(%0 : !tileplan.l1_buffer [full]) {
            ...
            %c0 = arith.constant 0 : index
            %c0_2 = arith.constant 0 : index
            %10 = tileflow.read_l1_buffer %2 at(%c0, %c0_2) on cell(%7, %8) epoch(%arg4) : !tileplan.l1_buffer -> !d2mtile.tile<f32>
            %11 = d2mtile.unary tile_recip %10 -> "source_ssa" {task.engine_label = "compute"} : !d2mtile.tile<f32>
            tileplan.shard_for (%arg5) in (%c16) axis <row> {
              %c0_3 = arith.constant 0 : index
              %12 = tileflow.read_l1_buffer %6 at(%arg5, %c0_3) on col(%9) epoch(%arg4) : !tileplan.l1_buffer -> !d2mtile.tile<f32>
              %13 = d2mtile.binary tile_mul %12, %11 -> "source_ssa" {task.engine_label = "compute"} : !d2mtile.tile<f32>
              tileplan.shard_for (%arg6) in (%c16_1) axis <col> {
                ...
                %c0_4 = arith.constant 0 : index
                %17 = tileflow.read_l1_buffer %5 at(%c0_4, %arg6) epoch(%arg4) : !tileplan.l1_buffer -> !d2mtile.tile<f32>
                %18 = d2mtile.binary tile_mul %13, %17 -> "source_ssa" {task.engine_label = "compute"} : !d2mtile.tile<f32>
                %19 = d2mtile.binary tile_sub %16, %18 -> "source_ssa" {task.engine_label = "compute"} : !d2mtile.tile<f32>
                tileflow.write_l1_buffer %0 at(%arg5, %arg6) epoch(%arg4) to %19 {task.engine_label = "compute"} : !tileplan.l1_buffer to !d2mtile.tile<f32>
              }
            }
          }
        } {epoch_id = 0 : i64}
