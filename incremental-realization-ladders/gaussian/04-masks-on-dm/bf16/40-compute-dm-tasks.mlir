  ...
  func.func @_Z10ForwardSubPfS__driver(%arg0: memref<5120x5120xbf16> {tileplan.abi_index = 1 : i64, tileplan.tensor_role = #tileplan.tensor_role<inout>}) attributes {tileplan.selected_compute} {
    ...
    tileplan.device_for (%arg1, %arg2) in (%c10_0, %c10) {
      ...
      ^bb0(%arg3: memref<5120x5120xbf16>):
        ...
        %6 = tileplan.l1_buffer role<constructed> elem bf16 tile(32, 32) domain(16, 1) order(5) {frame_axis = #tileplan.axis<row>} : !tileplan.l1_buffer
        ...
        tileplan.temporal_for (%arg4) in (0, 5119, 1) {
          task.group @dm0_0 engine(<dm0>) domain(<phase>) reads(%0 : !tileplan.l1_buffer [full]) writes(%1 : !tileplan.l1_buffer [full], %3 : !tileplan.l1_buffer [full], %4 : !tileplan.l1_buffer [full]) {
            ...
            tileflow.bulk_transfer %0 into %1 source_core(%7, %8) source_slice(%9, %10) multicast(%c0_3, %c0_4, %c10_5, %c10_6) epoch(%arg4) {task.engine_label = "dm"} : !tileplan.l1_buffer into !tileplan.l1_buffer
            %c0_7 = arith.constant 0 : index
            tileflow.broadcast_into %1[%c0_7, %c0_7] frag(%11, %12) kind scalar into %2[%c0, %c0_2] {task.engine_label = "dm"} : !tileplan.l1_buffer into !tileplan.l1_buffer
            %19 = affine.apply #map3(%arg1)
            %20 = affine.apply #map4()
            %c0_8 = arith.constant 0 : index
            %c1 = arith.constant 1 : index
            %c10_9 = arith.constant 10 : index
            tileflow.bulk_transfer %0 into %3 source_core(%19, %15) source_slice(%20, %16) multicast(%arg1, %c0_8, %c1, %c10_9) epoch(%arg4) {task.engine_label = "dm"} : !tileplan.l1_buffer into !tileplan.l1_buffer
            %21 = affine.apply #map3(%arg2)
            %22 = affine.apply #map4()
            %c0_10 = arith.constant 0 : index
            %c10_11 = arith.constant 10 : index
            %c1_12 = arith.constant 1 : index
            tileflow.bulk_transfer %0 into %4 source_core(%17, %21) source_slice(%18, %22) multicast(%c0_10, %arg2, %c10_11, %c1_12) epoch(%arg4) {task.engine_label = "dm"} : !tileplan.l1_buffer into !tileplan.l1_buffer
            tileplan.shard_for (%arg5) in (%c16_1) axis <col> {
              ...
              scf.for %arg6 = %c0_13 to %c32 step %c1_14 {
                ...
                %24 = tileflow.element_load %4[%c0_16, %arg5] at(%14, %arg6) {task.engine_label = "dm"} : !tileplan.l1_buffer -> bf16
                %c0_17 = arith.constant 0 : index
                %25 = affine.apply #map6(%arg6)[%23]
                %26 = arith.cmpi sge, %25, %c0_17 : index
                %cst = arith.constant 0.000000e+00 : bf16
                %27 = arith.select %26, %24, %cst : bf16
                tileflow.element_store %27 to %5[%c0_15, %arg5] at(%14, %arg6) {task.engine_label = "dm"} : bf16 to !tileplan.l1_buffer
              } {task.engine_label = "dm"}
              tileflow.broadcast_into %5[%c0_15, %arg5] frag(%14) kind row into %5[%c0_15, %arg5] {task.engine_label = "dm"} : !tileplan.l1_buffer into !tileplan.l1_buffer
            }
            tileplan.shard_for (%arg5) in (%c16) axis <row> {
              %c0_13 = arith.constant 0 : index
              %c32 = arith.constant 32 : index
              %c1_14 = arith.constant 1 : index
              %23 = affine.apply #map7(%arg4, %arg1, %arg5)
              %c0_15 = arith.constant 0 : index
              scf.for %arg6 = %c0_13 to %c32 step %c1_14 {
                %c0_16 = arith.constant 0 : index
                %24 = tileflow.element_load %3[%arg5, %c0_16] at(%arg6, %13) {task.engine_label = "dm"} : !tileplan.l1_buffer -> bf16
                %c0_17 = arith.constant 0 : index
                %25 = affine.apply #map6(%arg6)[%23]
                %26 = arith.cmpi sge, %25, %c0_17 : index
                %cst = arith.constant 0.000000e+00 : bf16
                %27 = arith.select %26, %24, %cst : bf16
                tileflow.element_store %27 to %6[%arg5, %c0_15] at(%arg6, %13) {task.engine_label = "dm"} : bf16 to !tileplan.l1_buffer
              } {task.engine_label = "dm"}
              tileflow.broadcast_into %6[%arg5, %c0_15] frag(%13) kind col into %6[%arg5, %c0_15] {task.engine_label = "dm"} : !tileplan.l1_buffer into !tileplan.l1_buffer
            }
          }
          task.group @compute_0 engine(<compute>) domain(<phase>) reads(%2 : !tileplan.l1_buffer [full], %6 : !tileplan.l1_buffer [full], %0 : !tileplan.l1_buffer [full], %5 : !tileplan.l1_buffer [full]) writes(%0 : !tileplan.l1_buffer [full]) {
            %7 = affine.apply #map2(%arg4)
            %8 = affine.apply #map2(%arg4)
            %9 = affine.apply #map2(%arg4)
            %c0 = arith.constant 0 : index
            %c0_2 = arith.constant 0 : index
            %10 = tileflow.read_l1_buffer %2 at(%c0, %c0_2) on cell(%7, %8) epoch(%arg4) : !tileplan.l1_buffer -> !d2mtile.tile<bf16>
            %11 = d2mtile.unary tile_recip %10 -> "source_ssa" {task.engine_label = "compute"} : !d2mtile.tile<bf16>
            tileplan.shard_for (%arg5) in (%c16) axis <row> {
              %c0_3 = arith.constant 0 : index
              %12 = tileflow.read_l1_buffer %6 at(%arg5, %c0_3) on col(%9) epoch(%arg4) : !tileplan.l1_buffer -> !d2mtile.tile<bf16>
              %13 = d2mtile.binary tile_mul %12, %11 -> "source_ssa" {task.engine_label = "compute"} : !d2mtile.tile<bf16>
              tileplan.shard_for (%arg6) in (%c16_1) axis <col> {
                %14 = affine.apply #map8(%arg1, %arg2, %arg5, %arg6)
                %15 = affine.apply #map9(%arg1, %arg2, %arg5, %arg6)
                %16 = tileflow.read_l1_buffer %0 at(%14, %15) epoch(%arg4) : !tileplan.l1_buffer -> !d2mtile.tile<bf16>
                %c0_4 = arith.constant 0 : index
                %17 = tileflow.read_l1_buffer %5 at(%c0_4, %arg6) epoch(%arg4) : !tileplan.l1_buffer -> !d2mtile.tile<bf16>
                %18 = d2mtile.binary tile_mul %13, %17 -> "source_ssa" {task.engine_label = "compute"} : !d2mtile.tile<bf16>
                %19 = d2mtile.binary tile_sub %16, %18 -> "source_ssa" {task.engine_label = "compute"} : !d2mtile.tile<bf16>
                tileflow.write_l1_buffer %0 at(%arg5, %arg6) epoch(%arg4) to %19 {task.engine_label = "compute"} : !tileplan.l1_buffer to !d2mtile.tile<bf16>
              }
            }
          }
        } {epoch_id = 0 : i64}
