# Annotations in `gaussian-fp32/mask-dm`

## What was asked for

| key | first seen | answered by | on | values |
|---|---|---|---|---|
| `tileflow.realization_engine` | `front-2-annotated` | `30-realized-tileflow` -- the policy tail, per op (see Support/RealizationEngine.h) | `d2mtile.unary`, `tileflow.mask_fill` | `#tileflow.engine<dm>` |
