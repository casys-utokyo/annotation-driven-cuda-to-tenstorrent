      ...
      scf.for %arg1 = %c0 to %c5119 step %c1 {
        ...
        scf.for %arg2 = %c0 to %c16 step %c1 {
          scf.for %arg3 = %c0 to %c32 step %c1 {
            ...
            d2m.tile_elem_store %36, %6[%arg2, %12, %arg3] : i16, !d2m.cb<memref<1x16x!ttcore.tile<32x32, bf16>, #l1>>, index, index, index
          }
          d2m.bcast_row_to_tile(%29, %12) to %29 at %arg2, %arg2 of %c16 : memref<1x16x!ttcore.tile<32x32, bf16>, #l1>, index, memref<1x16x!ttcore.tile<32x32, bf16>, #l1>, index, index, index
        }
      ...
      scf.for %arg1 = %c0 to %c5119 step %c1 {
        ...
        scf.for %arg2 = %c0 to %c16 step %c1 {
          ...
          scf.for %arg3 = %c0 to %c16 step %c1 {
            ...
            %23 = "d2m.tile_mul"(%22, %21) : (!ttcore.tile<32x32, bf16>, !ttcore.tile<32x32, bf16>) -> !ttcore.tile<32x32, bf16>
