...
module {
  func.func @_Z10ForwardSubPfS__driver(%arg0: memref<5120x5120xbf16> {tileplan.abi_index = 1 : i64, tileplan.tensor_role = #tileplan.tensor_role<inout>}) attributes {tileplan.selected_compute, tt.l1_peak = 632832 : i64, tt.l1_persistent_base = 108544 : i64, tt.l1_pool = 108544 : i64} {
    %c10 = arith.constant 10 : index
    %c10_0 = arith.constant 10 : index
    tileplan.device_for (%arg1, %arg2) in (%c10_0, %c10) {
      %0 = tileplan.persistent_l1 elem bf16 tile(32, 32) domain(16, 16) order(0) {logical_tiles = [160, 160], partition = [10, 10], physical_grid = [10, 10], shard = [16, 16], tt.frame_pages = 256 : i64, tt.l1_offset = 108544 : i64, tt.mailbox_depth = 1 : i64, tt.storage_bytes = 524288 : i64, tt.storage_depth = 1 : i64, tt.storage_kind = "persistent"} : !tileplan.l1_buffer
      ...
      ^bb0(%arg3: memref<5120x5120xbf16>):
        ...
        %6 = tileplan.l1_buffer role<constructed> elem bf16 tile(32, 32) domain(16, 1) resident(1, 1) order(5) {frame_axis = #tileplan.axis<row>, task.drain_axis = #tileplan.axis<row>, task.fill_axis = #tileplan.axis<row>, task.slot_access = #task.slot_access<single_pass>, task.stream = #tileplan.axis<row>, tt.cb_id = 5 : i64, tt.frame_pages = 1 : i64, tt.l1_offset = 102400 : i64, tt.mailbox_depth = 2 : i64, tt.storage_bytes = 4096 : i64, tt.storage_depth = 2 : i64, tt.storage_kind = "addressed_mailbox"} : !tileplan.l1_buffer
        %7 = tileplan.l1_buffer role<intermediate> name "dst_spill_6" elem bf16 tile(32, 32) domain(1, 1) order(6) {tt.cb_id = 6 : i64, tt.dst_spill, tt.frame_pages = 1 : i64, tt.l1_offset = 106496 : i64, tt.mailbox_depth = 1 : i64, tt.storage_bytes = 2048 : i64, tt.storage_depth = 1 : i64, tt.storage_kind = "addressed_mailbox"} : !tileplan.l1_buffer
        tileplan.bind_persistent %0 : !tileplan.l1_buffer reads(%arg3 : memref<5120x5120xbf16>) writes(%arg3 : memref<5120x5120xbf16>) {producer = "compute", tt.cb_id = 7 : i64}
        ...
        tileplan.temporal_for (%arg4) in (0, 5119, 1) {
          task.group @dm0_0 engine(<dm0>) domain(<phase>) reads() writes() {
            ...
            %20 = tileflow.element_load %1[%c0_3, %c0_4] at(%12, %13) {task.engine_label = "dm"} : !tileplan.l1_buffer -> bf16
            task.epoch_free %1 epoch(%arg4) : !tileplan.l1_buffer
            %21 = arith.extf %20 : bf16 to f32
            %22 = arith.divf %cst, %21 : f32
            %23 = arith.truncf %22 toward_zero : f32 to bf16
            task.epoch_acquire %2 epoch(%arg4) : !tileplan.l1_buffer
            tileflow.element_store %23 to %2[%c0, %c0_2] at(%12, %13) {task.engine_label = "dm"} : bf16 to !tileplan.l1_buffer
            ...
            %24 = affine.apply #map3(%arg1)
            %25 = affine.apply #map4()
            %c0_9 = arith.constant 0 : index
            %c1 = arith.constant 1 : index
            %c10_10 = arith.constant 10 : index
            tileflow.bulk_transfer %0 into %3 source_core(%24, %16) source_slice(%25, %17) multicast(%arg1, %c0_9, %c1, %c10_10) epoch(%arg4) {task.engine_label = "dm"} : !tileplan.l1_buffer into !tileplan.l1_buffer
            %26 = affine.apply #map3(%arg2)
            %27 = affine.apply #map4()
            %c0_11 = arith.constant 0 : index
            %c10_12 = arith.constant 10 : index
            %c1_13 = arith.constant 1 : index
            tileflow.bulk_transfer %0 into %4 source_core(%18, %26) source_slice(%19, %27) multicast(%c0_11, %arg2, %c10_12, %c1_13) epoch(%arg4) {task.engine_label = "dm"} : !tileplan.l1_buffer into !tileplan.l1_buffer
            ...
            tileplan.shard_for (%arg5) in (%c16_1) axis <col> {
              ...
              %28 = affine.apply #map5(%arg4, %arg2, %arg5)
              %c0_16 = arith.constant 0 : index
              scf.for %arg6 = %c0_14 to %c32 step %c1_15 {
                %c0_17 = arith.constant 0 : index
                %29 = tileflow.element_load %4[%c0_17, %arg5] at(%15, %arg6) {task.engine_label = "dm"} : !tileplan.l1_buffer -> bf16
                %c0_18 = arith.constant 0 : index
                %30 = affine.apply #map6(%arg6)[%28]
                %31 = arith.cmpi sge, %30, %c0_18 : index
                %cst_19 = arith.constant 0.000000e+00 : bf16
                %32 = arith.select %31, %29, %cst_19 : bf16
                tileflow.element_store %32 to %5[%c0_16, %arg5] at(%15, %arg6) {task.engine_label = "dm"} : bf16 to !tileplan.l1_buffer
              } {task.engine_label = "dm"}
              tileflow.broadcast_into %5[%c0_16, %arg5] frag(%15) kind row into %5[%c0_16, %arg5] {task.engine_label = "dm"} : !tileplan.l1_buffer into !tileplan.l1_buffer
            }
            ...
            tileplan.shard_for (%arg5) in (%c16) axis <row> {
              ...
              %c32 = arith.constant 32 : index
              %c1_15 = arith.constant 1 : index
              %28 = affine.apply #map7(%arg4, %arg1, %arg5)
              %c0_16 = arith.constant 0 : index
              task.epoch_acquire %6 epoch(%arg4) : !tileplan.l1_buffer
              scf.for %arg6 = %c0_14 to %c32 step %c1_15 {
                %c0_17 = arith.constant 0 : index
                %29 = tileflow.element_load %3[%arg5, %c0_17] at(%arg6, %14) {task.engine_label = "dm"} : !tileplan.l1_buffer -> bf16
                %c0_18 = arith.constant 0 : index
                %30 = affine.apply #map6(%arg6)[%28]
                %31 = arith.cmpi sge, %30, %c0_18 : index
                %cst_19 = arith.constant 0.000000e+00 : bf16
                %32 = arith.select %31, %29, %cst_19 : bf16
                tileflow.element_store %32 to %6[%arg5, %c0_16] at(%arg6, %14) {task.engine_label = "dm"} : bf16 to !tileplan.l1_buffer
              } {task.engine_label = "dm"}
          ...
          task.group @compute_0 engine(<compute>) domain(<phase>) reads() writes() {
            ...
            tileplan.shard_for (%arg5) in (%c16) axis <row> {
              ...
              %11 = tileflow.read_l1_buffer %6 at(%arg5, %c0_3) on col(%10) epoch(%arg4) : !tileplan.l1_buffer -> !d2mtile.tile<bf16>
              %12 = tileflow.read_l1_buffer %2 at(%c0, %c0_2) on cell(%8, %9) epoch(%arg4) : !tileplan.l1_buffer -> !d2mtile.tile<bf16>
              task.epoch_acquire %7 epoch(%arg4) : !tileplan.l1_buffer
              %13 = d2mtile.dst_acquire capacity 8 : !d2mtile.dst_bank
              %14 = d2mtile.binary tile_mul %11, %12 -> "source_ssa" {task.engine_label = "compute", tt.dst_slot = 0 : i64} : !d2mtile.tile<bf16>
              task.epoch_free %6 epoch(%arg4) : !tileplan.l1_buffer
              %c0_4 = arith.constant 0 : index
              %c0_5 = arith.constant 0 : index
              tileflow.write_l1_buffer %7 at(%c0_4, %c0_5) epoch(%arg4) to %14 : !tileplan.l1_buffer to !d2mtile.tile<bf16>
              ...
              tileplan.shard_for (%arg6) in (%c16_1) axis <col> {
                ...
                %c0_6 = arith.constant 0 : index
                %18 = tileflow.read_l1_buffer %5 at(%c0_6, %arg6) epoch(%arg4) : !tileplan.l1_buffer -> !d2mtile.tile<bf16>
                %c0_7 = arith.constant 0 : index
                %c0_8 = arith.constant 0 : index
                %19 = tileflow.read_l1_buffer %7 at(%c0_7, %c0_8) epoch(%arg4) : !tileplan.l1_buffer -> !d2mtile.tile<bf16>
                %20 = d2mtile.dst_acquire capacity 8 : !d2mtile.dst_bank
                %21 = d2mtile.binary tile_mul %19, %18 -> "source_ssa" {task.engine_label = "compute", tt.dst_slot = 0 : i64} : !d2mtile.tile<bf16>
                %22 = d2mtile.binary tile_sub %17, %21 -> "source_ssa" {task.engine_label = "compute", tt.dst_slot = 0 : i64} : !d2mtile.tile<bf16>
                tileflow.write_l1_buffer %0 at(%arg5, %arg6) epoch(%arg4) to %22 {task.engine_label = "compute"} : !tileplan.l1_buffer to !d2mtile.tile<bf16>
