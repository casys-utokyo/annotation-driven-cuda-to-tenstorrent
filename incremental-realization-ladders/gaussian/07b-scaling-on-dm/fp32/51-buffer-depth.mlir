          ...
          task.group @compute_0_1 engine(<compute>) domain(<phase>) reads() writes() {
            ...
            tileplan.shard_for (%arg5) in (%c16) axis <row> {
              ...
              tileplan.shard_for (%arg6) in (%c16_1) axis <col> {
                ...
                %14 = d2mtile.binary tile_mul %13, %12 -> "source_ssa" bcast row {task.engine_label = "compute", tt.dst_slot = 2 : i64} : !d2mtile.tile<f32>
                %15 = d2mtile.binary tile_sub %11, %14 -> "source_ssa" {task.engine_label = "compute", tt.dst_slot = 2 : i64} : !d2mtile.tile<f32>
