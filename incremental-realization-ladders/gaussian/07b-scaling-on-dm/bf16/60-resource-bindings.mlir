...
module {
  func.func @_Z10ForwardSubPfS__driver(%arg0: memref<5120x5120xbf16> {tileplan.abi_index = 1 : i64, tileplan.tensor_role = #tileplan.tensor_role<inout>}) attributes {tileplan.selected_compute, tt.l1_peak = 630784 : i64, tt.l1_persistent_base = 106496 : i64, tt.l1_pool = 106496 : i64} {
    %c10 = arith.constant 10 : index
    %c10_0 = arith.constant 10 : index
    tileplan.device_for (%arg1, %arg2) in (%c10_0, %c10) {
      %0 = tileplan.persistent_l1 elem bf16 tile(32, 32) domain(16, 16) order(0) {logical_tiles = [160, 160], partition = [10, 10], physical_grid = [10, 10], shard = [16, 16], tt.frame_pages = 256 : i64, tt.l1_offset = 106496 : i64, tt.mailbox_depth = 1 : i64, tt.storage_bytes = 524288 : i64, tt.storage_depth = 1 : i64, tt.storage_kind = "persistent"} : !tileplan.l1_buffer
      ...
      ^bb0(%arg3: memref<5120x5120xbf16>):
        ...
        %2 = tileplan.l1_buffer role<constructed> elem bf16 tile(32, 32) domain(1, 1) order(1) {task.slot_access = #task.slot_access<resident>, tt.cb_id = 1 : i64, tt.frame_pages = 1 : i64, tt.l1_offset = 2048 : i64, tt.storage_bytes = 2048 : i64, tt.storage_depth = 1 : i64, tt.storage_kind = "addressed"} : !tileplan.l1_buffer
        ...
        tileplan.bind_persistent %0 : !tileplan.l1_buffer reads(%arg3 : memref<5120x5120xbf16>) writes(%arg3 : memref<5120x5120xbf16>) {producer = "compute", tt.cb_id = 6 : i64}
        ...
        tileplan.temporal_for (%arg4) in (0, 5119, 1) {
          task.group @dm0_0 engine(<dm0>) domain(<phase>) reads() writes() {
            ...
            %19 = tileflow.element_load %1[%c0_3, %c0_4] at(%11, %12) {task.engine_label = "dm"} : !tileplan.l1_buffer -> bf16
            task.epoch_free %1 epoch(%arg4) : !tileplan.l1_buffer
            %20 = arith.extf %19 : bf16 to f32
            %21 = arith.divf %cst, %20 : f32
            %22 = arith.truncf %21 toward_zero : f32 to bf16
            tileflow.element_store %22 to %2[%c0, %c0_2] at(%11, %12) {task.engine_label = "dm"} : bf16 to !tileplan.l1_buffer
            %23 = affine.apply #map3(%arg1)
            %24 = affine.apply #map4()
            %c0_9 = arith.constant 0 : index
            %c1 = arith.constant 1 : index
            %c10_10 = arith.constant 10 : index
            tileflow.bulk_transfer %0 into %3 source_core(%23, %15) source_slice(%24, %16) multicast(%arg1, %c0_9, %c1, %c10_10) epoch(%arg4) {task.engine_label = "dm"} : !tileplan.l1_buffer into !tileplan.l1_buffer
            %25 = affine.apply #map3(%arg2)
            %26 = affine.apply #map4()
            %c0_11 = arith.constant 0 : index
            %c10_12 = arith.constant 10 : index
            %c1_13 = arith.constant 1 : index
            tileflow.bulk_transfer %0 into %4 source_core(%17, %25) source_slice(%18, %26) multicast(%c0_11, %arg2, %c10_12, %c1_13) epoch(%arg4) {task.engine_label = "dm"} : !tileplan.l1_buffer into !tileplan.l1_buffer
            ...
            tileplan.shard_for (%arg5) in (%c16_1) axis <col> {
              ...
              scf.for %arg6 = %c0_14 to %c32 step %c1_15 {
                ...
                %28 = tileflow.element_load %4[%c0_17, %arg5] at(%14, %arg6) {task.engine_label = "dm"} : !tileplan.l1_buffer -> bf16
                %c0_18 = arith.constant 0 : index
                %29 = affine.apply #map6(%arg6)[%27]
                %30 = arith.cmpi sge, %29, %c0_18 : index
                %cst_19 = arith.constant 0.000000e+00 : bf16
                %31 = arith.select %30, %28, %cst_19 : bf16
                tileflow.element_store %31 to %5[%c0_16, %arg5] at(%c0_14, %arg6) {task.engine_label = "dm"} : bf16 to !tileplan.l1_buffer
            ...
            tileplan.shard_for (%arg5) in (%c16) axis <row> {
              ...
              %c32 = arith.constant 32 : index
              %c1_15 = arith.constant 1 : index
              %27 = affine.apply #map7(%arg4, %arg1, %arg5)
              %c0_16 = arith.constant 0 : index
              task.epoch_acquire %6 epoch(%arg4) : !tileplan.l1_buffer
              scf.for %arg6 = %c0_14 to %c32 step %c1_15 {
                %c0_17 = arith.constant 0 : index
                %28 = tileflow.element_load %3[%arg5, %c0_17] at(%arg6, %13) {task.engine_label = "dm"} : !tileplan.l1_buffer -> bf16
                %c0_18 = arith.constant 0 : index
                %29 = affine.apply #map6(%arg6)[%27]
                %30 = arith.cmpi sge, %29, %c0_18 : index
                %cst_19 = arith.constant 0.000000e+00 : bf16
                ...
                %32 = tileflow.element_load %2[%c0_20, %c0_21] at(%11, %12) {task.engine_label = "dm"} : !tileplan.l1_buffer -> bf16
                %33 = arith.extf %31 : bf16 to f32
                %34 = arith.extf %32 : bf16 to f32
                %35 = arith.mulf %33, %34 : f32
                %36 = arith.truncf %35 toward_zero : f32 to bf16
                tileflow.element_store %36 to %6[%arg5, %c0_16] at(%arg6, %13) {task.engine_label = "dm"} : bf16 to !tileplan.l1_buffer
              } {task.engine_label = "dm"}
          ...
          task.group @compute_0_1 engine(<compute>) domain(<phase>) reads() writes() {
            ...
            tileplan.shard_for (%arg5) in (%c16) axis <row> {
              ...
              tileplan.shard_for (%arg6) in (%c16_1) axis <col> {
                %8 = affine.apply #map8(%arg1, %arg2, %arg5, %arg6)
                %9 = affine.apply #map9(%arg1, %arg2, %arg5, %arg6)
                %10 = tileflow.read_l1_buffer %0 at(%8, %9) epoch(%arg4) : !tileplan.l1_buffer -> !d2mtile.tile<bf16>
                %c0_2 = arith.constant 0 : index
                %11 = tileflow.read_l1_buffer %5 at(%c0_2, %arg6) epoch(%arg4) : !tileplan.l1_buffer -> !d2mtile.tile<bf16>
                %12 = tileflow.read_l1_buffer %6 at(%arg5, %c0) on col(%7) epoch(%arg4) : !tileplan.l1_buffer -> !d2mtile.tile<bf16>
                %13 = d2mtile.dst_acquire capacity 8 : !d2mtile.dst_bank
                %14 = d2mtile.binary tile_mul %12, %11 -> "source_ssa" bcast row {task.engine_label = "compute", tt.dst_slot = 0 : i64} : !d2mtile.tile<bf16>
                %15 = d2mtile.binary tile_sub %10, %14 -> "source_ssa" {task.engine_label = "compute", tt.dst_slot = 0 : i64} : !d2mtile.tile<bf16>
                tileflow.write_l1_buffer %0 at(%arg5, %arg6) epoch(%arg4) to %15 {task.engine_label = "compute"} : !tileplan.l1_buffer to !d2mtile.tile<bf16>
