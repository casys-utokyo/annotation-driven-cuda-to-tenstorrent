      ...
      ^bb0(%arg3: memref<5120x5120xbf16>):
        ...
        tileplan.temporal_for (%arg4) in (0, 5119, 1) {
          ...
          task.group @compute_0_1 engine(<compute>) domain(<phase>) reads(%6 : !tileplan.l1_buffer [full], %0 : !tileplan.l1_buffer [full], %5 : !tileplan.l1_buffer [full]) writes(%0 : !tileplan.l1_buffer [full]) {
            ...
            tileplan.shard_for (%arg5) in (%c16) axis <row> {
              %c0 = arith.constant 0 : index
              %8 = tileflow.read_l1_buffer %6 at(%arg5, %c0) on col(%7) epoch(%arg4) : !tileplan.l1_buffer -> !d2mtile.tile<bf16>
              tileplan.shard_for (%arg6) in (%c16_1) axis <col> {
                %9 = affine.apply #map8(%arg1, %arg2, %arg5, %arg6)
                %10 = affine.apply #map9(%arg1, %arg2, %arg5, %arg6)
                %11 = tileflow.read_l1_buffer %0 at(%9, %10) epoch(%arg4) : !tileplan.l1_buffer -> !d2mtile.tile<bf16>
                %c0_2 = arith.constant 0 : index
                %12 = tileflow.read_l1_buffer %5 at(%c0_2, %arg6) epoch(%arg4) : !tileplan.l1_buffer -> !d2mtile.tile<bf16>
                %13 = d2mtile.binary tile_mul %8, %12 -> "source_ssa" bcast row {task.engine_label = "compute"} : !d2mtile.tile<bf16>
                %14 = d2mtile.binary tile_sub %11, %13 -> "source_ssa" {task.engine_label = "compute"} : !d2mtile.tile<bf16>
                tileflow.write_l1_buffer %0 at(%arg5, %arg6) epoch(%arg4) to %14 {task.engine_label = "compute"} : !tileplan.l1_buffer to !d2mtile.tile<bf16>
              }
            }
          }
        } {epoch_id = 0 : i64}
