      ...
      ^bb0(%arg4: memref<5120x5120xf32>, %arg5: memref<5120x5120xf32>):
        ...
        tileplan.temporal_for (%arg6) in (0, 5119, 1) {
          ...
          %26 = tileflow.frame_generate (%arg7) in (%c16_3) shape(1, 16) reuse 16 {
            ...
            %28 = tileflow.col_mask symbols(%27) set #set : !tileflow.mask<f32>
          ...
          tileplan.shard_for (%arg7) in (%c16_1) axis <row> {
            ...
            tileplan.shard_for (%arg8) in (%c16_3) axis <col> {
              ...
              %36 = tileflow.frame_at %26 at(%c0_18, %arg8) : !tileflow.frame<!tileflow.mask<f32>> -> !tileflow.mask<f32>
              %37 = tileflow.compute_select %0 with %34 active(%36 : !tileflow.mask<f32>) : !d2mtile.tile<f32>
              %38 = d2mtile.binary tile_mul %33, %37 -> "source_ssa" : !d2mtile.tile<f32>
              %39 = d2mtile.binary tile_sub %35, %38 -> "source_ssa" : !d2mtile.tile<f32>
