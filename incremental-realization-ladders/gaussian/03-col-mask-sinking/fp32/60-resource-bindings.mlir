...
module {
  func.func @_Z10ForwardSubPfS__driver(%arg0: memref<5120x5120xf32> {tileplan.abi_index = 1 : i64, tileplan.tensor_role = #tileplan.tensor_role<inout>}) attributes {tileplan.selected_compute, tt.l1_peak = 1347584 : i64, tt.l1_persistent_base = 299008 : i64, tt.l1_pool = 299008 : i64} {
    %c10 = arith.constant 10 : index
    %c10_0 = arith.constant 10 : index
    tileplan.device_for (%arg1, %arg2) in (%c10_0, %c10) {
      %0 = tileplan.persistent_l1 elem f32 tile(32, 32) domain(16, 16) order(0) {logical_tiles = [160, 160], partition = [10, 10], physical_grid = [10, 10], shard = [16, 16], tt.frame_pages = 256 : i64, tt.l1_offset = 299008 : i64, tt.mailbox_depth = 1 : i64, tt.storage_bytes = 1048576 : i64, tt.storage_depth = 1 : i64, tt.storage_kind = "persistent"} : !tileplan.l1_buffer
      ...
      ^bb0(%arg3: memref<5120x5120xf32>):
        ...
        %6 = tileplan.l1_buffer role<constructed> elem f32 tile(32, 32) domain(1, 16) order(5) {frame_axis = #tileplan.axis<col>, task.fill_axis = #tileplan.axis<col>, task.frame_access = "replay", task.reuse = 16 : i64, task.slot_access = #task.slot_access<replay>, tt.cb_id = 5 : i64, tt.frame_pages = 16 : i64, tt.l1_offset = 204800 : i64, tt.mailbox_depth = 1 : i64, tt.storage_bytes = 65536 : i64, tt.storage_depth = 1 : i64, tt.storage_kind = "addressed_mailbox"} : !tileplan.l1_buffer
        %7 = tileplan.l1_buffer role<constructed> elem f32 tile(32, 32) domain(16, 1) resident(1, 1) order(6) {frame_axis = #tileplan.axis<row>, task.drain_axis = #tileplan.axis<row>, task.fill_axis = #tileplan.axis<row>, task.slot_access = #task.slot_access<single_pass>, task.stream = #tileplan.axis<row>, tt.cb_id = 6 : i64, tt.frame_pages = 1 : i64, tt.l1_offset = 270336 : i64, tt.mailbox_depth = 2 : i64, tt.storage_bytes = 8192 : i64, tt.storage_depth = 2 : i64, tt.storage_kind = "addressed_mailbox"} : !tileplan.l1_buffer
        %8 = tileplan.l1_buffer role<constructed> elem f32 tile(32, 32) domain(16, 1) resident(1, 1) order(7) {frame_axis = #tileplan.axis<row>, task.drain_axis = #tileplan.axis<row>, task.fill_axis = #tileplan.axis<row>, task.slot_access = #task.slot_access<single_pass>, task.stream = #tileplan.axis<row>, tt.cb_id = 7 : i64, tt.frame_pages = 1 : i64, tt.l1_offset = 278528 : i64, tt.mailbox_depth = 2 : i64, tt.storage_bytes = 8192 : i64, tt.storage_depth = 2 : i64, tt.storage_kind = "addressed_mailbox"} : !tileplan.l1_buffer
        %9 = tileplan.l1_buffer role<intermediate> name "dst_spill_8" elem f32 tile(32, 32) domain(1, 1) order(8) {tt.cb_id = 8 : i64, tt.dst_spill, tt.frame_pages = 1 : i64, tt.l1_offset = 286720 : i64, tt.mailbox_depth = 1 : i64, tt.storage_bytes = 4096 : i64, tt.storage_depth = 1 : i64, tt.storage_kind = "addressed_mailbox"} : !tileplan.l1_buffer
        %10 = tileplan.l1_buffer role<intermediate> name "dst_spill_9" elem f32 tile(32, 32) domain(1, 1) order(9) {tt.cb_id = 9 : i64, tt.dst_spill, tt.frame_pages = 1 : i64, tt.l1_offset = 290816 : i64, tt.mailbox_depth = 1 : i64, tt.storage_bytes = 4096 : i64, tt.storage_depth = 1 : i64, tt.storage_kind = "addressed_mailbox"} : !tileplan.l1_buffer
        %11 = tileplan.l1_buffer role<intermediate> name "dst_spill_10" elem f32 tile(32, 32) domain(1, 1) order(10) {tt.cb_id = 10 : i64, tt.dst_spill, tt.frame_pages = 1 : i64, tt.l1_offset = 294912 : i64, tt.mailbox_depth = 1 : i64, tt.storage_bytes = 4096 : i64, tt.storage_depth = 1 : i64, tt.storage_kind = "addressed_mailbox"} : !tileplan.l1_buffer
        tileplan.bind_persistent %0 : !tileplan.l1_buffer reads(%arg3 : memref<5120x5120xf32>) writes(%arg3 : memref<5120x5120xf32>) {producer = "compute", tt.cb_id = 11 : i64}
        tileplan.temporal_for (%arg4) in (0, 5119, 1) {
          task.group @dm0_0 engine(<dm0>) domain(<phase>) reads() writes() {
            ...
            tileplan.shard_for (%arg5) in (%c16_1) axis <col> {
              ...
              %27 = tileflow.col_mask symbols(%26) set #set {task.engine_label = "dm"} : !tileflow.mask<f32>
              tileflow.write_l1_buffer %6 at(%c0_15, %arg5) epoch(%arg4) to %27 : !tileplan.l1_buffer to !tileflow.mask<f32>
            }
            ...
            tileplan.shard_for (%arg5) in (%c16) axis <row> {
              ...
              %28 = tileflow.row_mask symbols(%27) set #set {task.engine_label = "dm"} : !tileflow.mask<f32>
              task.epoch_acquire %8 epoch(%arg4) : !tileplan.l1_buffer
              tileflow.write_l1_buffer %8 at(%arg5, %c0_16) epoch(%arg4) to %28 : !tileplan.l1_buffer to !tileflow.mask<f32>
          ...
          task.group @compute_1 engine(<compute>) domain(<phase>) reads() writes() {
            ...
            %13 = d2mtile.fill "0.000000e+00" {task.engine_label = "compute", tt.dst_slot = 0 : i64} : !d2mtile.tile<f32>
            %c0_3 = arith.constant 0 : index
            %c0_4 = arith.constant 0 : index
            tileflow.write_l1_buffer %9 at(%c0_3, %c0_4) epoch(%arg4) to %13 : !tileplan.l1_buffer to !d2mtile.tile<f32>
            ...
            %17 = tileflow.read_l1_buffer %2 at(%c0_5, %c0_6) on cell(%15, %16) epoch(%arg4) {tt.dst_slot = 0 : i64} : !tileplan.l1_buffer -> !d2mtile.tile<f32>
            %18 = d2mtile.unary tile_recip %17 -> "source_ssa" {task.engine_label = "compute", tt.dst_slot = 0 : i64} : !d2mtile.tile<f32>
            task.epoch_free %2 epoch(%arg4) : !tileplan.l1_buffer
            %c0_7 = arith.constant 0 : index
            %c0_8 = arith.constant 0 : index
            tileflow.write_l1_buffer %10 at(%c0_7, %c0_8) epoch(%arg4) to %18 : !tileplan.l1_buffer to !d2mtile.tile<f32>
            ...
            tileplan.shard_for (%arg5) in (%c16) axis <row> {
              ...
              %20 = d2mtile.dst_acquire capacity 4 : !d2mtile.dst_bank
              task.epoch_wait %7 epoch(%arg4) : !tileplan.l1_buffer
              %21 = tileflow.read_l1_buffer %7 at(%arg5, %c0_9) on col(%19) epoch(%arg4) {tt.dst_slot = 0 : i64} : !tileplan.l1_buffer -> !d2mtile.tile<f32>
              %c0_10 = arith.constant 0 : index
              task.epoch_wait %8 epoch(%arg4) : !tileplan.l1_buffer
              %22 = tileflow.read_l1_buffer %8 at(%arg5, %c0_10) epoch(%arg4) {tt.dst_slot = 1 : i64} : !tileplan.l1_buffer -> !tileflow.mask<f32>
              %c0_11 = arith.constant 0 : index
              %c0_12 = arith.constant 0 : index
              %23 = tileflow.read_l1_buffer %9 at(%c0_11, %c0_12) epoch(%arg4) {tt.dst_slot = 2 : i64} : !tileplan.l1_buffer -> !d2mtile.tile<f32>
              %24 = tileflow.compute_select %23 with %21 active(%22 : !tileflow.mask<f32>) {task.engine_label = "compute", tt.dst_slot = 2 : i64} : !d2mtile.tile<f32>
              task.epoch_free %8 epoch(%arg4) : !tileplan.l1_buffer
              task.epoch_free %7 epoch(%arg4) : !tileplan.l1_buffer
              %c0_13 = arith.constant 0 : index
              %c0_14 = arith.constant 0 : index
              %25 = tileflow.read_l1_buffer %10 at(%c0_13, %c0_14) epoch(%arg4) {tt.dst_slot = 0 : i64} : !tileplan.l1_buffer -> !d2mtile.tile<f32>
              %26 = d2mtile.binary tile_mul %24, %25 -> "source_ssa" {task.engine_label = "compute", tt.dst_slot = 2 : i64} : !d2mtile.tile<f32>
              %c0_15 = arith.constant 0 : index
              %c0_16 = arith.constant 0 : index
              tileflow.write_l1_buffer %11 at(%c0_15, %c0_16) epoch(%arg4) to %26 : !tileplan.l1_buffer to !d2mtile.tile<f32>
              ...
              tileplan.shard_for (%arg6) in (%c16_1) axis <col> {
                %27 = d2mtile.dst_acquire capacity 4 : !d2mtile.dst_bank
                %28 = tileflow.read_l1_buffer %5 at(%c0, %arg6) epoch(%arg4) {tt.dst_slot = 0 : i64} : !tileplan.l1_buffer -> !d2mtile.tile<f32>
                %29 = affine.apply #map7(%arg1, %arg2, %arg5, %arg6)
                %30 = affine.apply #map8(%arg1, %arg2, %arg5, %arg6)
                %31 = tileflow.read_l1_buffer %0 at(%29, %30) epoch(%arg4) {tt.dst_slot = 1 : i64} : !tileplan.l1_buffer -> !d2mtile.tile<f32>
                %32 = tileflow.read_l1_buffer %6 at(%c0_2, %arg6) epoch(%arg4) {tt.dst_slot = 2 : i64} : !tileplan.l1_buffer -> !tileflow.mask<f32>
                %c0_17 = arith.constant 0 : index
                %c0_18 = arith.constant 0 : index
                %33 = tileflow.read_l1_buffer %9 at(%c0_17, %c0_18) epoch(%arg4) {tt.dst_slot = 3 : i64} : !tileplan.l1_buffer -> !d2mtile.tile<f32>
                %34 = tileflow.compute_select %33 with %28 active(%32 : !tileflow.mask<f32>) {task.engine_label = "compute", tt.dst_slot = 3 : i64} : !d2mtile.tile<f32>
                %c0_19 = arith.constant 0 : index
                %c0_20 = arith.constant 0 : index
                %35 = tileflow.read_l1_buffer %11 at(%c0_19, %c0_20) epoch(%arg4) {tt.dst_slot = 0 : i64} : !tileplan.l1_buffer -> !d2mtile.tile<f32>
                %36 = d2mtile.binary tile_mul %35, %34 -> "source_ssa" {task.engine_label = "compute", tt.dst_slot = 0 : i64} : !d2mtile.tile<f32>
                %37 = d2mtile.binary tile_sub %31, %36 -> "source_ssa" {task.engine_label = "compute", tt.dst_slot = 0 : i64} : !d2mtile.tile<f32>
                tileflow.write_l1_buffer %0 at(%arg5, %arg6) epoch(%arg4) to %37 {task.engine_label = "compute"} : !tileplan.l1_buffer to !d2mtile.tile<f32>
