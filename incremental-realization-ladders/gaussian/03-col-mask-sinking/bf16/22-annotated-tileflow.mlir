    ...
    tileplan.device_for (%arg2, %arg3) in (%c10_0, %c10) {
      ...
      ^bb0(%arg4: memref<5120x5120xbf16>, %arg5: memref<5120x5120xbf16>):
        ...
        tileplan.temporal_for (%arg6) in (0, 5119, 1) {
          ...
          %7 = d2mtile.unary tile_recip %5 -> "source_ssa" {tileflow.realization_engine = #tileflow.engine<compute>} : !d2mtile.tile<bf16>
          ...
          tileplan.shard_for (%arg7) in (%c16_1) axis <row> {
            ...
            tileplan.shard_for (%arg8) in (%c16_3) axis <col> {
              ...
              %18 = tileflow.mask_fill %10 active(%17 : !tileflow.mask<bf16>) policy zero : !d2mtile.tile<bf16> -> !d2mtile.tile<bf16>
              %19 = tileflow.col_mask symbols(%16) set #set : !tileflow.mask<bf16>
              %20 = tileflow.mask_fill %14 active(%19 : !tileflow.mask<bf16>) policy zero : !d2mtile.tile<bf16> -> !d2mtile.tile<bf16>
